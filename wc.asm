...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 9a 04 00 00       	call   4d6 <open>
  ...
  59:	e8 60 04 00 00       	call   4be <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 2b 04 00 00       	call   496 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 86 05 00 00       	call   600 <printf>
      exit();
  7a:	e8 17 04 00 00       	call   496 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 04 04 00 00       	call   496 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 d9 03 00 00       	call   4ae <read>
 ...
 16f:	e8 8c 04 00 00       	call   600 <printf>
    exit();
 174:	e8 1d 03 00 00       	call   496 <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 f1 01 00 00       	call   4ae <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 b4 01 00 00       	call   4d6 <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 b7 01 00 00       	call   4ee <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 7d 01 00 00       	call   4be <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 3db:	e8 50 04 00 00       	call   830 <malloc>
 ...
 3f1:	e8 40 01 00 00       	call   536 <clone>
...
thread_join()
{
 ...
 413:	83 ec 34             	sub    $0x34,%esp
	void *stack;
	int pid = join(&stack);
 416:	8d 45 f4             	lea    -0xc(%ebp),%eax
 419:	50                   	push   %eax
 41a:	e8 1f 01 00 00       	call   53e <join>
	
	if(pid >= 0)
 41f:	83 c4 10             	add    $0x10,%esp
 422:	85 c0                	test   %eax,%eax
 424:	79 0a                	jns    430 <thread_join+0x20>
		free(stack);
 ...
 439:	e8 62 03 00 00       	call   7a0 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 472:	f0 0f c1 02          	lock xadd %eax,(%edx)
	while(fetch_and_add((int*)&lock->flag, 1) != 0)
 476:	85 c0                	test   %eax,%eax
 478:	75 f6                	jne    470 <lock_acquire+0x10>
		;
}
 47a:	5d                   	pop    %ebp
 47b:	c3                   	ret    
 ...
 55c:	89 d1                	mov    %edx,%ecx
{
 ...
 5ce:	56                   	push   %esi
 5cf:	57                   	push   %edi
 5d0:	e8 e1 fe ff ff       	call   4b6 <write>
  while(--i >= 0)
 ...
 609:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 645:	57                   	push   %edi
 646:	56                   	push   %esi
 647:	e8 6a fe ff ff       	call   4b6 <write>
 ...
 69e:	e8 13 fe ff ff       	call   4b6 <write>
        putc(fd, c);
 ...
 6af:	57                   	push   %edi
 6b0:	56                   	push   %esi
 6b1:	e8 00 fe ff ff       	call   4b6 <write>
        putc(fd, c);
 ...
 71b:	57                   	push   %edi
 71c:	56                   	push   %esi
 71d:	e8 94 fd ff ff       	call   4b6 <write>
        while(*s != 0){
 ...
 75c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 75f:	e8 52 fd ff ff       	call   4b6 <write>
        ap++;
 ...
 787:	90                   	nop
          s = "(null)";
 788:	ba 5f 09 00 00       	mov    $0x95f,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 893:	e8 86 fc ff ff       	call   51e <sbrk>
  if(p == (char*)-1)

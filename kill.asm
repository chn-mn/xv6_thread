...
main(int argc, char **argv)
{
  ...
  39:	e8 68 03 00 00       	call   3a6 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 2c 03 00 00       	call   376 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 88 04 00 00       	call   4e0 <printf>
    exit();
  58:	e8 19 03 00 00       	call   376 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
free(void *ap)
{
 ...
 681:	a1 e4 0b 00 00       	mov    0xbe4,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 e4 0b 00 00 e8 	movl   $0xbe8,0xbe4
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf e8 0b 00 00       	mov    $0xbe8,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 e8 0b 00 00 e8 	movl   $0xbe8,0xbe8
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 ec 0b 00 00 00 	movl   $0x0,0xbec
 7f2:	00 00 00 
    if(p->s.size >= nunits){

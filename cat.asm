...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 2a 04 00 00       	call   466 <open>
  ...
  57:	e8 f2 03 00 00       	call   44e <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 bd 03 00 00       	call   426 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 18 05 00 00       	call   590 <printf>
      exit();
  78:	e8 a9 03 00 00       	call   426 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 9a 03 00 00       	call   426 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a3:	53                   	push   %ebx
  a4:	68 00 0d 00 00       	push   $0xd00
  a9:	6a 01                	push   $0x1
  ab:	e8 96 03 00 00       	call   446 <write>
  ...
  bf:	68 00 0d 00 00       	push   $0xd00
  c4:	56                   	push   %esi
  c5:	e8 74 03 00 00       	call   43e <read>
  ...
  e6:	e8 a5 04 00 00       	call   590 <printf>
      exit();
  eb:	e8 36 03 00 00       	call   426 <exit>
  ...
  f9:	e8 92 04 00 00       	call   590 <printf>
    exit();
  fe:	e8 23 03 00 00       	call   426 <exit>
 ...
 239:	31 db                	xor    %ebx,%ebx
{
 ...
 245:	57                   	push   %edi
 246:	6a 00                	push   $0x0
 248:	e8 f1 01 00 00       	call   43e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 b4 01 00 00       	call   466 <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 b7 01 00 00       	call   47e <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 7d 01 00 00       	call   44e <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 375:	74 14                	je     38b <thread_create+0x2b>
		return -1;

	return clone(fcn, arg1, arg2, stack);
 377:	50                   	push   %eax
 378:	ff 75 10             	push   0x10(%ebp)
 37b:	ff 75 0c             	push   0xc(%ebp)
 37e:	ff 75 08             	push   0x8(%ebp)
 381:	e8 40 01 00 00       	call   4c6 <clone>
...
thread_join()
{
 ...
 3a3:	83 ec 34             	sub    $0x34,%esp
	void *stack;
	int pid = join(&stack);
 3a6:	8d 45 f4             	lea    -0xc(%ebp),%eax
 3a9:	50                   	push   %eax
 3aa:	e8 1f 01 00 00       	call   4ce <join>
	
	if(pid >= 0)
 3af:	83 c4 10             	add    $0x10,%esp
 3b2:	85 c0                	test   %eax,%eax
 3b4:	79 0a                	jns    3c0 <thread_join+0x20>
		free(stack);
 ...
 3c9:	e8 62 03 00 00       	call   730 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 402:	f0 0f c1 02          	lock xadd %eax,(%edx)
	while(fetch_and_add((int*)&lock->flag, 1) != 0)
 406:	85 c0                	test   %eax,%eax
 408:	75 f6                	jne    400 <lock_acquire+0x10>
		;
}
 40a:	5d                   	pop    %ebp
 40b:	c3                   	ret    
 ...
 4ec:	89 d1                	mov    %edx,%ecx
{
 ...
 55e:	56                   	push   %esi
 55f:	57                   	push   %edi
 560:	e8 e1 fe ff ff       	call   446 <write>
  while(--i >= 0)
 ...
 599:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d5:	57                   	push   %edi
 5d6:	56                   	push   %esi
 5d7:	e8 6a fe ff ff       	call   446 <write>
 ...
 62e:	e8 13 fe ff ff       	call   446 <write>
        putc(fd, c);
 ...
 63f:	57                   	push   %edi
 640:	56                   	push   %esi
 641:	e8 00 fe ff ff       	call   446 <write>
        putc(fd, c);
 ...
 6ab:	57                   	push   %edi
 6ac:	56                   	push   %esi
 6ad:	e8 94 fd ff ff       	call   446 <write>
        while(*s != 0){
 ...
 6ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6ef:	e8 52 fd ff ff       	call   446 <write>
        ap++;
...
free(void *ap)
{
 ...
 731:	a1 00 0f 00 00       	mov    0xf00,%eax
{
 ...
 771:	5b                   	pop    %ebx
  freep = p;
 772:	89 15 00 0f 00 00    	mov    %edx,0xf00
}
 778:	5e                   	pop    %esi
 779:	5f                   	pop    %edi
 77a:	5d                   	pop    %ebp
 ...
 7a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ac:	89 15 00 0f 00 00    	mov    %edx,0xf00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7cc:	8b 3d 00 0f 00 00    	mov    0xf00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 80f:	73 4f                	jae    860 <malloc+0xa0>
    ...
    if(p == freep)
 811:	8b 3d 00 0f 00 00    	mov    0xf00,%edi
 ...
 823:	e8 86 fc ff ff       	call   4ae <sbrk>
  if(p == (char*)-1)
 ...
 83a:	e8 f1 fe ff ff       	call   730 <free>
  return freep;
 83f:	8b 15 00 0f 00 00    	mov    0xf00,%edx
 ...
 86c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 86f:	89 15 00 0f 00 00    	mov    %edx,0xf00
}
 ...
 87f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 880:	c7 05 00 0f 00 00 04 	movl   $0xf04,0xf00
 887:	0f 00 00 
    base.s.size = 0;
 88a:	bf 04 0f 00 00       	mov    $0xf04,%edi
    base.s.ptr = freep = prevp = &base;
 88f:	c7 05 04 0f 00 00 04 	movl   $0xf04,0xf04
 896:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 899:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 89b:	c7 05 08 0f 00 00 00 	movl   $0x0,0xf08
 8a2:	00 00 00 
    if(p->s.size >= nunits){

...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 28 03 00 00       	call   33e <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 b2 03 00 00       	call   3d6 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 1a 03 00 00       	call   346 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 f1 01 00 00       	call   35e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 b4 01 00 00       	call   386 <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 b7 01 00 00       	call   39e <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 7d 01 00 00       	call   36e <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 28b:	e8 50 04 00 00       	call   6e0 <malloc>

	if(stack == 0)
 290:	83 c4 10             	add    $0x10,%esp
 293:	85 c0                	test   %eax,%eax
 295:	74 14                	je     2ab <thread_create+0x2b>
		return -1;

	return clone(fcn, arg1, arg2, stack);
 297:	50                   	push   %eax
 298:	ff 75 10             	push   0x10(%ebp)
 29b:	ff 75 0c             	push   0xc(%ebp)
 29e:	ff 75 08             	push   0x8(%ebp)
 2a1:	e8 40 01 00 00       	call   3e6 <clone>
...
thread_join()
{
 ...
 2c3:	83 ec 34             	sub    $0x34,%esp
	void *stack;
	int pid = join(&stack);
 2c6:	8d 45 f4             	lea    -0xc(%ebp),%eax
 2c9:	50                   	push   %eax
 2ca:	e8 1f 01 00 00       	call   3ee <join>
	
	if(pid >= 0)
 2cf:	83 c4 10             	add    $0x10,%esp
 2d2:	85 c0                	test   %eax,%eax
 2d4:	79 0a                	jns    2e0 <thread_join+0x20>
		free(stack);
 ...
 2e3:	ff 75 f4             	push   -0xc(%ebp)
 2e6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 2e9:	e8 62 03 00 00       	call   650 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 322:	f0 0f c1 02          	lock xadd %eax,(%edx)
	while(fetch_and_add((int*)&lock->flag, 1) != 0)
 326:	85 c0                	test   %eax,%eax
 328:	75 f6                	jne    320 <lock_acquire+0x10>
		;
}
 32a:	5d                   	pop    %ebp
 32b:	c3                   	ret    
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 47e:	56                   	push   %esi
 47f:	57                   	push   %edi
 480:	e8 e1 fe ff ff       	call   366 <write>
  while(--i >= 0)
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f5:	57                   	push   %edi
 4f6:	56                   	push   %esi
 4f7:	e8 6a fe ff ff       	call   366 <write>
 ...
 54e:	e8 13 fe ff ff       	call   366 <write>
        putc(fd, c);
 ...
 55f:	57                   	push   %edi
 560:	56                   	push   %esi
 561:	e8 00 fe ff ff       	call   366 <write>
        putc(fd, c);
 ...
 5cb:	57                   	push   %edi
 5cc:	56                   	push   %esi
 5cd:	e8 94 fd ff ff       	call   366 <write>
        while(*s != 0){
 ...
 60c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 60f:	e8 52 fd ff ff       	call   366 <write>
        ap++;
...
free(void *ap)
{
 ...
 651:	a1 90 0b 00 00       	mov    0xb90,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 90 0b 00 00    	mov    %edx,0xb90
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 90 0b 00 00    	mov    %edx,0xb90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
 ...
 743:	e8 86 fc ff ff       	call   3ce <sbrk>
  if(p == (char*)-1)
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 90 0b 00 00    	mov    0xb90,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 90 0b 00 00    	mov    %edx,0xb90
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 90 0b 00 00 94 	movl   $0xb94,0xb90
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 94 0b 00 00       	mov    $0xb94,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 94 0b 00 00 94 	movl   $0xb94,0xb94
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 7c2:	00 00 00 
    if(p->s.size >= nunits){

  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 eb 03 00 00       	call   44e <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 ee 03 00 00       	call   496 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 b7 03 00 00       	call   476 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 ae 03 00 00       	call   47e <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 a3 03 00 00       	call   496 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 5f 03 00 00       	call   46e <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 5e 03 00 00       	call   47e <close>

  wait();
 120:	e8 39 03 00 00       	call   45e <wait>

  exit();
 125:	e8 2c 03 00 00       	call   456 <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 f1 01 00 00       	call   46e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 b4 01 00 00       	call   496 <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 b7 01 00 00       	call   4ae <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 7d 01 00 00       	call   47e <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 3a5:	74 14                	je     3bb <thread_create+0x2b>
		return -1;

	return clone(fcn, arg1, arg2, stack);
 3a7:	50                   	push   %eax
 3a8:	ff 75 10             	push   0x10(%ebp)
 3ab:	ff 75 0c             	push   0xc(%ebp)
 3ae:	ff 75 08             	push   0x8(%ebp)
 3b1:	e8 40 01 00 00       	call   4f6 <clone>
...
thread_join()
{
 ...
 3d3:	83 ec 34             	sub    $0x34,%esp
	void *stack;
	int pid = join(&stack);
 3d6:	8d 45 f4             	lea    -0xc(%ebp),%eax
 3d9:	50                   	push   %eax
 3da:	e8 1f 01 00 00       	call   4fe <join>
	
	if(pid >= 0)
 3df:	83 c4 10             	add    $0x10,%esp
 3e2:	85 c0                	test   %eax,%eax
 3e4:	79 0a                	jns    3f0 <thread_join+0x20>
		free(stack);
 ...
 3f6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 3f9:	e8 62 03 00 00       	call   760 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 438:	75 f6                	jne    430 <lock_acquire+0x10>
		;
}
 43a:	5d                   	pop    %ebp
 43b:	c3                   	ret    
 ...
 51c:	89 d1                	mov    %edx,%ecx
{
 ...
 58e:	56                   	push   %esi
 58f:	57                   	push   %edi
 590:	e8 e1 fe ff ff       	call   476 <write>
  while(--i >= 0)
 ...
 5c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 605:	57                   	push   %edi
 606:	56                   	push   %esi
 607:	e8 6a fe ff ff       	call   476 <write>
 ...
 65e:	e8 13 fe ff ff       	call   476 <write>
        putc(fd, c);
 ...
 66f:	57                   	push   %edi
 670:	56                   	push   %esi
 671:	e8 00 fe ff ff       	call   476 <write>
        putc(fd, c);
 ...
 6db:	57                   	push   %edi
 6dc:	56                   	push   %esi
 6dd:	e8 94 fd ff ff       	call   476 <write>
        while(*s != 0){
 ...
 71c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 71f:	e8 52 fd ff ff       	call   476 <write>
        ap++;
...
free(void *ap)
{
 ...
 761:	a1 d4 0c 00 00       	mov    0xcd4,%eax
{
 ...
 7a1:	5b                   	pop    %ebx
  freep = p;
 7a2:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
}
 7a8:	5e                   	pop    %esi
 7a9:	5f                   	pop    %edi
 7aa:	5d                   	pop    %ebp
 ...
 7d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7dc:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7fc:	8b 3d d4 0c 00 00    	mov    0xcd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 83f:	73 4f                	jae    890 <malloc+0xa0>
    ...
    if(p == freep)
 841:	8b 3d d4 0c 00 00    	mov    0xcd4,%edi
 ...
 853:	e8 86 fc ff ff       	call   4de <sbrk>
  if(p == (char*)-1)
 ...
 86a:	e8 f1 fe ff ff       	call   760 <free>
  return freep;
 86f:	8b 15 d4 0c 00 00    	mov    0xcd4,%edx
 ...
 89c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 89f:	89 15 d4 0c 00 00    	mov    %edx,0xcd4
}
 ...
 8af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8b0:	c7 05 d4 0c 00 00 d8 	movl   $0xcd8,0xcd4
 8b7:	0c 00 00 
    base.s.size = 0;
 8ba:	bf d8 0c 00 00       	mov    $0xcd8,%edi
    base.s.ptr = freep = prevp = &base;
 8bf:	c7 05 d8 0c 00 00 d8 	movl   $0xcd8,0xcd8
 8c6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8cb:	c7 05 dc 0c 00 00 00 	movl   $0x0,0xcdc
 8d2:	00 00 00 
    if(p->s.size >= nunits){

...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      11:	68 16 4e 00 00       	push   $0x4e16
      16:	6a 01                	push   $0x1
      18:	e8 e3 3a 00 00       	call   3b00 <printf>

  if(open("usertests.ran", 0) >= 0){
      1d:	59                   	pop    %ecx
      1e:	58                   	pop    %eax
      1f:	6a 00                	push   $0x0
      21:	68 2a 4e 00 00       	push   $0x4e2a
      26:	e8 ab 39 00 00       	call   39d6 <open>
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      32:	52                   	push   %edx
      33:	52                   	push   %edx
      34:	68 94 55 00 00       	push   $0x5594
      39:	6a 01                	push   $0x1
      3b:	e8 c0 3a 00 00       	call   3b00 <printf>
    exit();
      40:	e8 51 39 00 00       	call   3996 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      45:	50                   	push   %eax
      46:	50                   	push   %eax
      47:	68 00 02 00 00       	push   $0x200
      4c:	68 2a 4e 00 00       	push   $0x4e2a
      51:	e8 80 39 00 00       	call   39d6 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 60 39 00 00       	call   39be <close>
  ...
  exit();
     10d:	e8 84 38 00 00       	call   3996 <exit>
...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     126:	68 bc 3e 00 00       	push   $0x3ebc
     12b:	ff 35 c8 5f 00 00    	push   0x5fc8
     131:	e8 ca 39 00 00       	call   3b00 <printf>
  if(mkdir("iputdir") < 0){
     136:	c7 04 24 4f 3e 00 00 	movl   $0x3e4f,(%esp)
     13d:	e8 bc 38 00 00       	call   39fe <mkdir>
     142:	83 c4 10             	add    $0x10,%esp
     145:	85 c0                	test   %eax,%eax
     147:	78 58                	js     1a1 <iputtest+0x81>
  if(chdir("iputdir") < 0){
     149:	83 ec 0c             	sub    $0xc,%esp
     14c:	68 4f 3e 00 00       	push   $0x3e4f
     151:	e8 b0 38 00 00       	call   3a06 <chdir>
     156:	83 c4 10             	add    $0x10,%esp
     159:	85 c0                	test   %eax,%eax
     15b:	0f 88 85 00 00 00    	js     1e6 <iputtest+0xc6>
  if(unlink("../iputdir") < 0){
     161:	83 ec 0c             	sub    $0xc,%esp
     164:	68 4c 3e 00 00       	push   $0x3e4c
     169:	e8 78 38 00 00       	call   39e6 <unlink>
     16e:	83 c4 10             	add    $0x10,%esp
     171:	85 c0                	test   %eax,%eax
     173:	78 5a                	js     1cf <iputtest+0xaf>
  if(chdir("/") < 0){
     175:	83 ec 0c             	sub    $0xc,%esp
     178:	68 71 3e 00 00       	push   $0x3e71
     17d:	e8 84 38 00 00       	call   3a06 <chdir>
     182:	83 c4 10             	add    $0x10,%esp
     185:	85 c0                	test   %eax,%eax
     187:	78 2f                	js     1b8 <iputtest+0x98>
  printf(stdout, "iput test ok\n");
     189:	83 ec 08             	sub    $0x8,%esp
     18c:	68 f4 3e 00 00       	push   $0x3ef4
     191:	ff 35 c8 5f 00 00    	push   0x5fc8
     197:	e8 64 39 00 00       	call   3b00 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     1a1:	50                   	push   %eax
     1a2:	50                   	push   %eax
     1a3:	68 28 3e 00 00       	push   $0x3e28
     1a8:	ff 35 c8 5f 00 00    	push   0x5fc8
     1ae:	e8 4d 39 00 00       	call   3b00 <printf>
    exit();
     1b3:	e8 de 37 00 00       	call   3996 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 73 3e 00 00       	push   $0x3e73
     1bf:	ff 35 c8 5f 00 00    	push   0x5fc8
     1c5:	e8 36 39 00 00       	call   3b00 <printf>
    exit();
     1ca:	e8 c7 37 00 00       	call   3996 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 57 3e 00 00       	push   $0x3e57
     1d6:	ff 35 c8 5f 00 00    	push   0x5fc8
     1dc:	e8 1f 39 00 00       	call   3b00 <printf>
    exit();
     1e1:	e8 b0 37 00 00       	call   3996 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 36 3e 00 00       	push   $0x3e36
     1ed:	ff 35 c8 5f 00 00    	push   0x5fc8
     1f3:	e8 08 39 00 00       	call   3b00 <printf>
    exit();
     1f8:	e8 99 37 00 00       	call   3996 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     206:	68 83 3e 00 00       	push   $0x3e83
     20b:	ff 35 c8 5f 00 00    	push   0x5fc8
     211:	e8 ea 38 00 00       	call   3b00 <printf>
  pid = fork();
     216:	e8 73 37 00 00       	call   398e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     22b:	68 4f 3e 00 00       	push   $0x3e4f
     230:	e8 c9 37 00 00       	call   39fe <mkdir>
     235:	83 c4 10             	add    $0x10,%esp
     238:	85 c0                	test   %eax,%eax
     23a:	0f 88 87 00 00 00    	js     2c7 <exitiputtest+0xc7>
    if(chdir("iputdir") < 0){
     240:	83 ec 0c             	sub    $0xc,%esp
     243:	68 4f 3e 00 00       	push   $0x3e4f
     248:	e8 b9 37 00 00       	call   3a06 <chdir>
     24d:	83 c4 10             	add    $0x10,%esp
     250:	85 c0                	test   %eax,%eax
     252:	0f 88 86 00 00 00    	js     2de <exitiputtest+0xde>
    if(unlink("../iputdir") < 0){
     258:	83 ec 0c             	sub    $0xc,%esp
     25b:	68 4c 3e 00 00       	push   $0x3e4c
     260:	e8 81 37 00 00       	call   39e6 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 25 37 00 00       	call   3996 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 21 37 00 00       	call   399e <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 a6 3e 00 00       	push   $0x3ea6
     285:	ff 35 c8 5f 00 00    	push   0x5fc8
     ...
     29b:	68 57 3e 00 00       	push   $0x3e57
     2a0:	ff 35 c8 5f 00 00    	push   0x5fc8
     2a6:	e8 55 38 00 00       	call   3b00 <printf>
      exit();
     2ab:	e8 e6 36 00 00       	call   3996 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 69 4d 00 00       	push   $0x4d69
     2b7:	ff 35 c8 5f 00 00    	push   0x5fc8
     2bd:	e8 3e 38 00 00       	call   3b00 <printf>
    exit();
     2c2:	e8 cf 36 00 00       	call   3996 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 28 3e 00 00       	push   $0x3e28
     2ce:	ff 35 c8 5f 00 00    	push   0x5fc8
     2d4:	e8 27 38 00 00       	call   3b00 <printf>
      exit();
     2d9:	e8 b8 36 00 00       	call   3996 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 92 3e 00 00       	push   $0x3e92
     2e5:	ff 35 c8 5f 00 00    	push   0x5fc8
     2eb:	e8 10 38 00 00       	call   3b00 <printf>
      exit();
     2f0:	e8 a1 36 00 00       	call   3996 <exit>
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     306:	68 b8 3e 00 00       	push   $0x3eb8
     30b:	ff 35 c8 5f 00 00    	push   0x5fc8
     311:	e8 ea 37 00 00       	call   3b00 <printf>
  if(mkdir("oidir") < 0){
     316:	c7 04 24 c7 3e 00 00 	movl   $0x3ec7,(%esp)
     31d:	e8 dc 36 00 00       	call   39fe <mkdir>
     322:	83 c4 10             	add    $0x10,%esp
     325:	85 c0                	test   %eax,%eax
     327:	0f 88 9f 00 00 00    	js     3cc <openiputtest+0xcc>
  pid = fork();
     32d:	e8 5c 36 00 00       	call   398e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     33b:	6a 02                	push   $0x2
     33d:	68 c7 3e 00 00       	push   $0x3ec7
     342:	e8 8f 36 00 00       	call   39d6 <open>
    if(fd >= 0){
     ...
     351:	68 4c 4e 00 00       	push   $0x4e4c
     356:	ff 35 c8 5f 00 00    	push   0x5fc8
     35c:	e8 9f 37 00 00       	call   3b00 <printf>
      exit();
     361:	e8 30 36 00 00       	call   3996 <exit>
     366:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     36d:	8d 76 00             	lea    0x0(%esi),%esi
  sleep(1);
     370:	83 ec 0c             	sub    $0xc,%esp
     373:	6a 01                	push   $0x1
     375:	e8 ac 36 00 00       	call   3a26 <sleep>
  if(unlink("oidir") != 0){
     37a:	c7 04 24 c7 3e 00 00 	movl   $0x3ec7,(%esp)
     381:	e8 60 36 00 00       	call   39e6 <unlink>
     386:	83 c4 10             	add    $0x10,%esp
     389:	85 c0                	test   %eax,%eax
     38b:	75 56                	jne    3e3 <openiputtest+0xe3>
  wait();
     38d:	e8 0c 36 00 00       	call   399e <wait>
  printf(stdout, "openiput test ok\n");
     392:	83 ec 08             	sub    $0x8,%esp
     395:	68 f0 3e 00 00       	push   $0x3ef0
     39a:	ff 35 c8 5f 00 00    	push   0x5fc8
    ...
    exit();
     3b0:	e8 e1 35 00 00       	call   3996 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 69 4d 00 00       	push   $0x4d69
     3bc:	ff 35 c8 5f 00 00    	push   0x5fc8
     3c2:	e8 39 37 00 00       	call   3b00 <printf>
    exit();
     3c7:	e8 ca 35 00 00       	call   3996 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 cd 3e 00 00       	push   $0x3ecd
     3d3:	ff 35 c8 5f 00 00    	push   0x5fc8
     3d9:	e8 22 37 00 00       	call   3b00 <printf>
    exit();
     3de:	e8 b3 35 00 00       	call   3996 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 e1 3e 00 00       	push   $0x3ee1
     3ea:	ff 35 c8 5f 00 00    	push   0x5fc8
     3f0:	e8 0b 37 00 00       	call   3b00 <printf>
    exit();
     3f5:	e8 9c 35 00 00       	call   3996 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     406:	68 02 3f 00 00       	push   $0x3f02
     40b:	ff 35 c8 5f 00 00    	push   0x5fc8
     411:	e8 ea 36 00 00       	call   3b00 <printf>
  fd = open("echo", 0);
     416:	58                   	pop    %eax
     417:	5a                   	pop    %edx
     418:	6a 00                	push   $0x0
     41a:	68 0d 3f 00 00       	push   $0x3f0d
     41f:	e8 b2 35 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 8a 35 00 00       	call   39be <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 25 3f 00 00       	push   $0x3f25
     43d:	e8 94 35 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     44c:	68 50 3f 00 00       	push   $0x3f50
     451:	ff 35 c8 5f 00 00    	push   0x5fc8
     457:	e8 a4 36 00 00       	call   3b00 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     461:	50                   	push   %eax
     462:	50                   	push   %eax
     463:	68 12 3f 00 00       	push   $0x3f12
     468:	ff 35 c8 5f 00 00    	push   0x5fc8
     46e:	e8 8d 36 00 00       	call   3b00 <printf>
    exit();
     473:	e8 1e 35 00 00       	call   3996 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 32 3f 00 00       	push   $0x3f32
     47f:	ff 35 c8 5f 00 00    	push   0x5fc8
     485:	e8 76 36 00 00       	call   3b00 <printf>
    exit();
     48a:	e8 07 35 00 00       	call   3996 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     498:	68 5e 3f 00 00       	push   $0x3f5e
     49d:	ff 35 c8 5f 00 00    	push   0x5fc8
     4a3:	e8 58 36 00 00       	call   3b00 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     4a8:	58                   	pop    %eax
     4a9:	5a                   	pop    %edx
     4aa:	68 02 02 00 00       	push   $0x202
     4af:	68 6f 3f 00 00       	push   $0x3f6f
     4b4:	e8 1d 35 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4cb:	68 75 3f 00 00       	push   $0x3f75
     4d0:	ff 35 c8 5f 00 00    	push   0x5fc8
     4d6:	e8 25 36 00 00       	call   3b00 <printf>
     4db:	83 c4 10             	add    $0x10,%esp
     4de:	66 90                	xchg   %ax,%ax
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     4e0:	83 ec 04             	sub    $0x4,%esp
     4e3:	6a 0a                	push   $0xa
     4e5:	68 ac 3f 00 00       	push   $0x3fac
     4ea:	56                   	push   %esi
     4eb:	e8 c6 34 00 00       	call   39b6 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4ff:	6a 0a                	push   $0xa
     501:	68 b7 3f 00 00       	push   $0x3fb7
     506:	56                   	push   %esi
     507:	e8 aa 34 00 00       	call   39b6 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     523:	68 c2 3f 00 00       	push   $0x3fc2
     528:	ff 35 c8 5f 00 00    	push   0x5fc8
     52e:	e8 cd 35 00 00       	call   3b00 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 83 34 00 00       	call   39be <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 6f 3f 00 00       	push   $0x3f6f
     544:	e8 8d 34 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     559:	68 cd 3f 00 00       	push   $0x3fcd
     55e:	ff 35 c8 5f 00 00    	push   0x5fc8
     564:	e8 97 35 00 00       	call   3b00 <printf>
  i = read(fd, buf, 2000);
     569:	83 c4 0c             	add    $0xc,%esp
     56c:	68 d0 07 00 00       	push   $0x7d0
     571:	68 00 87 00 00       	push   $0x8700
     576:	53                   	push   %ebx
     577:	e8 32 34 00 00       	call   39ae <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     58d:	68 01 40 00 00       	push   $0x4001
     592:	ff 35 c8 5f 00 00    	push   0x5fc8
     598:	e8 63 35 00 00       	call   3b00 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 19 34 00 00       	call   39be <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 6f 3f 00 00 	movl   $0x3f6f,(%esp)
     5ac:	e8 35 34 00 00       	call   39e6 <unlink>
     5b1:	83 c4 10             	add    $0x10,%esp
     5b4:	85 c0                	test   %eax,%eax
     5b6:	78 7d                	js     635 <writetest+0x1a5>
  printf(stdout, "small file test ok\n");
     5b8:	83 ec 08             	sub    $0x8,%esp
     5bb:	68 29 40 00 00       	push   $0x4029
     5c0:	ff 35 c8 5f 00 00    	push   0x5fc8
     5c6:	e8 35 35 00 00       	call   3b00 <printf>
}
     ...
     5d8:	53                   	push   %ebx
     5d9:	68 70 4e 00 00       	push   $0x4e70
     5de:	ff 35 c8 5f 00 00    	push   0x5fc8
     5e4:	e8 17 35 00 00       	call   3b00 <printf>
      exit();
     5e9:	e8 a8 33 00 00       	call   3996 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5ee:	83 ec 04             	sub    $0x4,%esp
     5f1:	53                   	push   %ebx
     5f2:	68 94 4e 00 00       	push   $0x4e94
     5f7:	ff 35 c8 5f 00 00    	push   0x5fc8
     5fd:	e8 fe 34 00 00       	call   3b00 <printf>
      exit();
     602:	e8 8f 33 00 00       	call   3996 <exit>
    printf(stdout, "error: open small failed!\n");
     607:	51                   	push   %ecx
     608:	51                   	push   %ecx
     609:	68 e6 3f 00 00       	push   $0x3fe6
     60e:	ff 35 c8 5f 00 00    	push   0x5fc8
     614:	e8 e7 34 00 00       	call   3b00 <printf>
    exit();
     619:	e8 78 33 00 00       	call   3996 <exit>
    printf(stdout, "read failed\n");
     61e:	52                   	push   %edx
     61f:	52                   	push   %edx
     620:	68 2d 43 00 00       	push   $0x432d
     625:	ff 35 c8 5f 00 00    	push   0x5fc8
     62b:	e8 d0 34 00 00       	call   3b00 <printf>
    exit();
     630:	e8 61 33 00 00       	call   3996 <exit>
    printf(stdout, "unlink small failed\n");
     635:	50                   	push   %eax
     636:	50                   	push   %eax
     637:	68 14 40 00 00       	push   $0x4014
     63c:	ff 35 c8 5f 00 00    	push   0x5fc8
     642:	e8 b9 34 00 00       	call   3b00 <printf>
    exit();
     647:	e8 4a 33 00 00       	call   3996 <exit>
    printf(stdout, "error: creat small failed!\n");
     64c:	50                   	push   %eax
     64d:	50                   	push   %eax
     64e:	68 90 3f 00 00       	push   $0x3f90
     653:	ff 35 c8 5f 00 00    	push   0x5fc8
     659:	e8 a2 34 00 00       	call   3b00 <printf>
    exit();
     65e:	e8 33 33 00 00       	call   3996 <exit>
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     678:	68 3d 40 00 00       	push   $0x403d
     67d:	ff 35 c8 5f 00 00    	push   0x5fc8
     683:	e8 78 34 00 00       	call   3b00 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     688:	58                   	pop    %eax
     689:	5a                   	pop    %edx
     68a:	68 02 02 00 00       	push   $0x202
     68f:	68 b7 40 00 00       	push   $0x40b7
     694:	e8 3d 33 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 ed 32 00 00       	call   39b6 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 d3 32 00 00       	call   39be <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 b7 40 00 00       	push   $0x40b7
     6f4:	e8 dd 32 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 74 32 00 00       	call   39ae <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 68 32 00 00       	call   39be <close>
  if(unlink("big") < 0){
     756:	c7 04 24 b7 40 00 00 	movl   $0x40b7,(%esp)
     75d:	e8 84 32 00 00       	call   39e6 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     770:	68 de 40 00 00       	push   $0x40de
     775:	ff 35 c8 5f 00 00    	push   0x5fc8
     77b:	e8 80 33 00 00       	call   3b00 <printf>
}
     ...
     78d:	53                   	push   %ebx
     78e:	68 67 40 00 00       	push   $0x4067
     793:	ff 35 c8 5f 00 00    	push   0x5fc8
     799:	e8 62 33 00 00       	call   3b00 <printf>
      exit();
     79e:	e8 f3 31 00 00       	call   3996 <exit>
      printf(stdout, "read content of block %d is %d\n",
     7a3:	50                   	push   %eax
     7a4:	56                   	push   %esi
     7a5:	68 b8 4e 00 00       	push   $0x4eb8
     7aa:	ff 35 c8 5f 00 00    	push   0x5fc8
     7b0:	e8 4b 33 00 00       	call   3b00 <printf>
      exit();
     7b5:	e8 dc 31 00 00       	call   3996 <exit>
      printf(stdout, "read failed %d\n", i);
     7ba:	83 ec 04             	sub    $0x4,%esp
     7bd:	50                   	push   %eax
     7be:	68 bb 40 00 00       	push   $0x40bb
     7c3:	ff 35 c8 5f 00 00    	push   0x5fc8
     7c9:	e8 32 33 00 00       	call   3b00 <printf>
      exit();
     7ce:	e8 c3 31 00 00       	call   3996 <exit>
        printf(stdout, "read only %d blocks from big", n);
     7d3:	52                   	push   %edx
     7d4:	68 8b 00 00 00       	push   $0x8b
     7d9:	68 9e 40 00 00       	push   $0x409e
     7de:	ff 35 c8 5f 00 00    	push   0x5fc8
     7e4:	e8 17 33 00 00       	call   3b00 <printf>
        exit();
     7e9:	e8 a8 31 00 00       	call   3996 <exit>
    printf(stdout, "error: open big failed!\n");
     7ee:	51                   	push   %ecx
     7ef:	51                   	push   %ecx
     7f0:	68 85 40 00 00       	push   $0x4085
     7f5:	ff 35 c8 5f 00 00    	push   0x5fc8
     7fb:	e8 00 33 00 00       	call   3b00 <printf>
    exit();
     800:	e8 91 31 00 00       	call   3996 <exit>
    printf(stdout, "error: creat big failed!\n");
     805:	50                   	push   %eax
     806:	50                   	push   %eax
     807:	68 4d 40 00 00       	push   $0x404d
     80c:	ff 35 c8 5f 00 00    	push   0x5fc8
     812:	e8 e9 32 00 00       	call   3b00 <printf>
    exit();
     817:	e8 7a 31 00 00       	call   3996 <exit>
    printf(stdout, "unlink big failed\n");
     81c:	50                   	push   %eax
     81d:	50                   	push   %eax
     81e:	68 cb 40 00 00       	push   $0x40cb
     823:	ff 35 c8 5f 00 00    	push   0x5fc8
     829:	e8 d2 32 00 00       	call   3b00 <printf>
    exit();
     82e:	e8 63 31 00 00       	call   3996 <exit>
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     84c:	68 d8 4e 00 00       	push   $0x4ed8
     851:	ff 35 c8 5f 00 00    	push   0x5fc8
     857:	e8 a4 32 00 00       	call   3b00 <printf>
  name[0] = 'a';
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 4b 31 00 00       	call   39d6 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 2b 31 00 00       	call   39be <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 20 31 00 00       	call   39e6 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d1:	68 00 4f 00 00       	push   $0x4f00
     8d6:	ff 35 c8 5f 00 00    	push   0x5fc8
     8dc:	e8 1f 32 00 00       	call   3b00 <printf>
}
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     8f6:	68 ec 40 00 00       	push   $0x40ec
     8fb:	ff 35 c8 5f 00 00    	push   0x5fc8
     901:	e8 fa 31 00 00       	call   3b00 <printf>
  if(mkdir("dir0") < 0){
     906:	c7 04 24 f8 40 00 00 	movl   $0x40f8,(%esp)
     90d:	e8 ec 30 00 00       	call   39fe <mkdir>
     912:	83 c4 10             	add    $0x10,%esp
     915:	85 c0                	test   %eax,%eax
     917:	78 58                	js     971 <dirtest+0x81>
  if(chdir("dir0") < 0){
     919:	83 ec 0c             	sub    $0xc,%esp
     91c:	68 f8 40 00 00       	push   $0x40f8
     921:	e8 e0 30 00 00       	call   3a06 <chdir>
     926:	83 c4 10             	add    $0x10,%esp
     929:	85 c0                	test   %eax,%eax
     92b:	0f 88 85 00 00 00    	js     9b6 <dirtest+0xc6>
  if(chdir("..") < 0){
     931:	83 ec 0c             	sub    $0xc,%esp
     934:	68 9d 46 00 00       	push   $0x469d
     939:	e8 c8 30 00 00       	call   3a06 <chdir>
     93e:	83 c4 10             	add    $0x10,%esp
     941:	85 c0                	test   %eax,%eax
     943:	78 5a                	js     99f <dirtest+0xaf>
  if(unlink("dir0") < 0){
     945:	83 ec 0c             	sub    $0xc,%esp
     948:	68 f8 40 00 00       	push   $0x40f8
     94d:	e8 94 30 00 00       	call   39e6 <unlink>
     952:	83 c4 10             	add    $0x10,%esp
     955:	85 c0                	test   %eax,%eax
     957:	78 2f                	js     988 <dirtest+0x98>
  printf(stdout, "mkdir test ok\n");
     959:	83 ec 08             	sub    $0x8,%esp
     95c:	68 35 41 00 00       	push   $0x4135
     961:	ff 35 c8 5f 00 00    	push   0x5fc8
     967:	e8 94 31 00 00       	call   3b00 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     971:	50                   	push   %eax
     972:	50                   	push   %eax
     973:	68 28 3e 00 00       	push   $0x3e28
     978:	ff 35 c8 5f 00 00    	push   0x5fc8
     97e:	e8 7d 31 00 00       	call   3b00 <printf>
    exit();
     983:	e8 0e 30 00 00       	call   3996 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 21 41 00 00       	push   $0x4121
     98f:	ff 35 c8 5f 00 00    	push   0x5fc8
     995:	e8 66 31 00 00       	call   3b00 <printf>
    exit();
     99a:	e8 f7 2f 00 00       	call   3996 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 10 41 00 00       	push   $0x4110
     9a6:	ff 35 c8 5f 00 00    	push   0x5fc8
     9ac:	e8 4f 31 00 00       	call   3b00 <printf>
    exit();
     9b1:	e8 e0 2f 00 00       	call   3996 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 fd 40 00 00       	push   $0x40fd
     9bd:	ff 35 c8 5f 00 00    	push   0x5fc8
     9c3:	e8 38 31 00 00       	call   3b00 <printf>
    exit();
     9c8:	e8 c9 2f 00 00       	call   3996 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9d6:	68 44 41 00 00       	push   $0x4144
     9db:	ff 35 c8 5f 00 00    	push   0x5fc8
     9e1:	e8 1a 31 00 00       	call   3b00 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 cc 5f 00 00       	push   $0x5fcc
     9ed:	68 0d 3f 00 00       	push   $0x3f0d
     9f2:	e8 d7 2f 00 00       	call   39ce <exec>
    ...
    printf(stdout, "exec echo failed\n");
     a00:	50                   	push   %eax
     a01:	50                   	push   %eax
     a02:	68 4f 41 00 00       	push   $0x414f
     a07:	ff 35 c8 5f 00 00    	push   0x5fc8
     a0d:	e8 ee 30 00 00       	call   3b00 <printf>
    exit();
     a12:	e8 7f 2f 00 00       	call   3996 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 5c 2f 00 00       	call   39be <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 31 2f 00 00       	call   39ae <read>
     ...
     ab8:	68 7e 41 00 00       	push   $0x417e
     abd:	6a 01                	push   $0x1
     abf:	e8 3c 30 00 00       	call   3b00 <printf>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 e2 2e 00 00       	call   39be <close>
     ...
     b11:	e8 a0 2e 00 00       	call   39b6 <write>
    ...
    exit();
     b28:	e8 69 2e 00 00       	call   3996 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 7d 2e 00 00       	call   39be <close>
    wait();
     b41:	e8 58 2e 00 00       	call   399e <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     b48:	68 a3 41 00 00       	push   $0x41a3
     b4d:	6a 01                	push   $0x1
     b4f:	e8 ac 2f 00 00       	call   3b00 <printf>
     b54:	83 c4 10             	add    $0x10,%esp
     b57:	e9 6b ff ff ff       	jmp    ac7 <pipe1+0xa7>
      printf(1, "pipe1 oops 3 total %d\n", total);
     b5c:	53                   	push   %ebx
     b5d:	ff 75 d4             	push   -0x2c(%ebp)
     b60:	68 8c 41 00 00       	push   $0x418c
     b65:	6a 01                	push   $0x1
     b67:	e8 94 2f 00 00       	call   3b00 <printf>
      exit();
     b6c:	e8 25 2e 00 00       	call   3996 <exit>
    printf(1, "pipe() failed\n");
     b71:	57                   	push   %edi
     b72:	57                   	push   %edi
     b73:	68 61 41 00 00       	push   $0x4161
     b78:	6a 01                	push   $0x1
     b7a:	e8 81 2f 00 00       	call   3b00 <printf>
    exit();
     b7f:	e8 12 2e 00 00       	call   3996 <exit>
    printf(1, "fork() failed\n");
     b84:	50                   	push   %eax
     b85:	50                   	push   %eax
     b86:	68 ad 41 00 00       	push   $0x41ad
     b8b:	6a 01                	push   $0x1
     b8d:	e8 6e 2f 00 00       	call   3b00 <printf>
    exit();
     b92:	e8 ff 2d 00 00       	call   3996 <exit>
        printf(1, "pipe1 oops 1\n");
     b97:	56                   	push   %esi
     b98:	56                   	push   %esi
     b99:	68 70 41 00 00       	push   $0x4170
     b9e:	6a 01                	push   $0x1
     ba0:	e8 5b 2f 00 00       	call   3b00 <printf>
        exit();
     ba5:	e8 ec 2d 00 00       	call   3996 <exit>
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bb9:	68 bc 41 00 00       	push   $0x41bc
     bbe:	6a 01                	push   $0x1
     bc0:	e8 3b 2f 00 00       	call   3b00 <printf>
  pid1 = fork();
     bc5:	e8 c4 2d 00 00       	call   398e <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 af 2d 00 00       	call   398e <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 aa 2d 00 00       	call   39a6 <pipe>
  pid3 = fork();
     bfc:	e8 8d 2d 00 00       	call   398e <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     c10:	e8 a9 2d 00 00       	call   39be <close>
    if(write(pfds[1], "x", 1) != 1)
     c15:	83 c4 0c             	add    $0xc,%esp
     c18:	6a 01                	push   $0x1
     c1a:	68 81 47 00 00       	push   $0x4781
     c1f:	ff 75 e4             	push   -0x1c(%ebp)
     c22:	e8 8f 2d 00 00       	call   39b6 <write>
    ...
    close(pfds[1]);
     ...
     c39:	e8 80 2d 00 00       	call   39be <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 43 2d 00 00       	call   39be <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
     c7d:	68 ed 41 00 00       	push   $0x41ed
     c82:	6a 01                	push   $0x1
     c84:	e8 77 2e 00 00       	call   3b00 <printf>
  kill(pid1);
     c89:	89 1c 24             	mov    %ebx,(%esp)
     c8c:	e8 35 2d 00 00       	call   39c6 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 2d 2d 00 00       	call   39c6 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 25 2d 00 00       	call   39c6 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
     ca3:	68 f6 41 00 00       	push   $0x41f6
     ca8:	6a 01                	push   $0x1
     caa:	e8 51 2e 00 00       	call   3b00 <printf>
  wait();
     caf:	e8 ea 2c 00 00       	call   399e <wait>
  wait();
     cb4:	e8 e5 2c 00 00       	call   399e <wait>
  wait();
     cb9:	e8 e0 2c 00 00       	call   399e <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
     cc0:	68 ff 41 00 00       	push   $0x41ff
     cc5:	6a 01                	push   $0x1
     cc7:	e8 34 2e 00 00       	call   3b00 <printf>
    ...
    printf(1, "preempt read error");
     ...
     cda:	68 da 41 00 00       	push   $0x41da
     cdf:	6a 01                	push   $0x1
     ce1:	e8 1a 2e 00 00       	call   3b00 <printf>
     ce6:	83 c4 10             	add    $0x10,%esp
     ce9:	eb e4                	jmp    ccf <preempt+0x11f>
      printf(1, "preempt write error");
     ceb:	83 ec 08             	sub    $0x8,%esp
     cee:	68 c6 41 00 00       	push   $0x41c6
     cf3:	6a 01                	push   $0x1
     cf5:	e8 06 2e 00 00       	call   3b00 <printf>
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 77 2c 00 00       	call   399e <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 59 2c 00 00       	call   398e <fork>
    ...
    if(pid < 0){
     ...
     d3e:	68 69 4d 00 00       	push   $0x4d69
     d43:	6a 01                	push   $0x1
     d45:	e8 b6 2d 00 00       	call   3b00 <printf>
      return;
     ...
     d5b:	68 0b 42 00 00       	push   $0x420b
     d60:	6a 01                	push   $0x1
     d62:	e8 99 2d 00 00       	call   3b00 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d74:	68 1b 42 00 00       	push   $0x421b
     d79:	6a 01                	push   $0x1
     d7b:	e8 80 2d 00 00       	call   3b00 <printf>
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 07 2c 00 00       	call   3996 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     d9a:	68 28 42 00 00       	push   $0x4228
     d9f:	6a 01                	push   $0x1
     da1:	e8 5a 2d 00 00       	call   3b00 <printf>
  ppid = getpid();
     da6:	e8 6b 2c 00 00       	call   3a16 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 dc 2b 00 00       	call   398e <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dcc:	e8 5f 2f 00 00       	call   3d30 <malloc>
    ...
    while(m1){
     ...
     de5:	8b 36                	mov    (%esi),%esi
      free(m1);
     de7:	50                   	push   %eax
     de8:	e8 b3 2e 00 00       	call   3ca0 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     dfc:	e8 2f 2f 00 00       	call   3d30 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     e0b:	50                   	push   %eax
     e0c:	e8 8f 2e 00 00       	call   3ca0 <free>
    printf(1, "mem ok\n");
     e11:	58                   	pop    %eax
     e12:	5a                   	pop    %edx
     e13:	68 4c 42 00 00       	push   $0x424c
     e18:	6a 01                	push   $0x1
     e1a:	e8 e1 2c 00 00       	call   3b00 <printf>
    exit();
     e1f:	e8 72 2b 00 00       	call   3996 <exit>
     e24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e28:	83 ec 08             	sub    $0x8,%esp
     e2b:	68 32 42 00 00       	push   $0x4232
     e30:	6a 01                	push   $0x1
     e32:	e8 c9 2c 00 00       	call   3b00 <printf>
      kill(ppid);
     e37:	89 1c 24             	mov    %ebx,(%esp)
     e3a:	e8 87 2b 00 00       	call   39c6 <kill>
      exit();
     e3f:	e8 52 2b 00 00       	call   3996 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 4b 2b 00 00       	jmp    399e <wait>
...
00000e60 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     e69:	68 54 42 00 00       	push   $0x4254
     e6e:	6a 01                	push   $0x1
     e70:	e8 8b 2c 00 00       	call   3b00 <printf>
  unlink("sharedfd");
     e75:	c7 04 24 63 42 00 00 	movl   $0x4263,(%esp)
     e7c:	e8 65 2b 00 00       	call   39e6 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 63 42 00 00       	push   $0x4263
     e8d:	e8 44 2b 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 e2 2a 00 00       	call   398e <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 93 2a 00 00       	call   399e <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 a5 2a 00 00       	call   39be <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 63 42 00 00       	push   $0x4263
     f22:	e8 af 2a 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 5d 2a 00 00       	call   39ae <read>
  ...
  close(fd);
     ...
     f86:	e8 33 2a 00 00       	call   39be <close>
  unlink("sharedfd");
     f8b:	c7 04 24 63 42 00 00 	movl   $0x4263,(%esp)
     f92:	e8 4f 2a 00 00       	call   39e6 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fb0:	68 6c 42 00 00       	push   $0x426c
     fb5:	6a 01                	push   $0x1
     fb7:	e8 44 2b 00 00       	call   3b00 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fca:	68 28 4f 00 00       	push   $0x4f28
     fcf:	6a 01                	push   $0x1
     fd1:	e8 2a 2b 00 00       	call   3b00 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fe4:	68 74 4f 00 00       	push   $0x4f74
     fe9:	6a 01                	push   $0x1
     feb:	e8 10 2b 00 00       	call   3b00 <printf>
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 96 29 00 00       	call   3996 <exit>
    printf(1, "sharedfd oops %d %d\n", nc, np);
    1000:	53                   	push   %ebx
    1001:	52                   	push   %edx
    1002:	68 79 42 00 00       	push   $0x4279
    1007:	6a 01                	push   $0x1
    1009:	e8 f2 2a 00 00       	call   3b00 <printf>
    exit();
    100e:	e8 83 29 00 00       	call   3996 <exit>
...
00001020 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1025:	be 8e 42 00 00       	mov    $0x428e,%esi
{
    102a:	53                   	push   %ebx
  for(pi = 0; pi < 4; pi++){
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1030:	c7 45 d8 8e 42 00 00 	movl   $0x428e,-0x28(%ebp)
  printf(1, "fourfiles test\n");
    1037:	68 94 42 00 00       	push   $0x4294
    103c:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    103e:	c7 45 dc d7 43 00 00 	movl   $0x43d7,-0x24(%ebp)
    1045:	c7 45 e0 db 43 00 00 	movl   $0x43db,-0x20(%ebp)
    104c:	c7 45 e4 91 42 00 00 	movl   $0x4291,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    1053:	e8 a8 2a 00 00       	call   3b00 <printf>
    1058:	83 c4 10             	add    $0x10,%esp
    unlink(fname);
    105b:	83 ec 0c             	sub    $0xc,%esp
    105e:	56                   	push   %esi
    105f:	e8 82 29 00 00       	call   39e6 <unlink>
    pid = fork();
    1064:	e8 25 29 00 00       	call   398e <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 11 29 00 00       	call   399e <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 0a 29 00 00       	call   399e <wait>
    1094:	e8 05 29 00 00       	call   399e <wait>
    1099:	e8 00 29 00 00       	call   399e <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 24 29 00 00       	call   39d6 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 d9 28 00 00       	call   39ae <read>
    ...
    1104:	e8 b5 28 00 00       	call   39be <close>
    if(total != 12*500){
    ...
    111e:	e8 c3 28 00 00       	call   39e6 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    112e:	68 d2 42 00 00       	push   $0x42d2
    1133:	6a 01                	push   $0x1
    1135:	e8 c6 29 00 00       	call   3b00 <printf>
}
    ...
    1152:	68 b5 42 00 00       	push   $0x42b5
    1157:	6a 01                	push   $0x1
    1159:	e8 a2 29 00 00       	call   3b00 <printf>
          exit();
    115e:	e8 33 28 00 00       	call   3996 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 65 28 00 00       	call   39d6 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 0b 28 00 00       	call   39b6 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 d7 27 00 00       	call   3996 <exit>
        printf(1, "create failed\n");
    11bf:	51                   	push   %ecx
    11c0:	51                   	push   %ecx
    11c1:	68 2f 45 00 00       	push   $0x452f
    11c6:	6a 01                	push   $0x1
    11c8:	e8 33 29 00 00       	call   3b00 <printf>
        exit();
    11cd:	e8 c4 27 00 00       	call   3996 <exit>
    11d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      printf(1, "fork failed\n");
    11d8:	83 ec 08             	sub    $0x8,%esp
    11db:	68 69 4d 00 00       	push   $0x4d69
    11e0:	6a 01                	push   $0x1
    11e2:	e8 19 29 00 00       	call   3b00 <printf>
      exit();
    11e7:	e8 aa 27 00 00       	call   3996 <exit>
      printf(1, "wrong length %d\n", total);
    11ec:	50                   	push   %eax
    11ed:	53                   	push   %ebx
    11ee:	68 c1 42 00 00       	push   $0x42c1
    11f3:	6a 01                	push   $0x1
    11f5:	e8 06 29 00 00       	call   3b00 <printf>
      exit();
    11fa:	e8 97 27 00 00       	call   3996 <exit>
          printf(1, "write failed %d\n", n);
    11ff:	52                   	push   %edx
    1200:	50                   	push   %eax
    1201:	68 a4 42 00 00       	push   $0x42a4
    1206:	6a 01                	push   $0x1
    1208:	e8 f3 28 00 00       	call   3b00 <printf>
          exit();
    120d:	e8 84 27 00 00       	call   3996 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    122b:	68 e0 42 00 00       	push   $0x42e0
    1230:	6a 01                	push   $0x1
    1232:	e8 c9 28 00 00       	call   3b00 <printf>
    1237:	83 c4 10             	add    $0x10,%esp
    pid = fork();
    123a:	e8 4f 27 00 00       	call   398e <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 44 27 00 00       	call   399e <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 3a 27 00 00       	call   399e <wait>
    1264:	e8 35 27 00 00       	call   399e <wait>
    1269:	e8 30 27 00 00       	call   399e <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 28 27 00 00       	call   39d6 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 ec 26 00 00       	call   39be <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 d6 26 00 00       	call   39e6 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1324:	68 f3 42 00 00       	push   $0x42f3
    1329:	6a 01                	push   $0x1
    132b:	e8 d0 27 00 00       	call   3b00 <printf>
}
    ...
    1344:	50                   	push   %eax
    1345:	57                   	push   %edi
    1346:	68 c4 4f 00 00       	push   $0x4fc4
    134b:	6a 01                	push   $0x1
    134d:	e8 ae 27 00 00       	call   3b00 <printf>
        exit();
    1352:	e8 3f 26 00 00       	call   3996 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 37 26 00 00       	call   39d6 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 0f 26 00 00       	call   39be <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 18 26 00 00       	call   39e6 <unlink>
    ...
    13d5:	52                   	push   %edx
    13d6:	52                   	push   %edx
    13d7:	68 e1 3e 00 00       	push   $0x3ee1
    13dc:	6a 01                	push   $0x1
    13de:	e8 1d 27 00 00       	call   3b00 <printf>
            exit();
    13e3:	e8 ae 25 00 00       	call   3996 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 a1 25 00 00       	call   3996 <exit>
        printf(1, "oops createdelete %s didn't exist\n", name);
    13f5:	83 ec 04             	sub    $0x4,%esp
    13f8:	57                   	push   %edi
    13f9:	68 a0 4f 00 00       	push   $0x4fa0
    13fe:	6a 01                	push   $0x1
    1400:	e8 fb 26 00 00       	call   3b00 <printf>
        exit();
    1405:	e8 8c 25 00 00       	call   3996 <exit>
      printf(1, "fork failed\n");
    140a:	83 ec 08             	sub    $0x8,%esp
    140d:	68 69 4d 00 00       	push   $0x4d69
    1412:	6a 01                	push   $0x1
    1414:	e8 e7 26 00 00       	call   3b00 <printf>
      exit();
    1419:	e8 78 25 00 00       	call   3996 <exit>
          printf(1, "create failed\n");
    141e:	83 ec 08             	sub    $0x8,%esp
    1421:	68 2f 45 00 00       	push   $0x452f
    1426:	6a 01                	push   $0x1
    1428:	e8 d3 26 00 00       	call   3b00 <printf>
          exit();
    142d:	e8 64 25 00 00       	call   3996 <exit>
...
00001440 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1448:	68 04 43 00 00       	push   $0x4304
    144d:	6a 01                	push   $0x1
    144f:	e8 ac 26 00 00       	call   3b00 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1454:	5b                   	pop    %ebx
    1455:	5e                   	pop    %esi
    1456:	68 02 02 00 00       	push   $0x202
    145b:	68 15 43 00 00       	push   $0x4315
    1460:	e8 71 25 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    1475:	6a 05                	push   $0x5
    1477:	68 3a 43 00 00       	push   $0x433a
    147c:	50                   	push   %eax
    147d:	e8 34 25 00 00       	call   39b6 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 34 25 00 00       	call   39be <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 15 43 00 00       	push   $0x4315
    1493:	e8 3e 25 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14a8:	68 15 43 00 00       	push   $0x4315
    14ad:	e8 34 25 00 00       	call   39e6 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14c5:	68 15 43 00 00       	push   $0x4315
    14ca:	e8 07 25 00 00       	call   39d6 <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    14d6:	68 72 43 00 00       	push   $0x4372
    14db:	50                   	push   %eax
    14dc:	e8 d5 24 00 00       	call   39b6 <write>
  close(fd1);
    14e1:	89 34 24             	mov    %esi,(%esp)
    14e4:	e8 d5 24 00 00       	call   39be <close>
  if(read(fd, buf, sizeof(buf)) != 5){
    14e9:	83 c4 0c             	add    $0xc,%esp
    14ec:	68 00 20 00 00       	push   $0x2000
    14f1:	68 00 87 00 00       	push   $0x8700
    14f6:	53                   	push   %ebx
    14f7:	e8 b2 24 00 00       	call   39ae <read>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 95 24 00 00       	call   39b6 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 8c 24 00 00       	call   39be <close>
  unlink("unlinkread");
    1532:	c7 04 24 15 43 00 00 	movl   $0x4315,(%esp)
    1539:	e8 a8 24 00 00       	call   39e6 <unlink>
  printf(1, "unlinkread ok\n");
    153e:	58                   	pop    %eax
    153f:	5a                   	pop    %edx
    1540:	68 bd 43 00 00       	push   $0x43bd
    1545:	6a 01                	push   $0x1
    1547:	e8 b4 25 00 00       	call   3b00 <printf>
}
    ...
    1556:	51                   	push   %ecx
    1557:	51                   	push   %ecx
    1558:	68 20 43 00 00       	push   $0x4320
    155d:	6a 01                	push   $0x1
    155f:	e8 9c 25 00 00       	call   3b00 <printf>
    exit();
    1564:	e8 2d 24 00 00       	call   3996 <exit>
    printf(1, "unlinkread write failed\n");
    1569:	51                   	push   %ecx
    156a:	51                   	push   %ecx
    156b:	68 a4 43 00 00       	push   $0x43a4
    1570:	6a 01                	push   $0x1
    1572:	e8 89 25 00 00       	call   3b00 <printf>
    exit();
    1577:	e8 1a 24 00 00       	call   3996 <exit>
    printf(1, "unlinkread wrong data\n");
    157c:	53                   	push   %ebx
    157d:	53                   	push   %ebx
    157e:	68 8d 43 00 00       	push   $0x438d
    1583:	6a 01                	push   $0x1
    1585:	e8 76 25 00 00       	call   3b00 <printf>
    exit();
    158a:	e8 07 24 00 00       	call   3996 <exit>
    printf(1, "unlinkread read failed");
    158f:	56                   	push   %esi
    1590:	56                   	push   %esi
    1591:	68 76 43 00 00       	push   $0x4376
    1596:	6a 01                	push   $0x1
    1598:	e8 63 25 00 00       	call   3b00 <printf>
    exit();
    159d:	e8 f4 23 00 00       	call   3996 <exit>
    printf(1, "unlink unlinkread failed\n");
    15a2:	50                   	push   %eax
    15a3:	50                   	push   %eax
    15a4:	68 58 43 00 00       	push   $0x4358
    15a9:	6a 01                	push   $0x1
    15ab:	e8 50 25 00 00       	call   3b00 <printf>
    exit();
    15b0:	e8 e1 23 00 00       	call   3996 <exit>
    printf(1, "open unlinkread failed\n");
    15b5:	50                   	push   %eax
    15b6:	50                   	push   %eax
    15b7:	68 40 43 00 00       	push   $0x4340
    15bc:	6a 01                	push   $0x1
    15be:	e8 3d 25 00 00       	call   3b00 <printf>
    exit();
    15c3:	e8 ce 23 00 00       	call   3996 <exit>
...
000015d0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15d7:	68 cc 43 00 00       	push   $0x43cc
    15dc:	6a 01                	push   $0x1
    15de:	e8 1d 25 00 00       	call   3b00 <printf>
  unlink("lf1");
    15e3:	c7 04 24 d6 43 00 00 	movl   $0x43d6,(%esp)
    15ea:	e8 f7 23 00 00       	call   39e6 <unlink>
  unlink("lf2");
    15ef:	c7 04 24 da 43 00 00 	movl   $0x43da,(%esp)
    15f6:	e8 eb 23 00 00       	call   39e6 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15fb:	58                   	pop    %eax
    15fc:	5a                   	pop    %edx
    15fd:	68 02 02 00 00       	push   $0x202
    1602:	68 d6 43 00 00       	push   $0x43d6
    1607:	e8 ca 23 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    161c:	6a 05                	push   $0x5
    161e:	68 3a 43 00 00       	push   $0x433a
    1623:	50                   	push   %eax
    1624:	e8 8d 23 00 00       	call   39b6 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 80 23 00 00       	call   39be <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 da 43 00 00       	push   $0x43da
    1645:	68 d6 43 00 00       	push   $0x43d6
    164a:	e8 a7 23 00 00       	call   39f6 <link>
    164f:	83 c4 10             	add    $0x10,%esp
    1652:	85 c0                	test   %eax,%eax
    1654:	0f 88 60 01 00 00    	js     17ba <linktest+0x1ea>
  unlink("lf1");
    165a:	83 ec 0c             	sub    $0xc,%esp
    165d:	68 d6 43 00 00       	push   $0x43d6
    1662:	e8 7f 23 00 00       	call   39e6 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 d6 43 00 00       	push   $0x43d6
    1670:	e8 61 23 00 00       	call   39d6 <open>
  ...
  fd = open("lf2", 0);
    ...
    1683:	6a 00                	push   $0x0
    1685:	68 da 43 00 00       	push   $0x43da
    168a:	e8 47 23 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 ff 22 00 00       	call   39ae <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 fa 22 00 00       	call   39be <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 da 43 00 00       	push   $0x43da
    16cb:	68 da 43 00 00       	push   $0x43da
    16d0:	e8 21 23 00 00       	call   39f6 <link>
    16d5:	83 c4 10             	add    $0x10,%esp
    16d8:	85 c0                	test   %eax,%eax
    16da:	0f 89 8e 00 00 00    	jns    176e <linktest+0x19e>
  unlink("lf2");
    16e0:	83 ec 0c             	sub    $0xc,%esp
    16e3:	68 da 43 00 00       	push   $0x43da
    16e8:	e8 f9 22 00 00       	call   39e6 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 d6 43 00 00       	push   $0x43d6
    16f4:	68 da 43 00 00       	push   $0x43da
    16f9:	e8 f8 22 00 00       	call   39f6 <link>
    16fe:	83 c4 10             	add    $0x10,%esp
    1701:	85 c0                	test   %eax,%eax
    1703:	79 56                	jns    175b <linktest+0x18b>
  if(link(".", "lf1") >= 0){
    1705:	83 ec 08             	sub    $0x8,%esp
    1708:	68 d6 43 00 00       	push   $0x43d6
    170d:	68 9e 46 00 00       	push   $0x469e
    1712:	e8 df 22 00 00       	call   39f6 <link>
    1717:	83 c4 10             	add    $0x10,%esp
    171a:	85 c0                	test   %eax,%eax
    171c:	79 2a                	jns    1748 <linktest+0x178>
  printf(1, "linktest ok\n");
    171e:	83 ec 08             	sub    $0x8,%esp
    1721:	68 74 44 00 00       	push   $0x4474
    1726:	6a 01                	push   $0x1
    1728:	e8 d3 23 00 00       	call   3b00 <printf>
}
    ...
    1735:	50                   	push   %eax
    1736:	50                   	push   %eax
    1737:	68 de 43 00 00       	push   $0x43de
    173c:	6a 01                	push   $0x1
    173e:	e8 bd 23 00 00       	call   3b00 <printf>
    exit();
    1743:	e8 4e 22 00 00       	call   3996 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1748:	50                   	push   %eax
    1749:	50                   	push   %eax
    174a:	68 58 44 00 00       	push   $0x4458
    174f:	6a 01                	push   $0x1
    1751:	e8 aa 23 00 00       	call   3b00 <printf>
    exit();
    1756:	e8 3b 22 00 00       	call   3996 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    175b:	52                   	push   %edx
    175c:	52                   	push   %edx
    175d:	68 0c 50 00 00       	push   $0x500c
    1762:	6a 01                	push   $0x1
    1764:	e8 97 23 00 00       	call   3b00 <printf>
    exit();
    1769:	e8 28 22 00 00       	call   3996 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    176e:	50                   	push   %eax
    176f:	50                   	push   %eax
    1770:	68 3a 44 00 00       	push   $0x443a
    1775:	6a 01                	push   $0x1
    1777:	e8 84 23 00 00       	call   3b00 <printf>
    exit();
    177c:	e8 15 22 00 00       	call   3996 <exit>
    printf(1, "read lf2 failed\n");
    1781:	51                   	push   %ecx
    1782:	51                   	push   %ecx
    1783:	68 29 44 00 00       	push   $0x4429
    1788:	6a 01                	push   $0x1
    178a:	e8 71 23 00 00       	call   3b00 <printf>
    exit();
    178f:	e8 02 22 00 00       	call   3996 <exit>
    printf(1, "open lf2 failed\n");
    1794:	53                   	push   %ebx
    1795:	53                   	push   %ebx
    1796:	68 18 44 00 00       	push   $0x4418
    179b:	6a 01                	push   $0x1
    179d:	e8 5e 23 00 00       	call   3b00 <printf>
    exit();
    17a2:	e8 ef 21 00 00       	call   3996 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    17a7:	50                   	push   %eax
    17a8:	50                   	push   %eax
    17a9:	68 e4 4f 00 00       	push   $0x4fe4
    17ae:	6a 01                	push   $0x1
    17b0:	e8 4b 23 00 00       	call   3b00 <printf>
    exit();
    17b5:	e8 dc 21 00 00       	call   3996 <exit>
    printf(1, "link lf1 lf2 failed\n");
    17ba:	51                   	push   %ecx
    17bb:	51                   	push   %ecx
    17bc:	68 03 44 00 00       	push   $0x4403
    17c1:	6a 01                	push   $0x1
    17c3:	e8 38 23 00 00       	call   3b00 <printf>
    exit();
    17c8:	e8 c9 21 00 00       	call   3996 <exit>
    printf(1, "write lf1 failed\n");
    17cd:	50                   	push   %eax
    17ce:	50                   	push   %eax
    17cf:	68 f1 43 00 00       	push   $0x43f1
    17d4:	6a 01                	push   $0x1
    17d6:	e8 25 23 00 00       	call   3b00 <printf>
    exit();
    17db:	e8 b6 21 00 00       	call   3996 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17ee:	68 81 44 00 00       	push   $0x4481
    17f3:	6a 01                	push   $0x1
    17f5:	e8 06 23 00 00       	call   3b00 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 a7 21 00 00       	call   39d6 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 7c 21 00 00       	call   39be <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 54 21 00 00       	call   399e <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 84 21 00 00       	call   39e6 <unlink>
    pid = fork();
    1862:	e8 27 21 00 00       	call   398e <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 4c 21 00 00       	call   39d6 <open>
      if(fd < 0){
    ...
    1898:	53                   	push   %ebx
    1899:	68 94 44 00 00       	push   $0x4494
    189e:	6a 01                	push   $0x1
    18a0:	e8 5b 22 00 00       	call   3b00 <printf>
        exit();
    18a5:	e8 ec 20 00 00       	call   3996 <exit>
    18aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      link("C0", file);
    18b0:	83 ec 08             	sub    $0x8,%esp
    18b3:	53                   	push   %ebx
    18b4:	68 91 44 00 00       	push   $0x4491
    18b9:	e8 38 21 00 00       	call   39f6 <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 d0 20 00 00       	call   3996 <exit>
  ...
  for(i = 0; i < 40; i++){
    18d3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18d6:	53                   	push   %ebx
    18d7:	68 91 44 00 00       	push   $0x4491
    18dc:	e8 15 21 00 00       	call   39f6 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 b5 20 00 00       	call   399e <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    1903:	5f                   	pop    %edi
    1904:	6a 00                	push   $0x0
    1906:	68 9e 46 00 00       	push   $0x469e
    190b:	8d 7d b0             	lea    -0x50(%ebp),%edi
    190e:	e8 c3 20 00 00       	call   39d6 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 82 20 00 00       	call   39ae <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 45 20 00 00       	call   39be <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 44 20 00 00       	call   39e6 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 3c 20 00 00       	call   39e6 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 34 20 00 00       	call   39e6 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 2c 20 00 00       	call   39e6 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 d4 1f 00 00       	call   399e <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 ad 1f 00 00       	call   398e <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 c6 1f 00 00       	call   39d6 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 a6 1f 00 00       	call   39be <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 b4 1f 00 00       	call   39d6 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 94 1f 00 00       	call   39be <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 a2 1f 00 00       	call   39d6 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 82 1f 00 00       	call   39be <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 90 1f 00 00       	call   39d6 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 70 1f 00 00       	call   39be <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a63:	68 e6 44 00 00       	push   $0x44e6
    1a68:	6a 01                	push   $0x1
    1a6a:	e8 91 20 00 00       	call   3b00 <printf>
}
    ...
    1a7a:	68 69 4d 00 00       	push   $0x4d69
    1a7f:	6a 01                	push   $0x1
    1a81:	e8 7a 20 00 00       	call   3b00 <printf>
      exit();
    1a86:	e8 0b 1f 00 00       	call   3996 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a8b:	51                   	push   %ecx
    1a8c:	51                   	push   %ecx
    1a8d:	68 30 50 00 00       	push   $0x5030
    1a92:	6a 01                	push   $0x1
    1a94:	e8 67 20 00 00       	call   3b00 <printf>
    exit();
    1a99:	e8 f8 1e 00 00       	call   3996 <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    1a9e:	83 ec 04             	sub    $0x4,%esp
    1aa1:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1aa4:	50                   	push   %eax
    1aa5:	68 c9 44 00 00       	push   $0x44c9
    1aaa:	6a 01                	push   $0x1
    1aac:	e8 4f 20 00 00       	call   3b00 <printf>
        exit();
    1ab1:	e8 e0 1e 00 00       	call   3996 <exit>
        printf(1, "concreate weird file %s\n", de.name);
    1ab6:	83 ec 04             	sub    $0x4,%esp
    1ab9:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1abc:	50                   	push   %eax
    1abd:	68 b0 44 00 00       	push   $0x44b0
    1ac2:	6a 01                	push   $0x1
    1ac4:	e8 37 20 00 00       	call   3b00 <printf>
        exit();
    1ac9:	e8 c8 1e 00 00       	call   3996 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 e7 1e 00 00       	call   39be <close>
...
00001ae0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ae9:	68 f4 44 00 00       	push   $0x44f4
    1aee:	6a 01                	push   $0x1
    1af0:	e8 0b 20 00 00       	call   3b00 <printf>
  unlink("x");
    1af5:	c7 04 24 81 47 00 00 	movl   $0x4781,(%esp)
    1afc:	e8 e5 1e 00 00       	call   39e6 <unlink>
  pid = fork();
    1b01:	e8 88 1e 00 00       	call   398e <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b38:	68 81 47 00 00       	push   $0x4781
    1b3d:	e8 a4 1e 00 00       	call   39e6 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b71:	68 81 47 00 00       	push   $0x4781
    1b76:	e8 5b 1e 00 00       	call   39d6 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 3b 1e 00 00       	call   39be <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 07 1e 00 00       	call   399e <wait>
  printf(1, "linkunlink ok\n");
    1b97:	83 ec 08             	sub    $0x8,%esp
    1b9a:	68 09 45 00 00       	push   $0x4509
    1b9f:	6a 01                	push   $0x1
    1ba1:	e8 5a 1f 00 00       	call   3b00 <printf>
}
    ...
    1bb3:	68 81 47 00 00       	push   $0x4781
    1bb8:	68 05 45 00 00       	push   $0x4505
    1bbd:	e8 34 1e 00 00       	call   39f6 <link>
    1bc2:	83 c4 10             	add    $0x10,%esp
    1bc5:	e9 7b ff ff ff       	jmp    1b45 <linkunlink+0x65>
    printf(1, "fork failed\n");
    1bca:	52                   	push   %edx
    1bcb:	52                   	push   %edx
    1bcc:	68 69 4d 00 00       	push   $0x4d69
    1bd1:	6a 01                	push   $0x1
    1bd3:	e8 28 1f 00 00       	call   3b00 <printf>
    exit();
    1bd8:	e8 b9 1d 00 00       	call   3996 <exit>
    exit();
    1bdd:	e8 b4 1d 00 00       	call   3996 <exit>
...
00001bf0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1bf9:	68 18 45 00 00       	push   $0x4518
    1bfe:	6a 01                	push   $0x1
    1c00:	e8 fb 1e 00 00       	call   3b00 <printf>
  unlink("bd");
    1c05:	c7 04 24 25 45 00 00 	movl   $0x4525,(%esp)
    1c0c:	e8 d5 1d 00 00       	call   39e6 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 25 45 00 00       	push   $0x4525
    1c1d:	e8 b4 1d 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 83 1d 00 00       	call   39be <close>
    ...
    if(link("bd", name) != 0){
    1c50:	68 25 45 00 00       	push   $0x4525
    name[1] = '0' + (i / 64);
    ...
    if(link("bd", name) != 0){
    1c67:	e8 8a 1d 00 00       	call   39f6 <link>
  ...
  unlink("bd");
    ...
    1c83:	68 25 45 00 00       	push   $0x4525
    1c88:	e8 59 1d 00 00       	call   39e6 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 2f 1d 00 00       	call   39e6 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ccc:	68 67 45 00 00       	push   $0x4567
    1cd1:	6a 01                	push   $0x1
    1cd3:	e8 28 1e 00 00       	call   3b00 <printf>
    ...
    1ce6:	68 3e 45 00 00       	push   $0x453e
    1ceb:	6a 01                	push   $0x1
    1ced:	e8 0e 1e 00 00       	call   3b00 <printf>
      exit();
    1cf2:	e8 9f 1c 00 00       	call   3996 <exit>
      printf(1, "bigdir unlink failed");
    1cf7:	83 ec 08             	sub    $0x8,%esp
    1cfa:	68 52 45 00 00       	push   $0x4552
    1cff:	6a 01                	push   $0x1
    1d01:	e8 fa 1d 00 00       	call   3b00 <printf>
      exit();
    1d06:	e8 8b 1c 00 00       	call   3996 <exit>
    printf(1, "bigdir create failed\n");
    1d0b:	50                   	push   %eax
    1d0c:	50                   	push   %eax
    1d0d:	68 28 45 00 00       	push   $0x4528
    1d12:	6a 01                	push   $0x1
    1d14:	e8 e7 1d 00 00       	call   3b00 <printf>
    exit();
    1d19:	e8 78 1c 00 00       	call   3996 <exit>
...
00001d20 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d27:	68 72 45 00 00       	push   $0x4572
    1d2c:	6a 01                	push   $0x1
    1d2e:	e8 cd 1d 00 00       	call   3b00 <printf>
  unlink("ff");
    1d33:	c7 04 24 fb 45 00 00 	movl   $0x45fb,(%esp)
    1d3a:	e8 a7 1c 00 00       	call   39e6 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d46:	e8 b3 1c 00 00       	call   39fe <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d5e:	68 d1 45 00 00       	push   $0x45d1
    1d63:	e8 6e 1c 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d78:	6a 02                	push   $0x2
    1d7a:	68 fb 45 00 00       	push   $0x45fb
    1d7f:	50                   	push   %eax
    1d80:	e8 31 1c 00 00       	call   39b6 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 31 1c 00 00       	call   39be <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d94:	e8 4d 1c 00 00       	call   39e6 <unlink>
    1d99:	83 c4 10             	add    $0x10,%esp
    1d9c:	85 c0                	test   %eax,%eax
    1d9e:	0f 89 3f 05 00 00    	jns    22e3 <subdir+0x5c3>
  if(mkdir("/dd/dd") != 0){
    1da4:	83 ec 0c             	sub    $0xc,%esp
    1da7:	68 ac 45 00 00       	push   $0x45ac
    1dac:	e8 4d 1c 00 00       	call   39fe <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc4:	68 ce 45 00 00       	push   $0x45ce
    1dc9:	e8 08 1c 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dde:	6a 02                	push   $0x2
    1de0:	68 ef 45 00 00       	push   $0x45ef
    1de5:	50                   	push   %eax
    1de6:	e8 cb 1b 00 00       	call   39b6 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 cb 1b 00 00       	call   39be <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 f2 45 00 00       	push   $0x45f2
    1dfc:	e8 d5 1b 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 8d 1b 00 00       	call   39ae <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 7b 1b 00 00       	call   39be <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 32 46 00 00       	push   $0x4632
    1e4a:	68 ce 45 00 00       	push   $0x45ce
    1e4f:	e8 a2 1b 00 00       	call   39f6 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e62:	68 ce 45 00 00       	push   $0x45ce
    1e67:	e8 7a 1b 00 00       	call   39e6 <unlink>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ef4:	6a 00                	push   $0x0
    1ef6:	68 32 46 00 00       	push   $0x4632
    1efb:	e8 d6 1a 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 8e 1a 00 00       	call   39ae <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 89 1a 00 00       	call   39be <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 ce 45 00 00       	push   $0x45ce
    1f3e:	e8 93 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f56:	68 e6 46 00 00       	push   $0x46e6
    1f5b:	e8 76 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f73:	68 0b 47 00 00       	push   $0x470b
    1f78:	e8 59 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f90:	68 98 46 00 00       	push   $0x4698
    1f95:	e8 3c 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1fa8:	6a 02                	push   $0x2
    1faa:	68 98 46 00 00       	push   $0x4698
    1faf:	e8 22 1a 00 00       	call   39d6 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc2:	6a 01                	push   $0x1
    1fc4:	68 98 46 00 00       	push   $0x4698
    1fc9:	e8 08 1a 00 00       	call   39d6 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fdc:	68 7a 47 00 00       	push   $0x477a
    1fe1:	68 e6 46 00 00       	push   $0x46e6
    1fe6:	e8 0b 1a 00 00       	call   39f6 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff9:	68 7a 47 00 00       	push   $0x477a
    1ffe:	68 0b 47 00 00       	push   $0x470b
    2003:	e8 ee 19 00 00       	call   39f6 <link>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2063:	68 32 46 00 00       	push   $0x4632
    2068:	e8 91 19 00 00       	call   39fe <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    207b:	68 0b 47 00 00       	push   $0x470b
    2080:	e8 61 19 00 00       	call   39e6 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2167:	50                   	push   %eax
    2168:	50                   	push   %eax
    2169:	68 17 46 00 00       	push   $0x4617
    216e:	6a 01                	push   $0x1
    2170:	e8 8b 19 00 00       	call   3b00 <printf>
    exit();
    2175:	e8 1c 18 00 00       	call   3996 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    217a:	50                   	push   %eax
    217b:	50                   	push   %eax
    217c:	68 72 46 00 00       	push   $0x4672
    2181:	6a 01                	push   $0x1
    2183:	e8 78 19 00 00       	call   3b00 <printf>
    exit();
    2188:	e8 09 18 00 00       	call   3996 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    218d:	50                   	push   %eax
    218e:	50                   	push   %eax
    218f:	68 3d 46 00 00       	push   $0x463d
    2194:	6a 01                	push   $0x1
    2196:	e8 65 19 00 00       	call   3b00 <printf>
    exit();
    219b:	e8 f6 17 00 00       	call   3996 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    21a0:	51                   	push   %ecx
    21a1:	51                   	push   %ecx
    21a2:	68 ef 46 00 00       	push   $0x46ef
    21a7:	6a 01                	push   $0x1
    21a9:	e8 52 19 00 00       	call   3b00 <printf>
    exit();
    21ae:	e8 e3 17 00 00       	call   3996 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    21b3:	53                   	push   %ebx
    21b4:	53                   	push   %ebx
    21b5:	68 d4 50 00 00       	push   $0x50d4
    21ba:	6a 01                	push   $0x1
    21bc:	e8 3f 19 00 00       	call   3b00 <printf>
    exit();
    21c1:	e8 d0 17 00 00       	call   3996 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21c6:	51                   	push   %ecx
    21c7:	51                   	push   %ecx
    21c8:	68 83 47 00 00       	push   $0x4783
    21cd:	6a 01                	push   $0x1
    21cf:	e8 2c 19 00 00       	call   3b00 <printf>
    exit();
    21d4:	e8 bd 17 00 00       	call   3996 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21d9:	53                   	push   %ebx
    21da:	53                   	push   %ebx
    21db:	68 44 51 00 00       	push   $0x5144
    21e0:	6a 01                	push   $0x1
    21e2:	e8 19 19 00 00       	call   3b00 <printf>
    exit();
    21e7:	e8 aa 17 00 00       	call   3996 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21ec:	50                   	push   %eax
    21ed:	50                   	push   %eax
    21ee:	68 fe 45 00 00       	push   $0x45fe
    21f3:	6a 01                	push   $0x1
    21f5:	e8 06 19 00 00       	call   3b00 <printf>
    exit();
    21fa:	e8 97 17 00 00       	call   3996 <exit>
    printf(1, "create dd/dd/ff failed\n");
    21ff:	51                   	push   %ecx
    2200:	51                   	push   %ecx
    2201:	68 d7 45 00 00       	push   $0x45d7
    2206:	6a 01                	push   $0x1
    2208:	e8 f3 18 00 00       	call   3b00 <printf>
    exit();
    220d:	e8 84 17 00 00       	call   3996 <exit>
    printf(1, "chdir ./.. failed\n");
    2212:	50                   	push   %eax
    2213:	50                   	push   %eax
    2214:	68 a0 46 00 00       	push   $0x46a0
    2219:	6a 01                	push   $0x1
    221b:	e8 e0 18 00 00       	call   3b00 <printf>
    exit();
    2220:	e8 71 17 00 00       	call   3996 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2225:	52                   	push   %edx
    2226:	52                   	push   %edx
    2227:	68 8c 50 00 00       	push   $0x508c
    222c:	6a 01                	push   $0x1
    222e:	e8 cd 18 00 00       	call   3b00 <printf>
    exit();
    2233:	e8 5e 17 00 00       	call   3996 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2238:	50                   	push   %eax
    2239:	50                   	push   %eax
    223a:	68 20 51 00 00       	push   $0x5120
    223f:	6a 01                	push   $0x1
    2241:	e8 ba 18 00 00       	call   3b00 <printf>
    exit();
    2246:	e8 4b 17 00 00       	call   3996 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    224b:	50                   	push   %eax
    224c:	50                   	push   %eax
    224d:	68 fc 50 00 00       	push   $0x50fc
    2252:	6a 01                	push   $0x1
    2254:	e8 a7 18 00 00       	call   3b00 <printf>
    exit();
    2259:	e8 38 17 00 00       	call   3996 <exit>
    printf(1, "open dd wronly succeeded!\n");
    225e:	50                   	push   %eax
    225f:	50                   	push   %eax
    2260:	68 5f 47 00 00       	push   $0x475f
    2265:	6a 01                	push   $0x1
    2267:	e8 94 18 00 00       	call   3b00 <printf>
    exit();
    226c:	e8 25 17 00 00       	call   3996 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2271:	50                   	push   %eax
    2272:	50                   	push   %eax
    2273:	68 46 47 00 00       	push   $0x4746
    2278:	6a 01                	push   $0x1
    227a:	e8 81 18 00 00       	call   3b00 <printf>
    exit();
    227f:	e8 12 17 00 00       	call   3996 <exit>
    printf(1, "create dd succeeded!\n");
    2284:	50                   	push   %eax
    2285:	50                   	push   %eax
    2286:	68 30 47 00 00       	push   $0x4730
    228b:	6a 01                	push   $0x1
    228d:	e8 6e 18 00 00       	call   3b00 <printf>
    exit();
    2292:	e8 ff 16 00 00       	call   3996 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2297:	52                   	push   %edx
    2298:	52                   	push   %edx
    2299:	68 14 47 00 00       	push   $0x4714
    229e:	6a 01                	push   $0x1
    22a0:	e8 5b 18 00 00       	call   3b00 <printf>
    exit();
    22a5:	e8 ec 16 00 00       	call   3996 <exit>
    printf(1, "chdir dd failed\n");
    22aa:	50                   	push   %eax
    22ab:	50                   	push   %eax
    22ac:	68 55 46 00 00       	push   $0x4655
    22b1:	6a 01                	push   $0x1
    22b3:	e8 48 18 00 00       	call   3b00 <printf>
    exit();
    22b8:	e8 d9 16 00 00       	call   3996 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    22bf:	68 b0 50 00 00       	push   $0x50b0
    22c4:	6a 01                	push   $0x1
    22c6:	e8 35 18 00 00       	call   3b00 <printf>
    exit();
    22cb:	e8 c6 16 00 00       	call   3996 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22d0:	53                   	push   %ebx
    22d1:	53                   	push   %ebx
    22d2:	68 b3 45 00 00       	push   $0x45b3
    22d7:	6a 01                	push   $0x1
    22d9:	e8 22 18 00 00       	call   3b00 <printf>
    exit();
    22de:	e8 b3 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22e3:	50                   	push   %eax
    22e4:	50                   	push   %eax
    22e5:	68 64 50 00 00       	push   $0x5064
    22ea:	6a 01                	push   $0x1
    22ec:	e8 0f 18 00 00       	call   3b00 <printf>
    exit();
    22f1:	e8 a0 16 00 00       	call   3996 <exit>
    printf(1, "create dd/ff failed\n");
    22f6:	50                   	push   %eax
    22f7:	50                   	push   %eax
    22f8:	68 97 45 00 00       	push   $0x4597
    22fd:	6a 01                	push   $0x1
    22ff:	e8 fc 17 00 00       	call   3b00 <printf>
    exit();
    2304:	e8 8d 16 00 00       	call   3996 <exit>
    printf(1, "subdir mkdir dd failed\n");
    2309:	50                   	push   %eax
    230a:	50                   	push   %eax
    230b:	68 7f 45 00 00       	push   $0x457f
    2310:	6a 01                	push   $0x1
    2312:	e8 e9 17 00 00       	call   3b00 <printf>
    exit();
    2317:	e8 7a 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd failed\n");
    231c:	50                   	push   %eax
    231d:	50                   	push   %eax
    231e:	68 68 48 00 00       	push   $0x4868
    2323:	6a 01                	push   $0x1
    2325:	e8 d6 17 00 00       	call   3b00 <printf>
    exit();
    232a:	e8 67 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd/dd failed\n");
    232f:	52                   	push   %edx
    2330:	52                   	push   %edx
    2331:	68 53 48 00 00       	push   $0x4853
    2336:	6a 01                	push   $0x1
    2338:	e8 c3 17 00 00       	call   3b00 <printf>
    exit();
    233d:	e8 54 16 00 00       	call   3996 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2342:	51                   	push   %ecx
    2343:	51                   	push   %ecx
    2344:	68 68 51 00 00       	push   $0x5168
    2349:	6a 01                	push   $0x1
    234b:	e8 b0 17 00 00       	call   3b00 <printf>
    exit();
    2350:	e8 41 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd/ff failed\n");
    2355:	53                   	push   %ebx
    2356:	53                   	push   %ebx
    2357:	68 3e 48 00 00       	push   $0x483e
    235c:	6a 01                	push   $0x1
    235e:	e8 9d 17 00 00       	call   3b00 <printf>
    exit();
    2363:	e8 2e 16 00 00       	call   3996 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2368:	50                   	push   %eax
    2369:	50                   	push   %eax
    236a:	68 26 48 00 00       	push   $0x4826
    236f:	6a 01                	push   $0x1
    2371:	e8 8a 17 00 00       	call   3b00 <printf>
    exit();
    2376:	e8 1b 16 00 00       	call   3996 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    237b:	50                   	push   %eax
    237c:	50                   	push   %eax
    237d:	68 0e 48 00 00       	push   $0x480e
    2382:	6a 01                	push   $0x1
    2384:	e8 77 17 00 00       	call   3b00 <printf>
    exit();
    2389:	e8 08 16 00 00       	call   3996 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    238e:	50                   	push   %eax
    238f:	50                   	push   %eax
    2390:	68 f2 47 00 00       	push   $0x47f2
    2395:	6a 01                	push   $0x1
    2397:	e8 64 17 00 00       	call   3b00 <printf>
    exit();
    239c:	e8 f5 15 00 00       	call   3996 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    23a1:	50                   	push   %eax
    23a2:	50                   	push   %eax
    23a3:	68 d6 47 00 00       	push   $0x47d6
    23a8:	6a 01                	push   $0x1
    23aa:	e8 51 17 00 00       	call   3b00 <printf>
    exit();
    23af:	e8 e2 15 00 00       	call   3996 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    23b4:	50                   	push   %eax
    23b5:	50                   	push   %eax
    23b6:	68 b9 47 00 00       	push   $0x47b9
    23bb:	6a 01                	push   $0x1
    23bd:	e8 3e 17 00 00       	call   3b00 <printf>
    exit();
    23c2:	e8 cf 15 00 00       	call   3996 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23c7:	52                   	push   %edx
    23c8:	52                   	push   %edx
    23c9:	68 9e 47 00 00       	push   $0x479e
    23ce:	6a 01                	push   $0x1
    23d0:	e8 2b 17 00 00       	call   3b00 <printf>
    exit();
    23d5:	e8 bc 15 00 00       	call   3996 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23da:	51                   	push   %ecx
    23db:	51                   	push   %ecx
    23dc:	68 cb 46 00 00       	push   $0x46cb
    23e1:	6a 01                	push   $0x1
    23e3:	e8 18 17 00 00       	call   3b00 <printf>
    exit();
    23e8:	e8 a9 15 00 00       	call   3996 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23ed:	53                   	push   %ebx
    23ee:	53                   	push   %ebx
    23ef:	68 b3 46 00 00       	push   $0x46b3
    23f4:	6a 01                	push   $0x1
    23f6:	e8 05 17 00 00       	call   3b00 <printf>
    exit();
    23fb:	e8 96 15 00 00       	call   3996 <exit>
...
00002400 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    240d:	68 85 48 00 00       	push   $0x4885
    2412:	6a 01                	push   $0x1
    2414:	e8 e7 16 00 00       	call   3b00 <printf>
  unlink("bigwrite");
    2419:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    2420:	e8 c1 15 00 00       	call   39e6 <unlink>
    ...
    2438:	68 94 48 00 00       	push   $0x4894
    243d:	e8 94 15 00 00       	call   39d6 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 5c 15 00 00       	call   39b6 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 46 15 00 00       	call   39b6 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 38 15 00 00       	call   39be <close>
    unlink("bigwrite");
    2486:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    248d:	e8 54 15 00 00       	call   39e6 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24a0:	68 c7 48 00 00       	push   $0x48c7
    24a5:	6a 01                	push   $0x1
    24a7:	e8 54 16 00 00       	call   3b00 <printf>
}
    ...
    24b6:	50                   	push   %eax
    24b7:	53                   	push   %ebx
    24b8:	68 b5 48 00 00       	push   $0x48b5
    24bd:	6a 01                	push   $0x1
    24bf:	e8 3c 16 00 00       	call   3b00 <printf>
        exit();
    24c4:	e8 cd 14 00 00       	call   3996 <exit>
      printf(1, "cannot create bigwrite\n");
    24c9:	83 ec 08             	sub    $0x8,%esp
    24cc:	68 9d 48 00 00       	push   $0x489d
    24d1:	6a 01                	push   $0x1
    24d3:	e8 28 16 00 00       	call   3b00 <printf>
      exit();
    24d8:	e8 b9 14 00 00       	call   3996 <exit>
...
000024e0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    24e9:	68 d4 48 00 00       	push   $0x48d4
    24ee:	6a 01                	push   $0x1
    24f0:	e8 0b 16 00 00       	call   3b00 <printf>
  unlink("bigfile");
    24f5:	c7 04 24 f0 48 00 00 	movl   $0x48f0,(%esp)
    24fc:	e8 e5 14 00 00       	call   39e6 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 f0 48 00 00       	push   $0x48f0
    250d:	e8 c4 14 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 68 14 00 00       	call   39b6 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 51 14 00 00       	call   39be <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 f0 48 00 00       	push   $0x48f0
    2576:	e8 5b 14 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 dd 13 00 00       	call   39ae <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 db 13 00 00       	call   39be <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25f5:	68 f0 48 00 00       	push   $0x48f0
    25fa:	e8 e7 13 00 00       	call   39e6 <unlink>
  printf(1, "bigfile test ok\n");
    25ff:	58                   	pop    %eax
    2600:	5a                   	pop    %edx
    2601:	68 7f 49 00 00       	push   $0x497f
    2606:	6a 01                	push   $0x1
    2608:	e8 f3 14 00 00       	call   3b00 <printf>
}
    ...
    261b:	68 4c 49 00 00       	push   $0x494c
    2620:	6a 01                	push   $0x1
    2622:	e8 d9 14 00 00       	call   3b00 <printf>
      exit();
    2627:	e8 6a 13 00 00       	call   3996 <exit>
      printf(1, "short read bigfile\n");
    262c:	83 ec 08             	sub    $0x8,%esp
    262f:	68 38 49 00 00       	push   $0x4938
    2634:	6a 01                	push   $0x1
    2636:	e8 c5 14 00 00       	call   3b00 <printf>
      exit();
    263b:	e8 56 13 00 00       	call   3996 <exit>
      printf(1, "read bigfile failed\n");
    2640:	83 ec 08             	sub    $0x8,%esp
    2643:	68 23 49 00 00       	push   $0x4923
    2648:	6a 01                	push   $0x1
    264a:	e8 b1 14 00 00       	call   3b00 <printf>
      exit();
    264f:	e8 42 13 00 00       	call   3996 <exit>
      printf(1, "write bigfile failed\n");
    2654:	83 ec 08             	sub    $0x8,%esp
    2657:	68 f8 48 00 00       	push   $0x48f8
    265c:	6a 01                	push   $0x1
    265e:	e8 9d 14 00 00       	call   3b00 <printf>
      exit();
    2663:	e8 2e 13 00 00       	call   3996 <exit>
    printf(1, "cannot open bigfile\n");
    2668:	53                   	push   %ebx
    2669:	53                   	push   %ebx
    266a:	68 0e 49 00 00       	push   $0x490e
    266f:	6a 01                	push   $0x1
    2671:	e8 8a 14 00 00       	call   3b00 <printf>
    exit();
    2676:	e8 1b 13 00 00       	call   3996 <exit>
    printf(1, "cannot create bigfile");
    267b:	50                   	push   %eax
    267c:	50                   	push   %eax
    267d:	68 e2 48 00 00       	push   $0x48e2
    2682:	6a 01                	push   $0x1
    2684:	e8 77 14 00 00       	call   3b00 <printf>
    exit();
    2689:	e8 08 13 00 00       	call   3996 <exit>
    printf(1, "read bigfile wrong total\n");
    268e:	51                   	push   %ecx
    268f:	51                   	push   %ecx
    2690:	68 65 49 00 00       	push   $0x4965
    2695:	6a 01                	push   $0x1
    2697:	e8 64 14 00 00       	call   3b00 <printf>
    exit();
    269c:	e8 f5 12 00 00       	call   3996 <exit>
...
000026b0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    26b6:	68 90 49 00 00       	push   $0x4990
    26bb:	6a 01                	push   $0x1
    26bd:	e8 3e 14 00 00       	call   3b00 <printf>
  if(mkdir("12345678901234") != 0){
    26c2:	c7 04 24 cb 49 00 00 	movl   $0x49cb,(%esp)
    26c9:	e8 30 13 00 00       	call   39fe <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26dc:	68 88 51 00 00       	push   $0x5188
    26e1:	e8 18 13 00 00       	call   39fe <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26f9:	68 d8 51 00 00       	push   $0x51d8
    26fe:	e8 d3 12 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 a7 12 00 00       	call   39be <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 48 52 00 00       	push   $0x5248
    2720:	e8 b1 12 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 89 12 00 00       	call   39be <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 bc 49 00 00 	movl   $0x49bc,(%esp)
    273c:	e8 bd 12 00 00       	call   39fe <mkdir>
    2741:	83 c4 10             	add    $0x10,%esp
    2744:	85 c0                	test   %eax,%eax
    2746:	74 4e                	je     2796 <fourteen+0xe6>
  if(mkdir("123456789012345/12345678901234") == 0){
    2748:	83 ec 0c             	sub    $0xc,%esp
    274b:	68 e4 52 00 00       	push   $0x52e4
    2750:	e8 a9 12 00 00       	call   39fe <mkdir>
    2755:	83 c4 10             	add    $0x10,%esp
    2758:	85 c0                	test   %eax,%eax
    275a:	74 27                	je     2783 <fourteen+0xd3>
  printf(1, "fourteen ok\n");
    275c:	83 ec 08             	sub    $0x8,%esp
    275f:	68 da 49 00 00       	push   $0x49da
    2764:	6a 01                	push   $0x1
    2766:	e8 95 13 00 00       	call   3b00 <printf>
}
    ...
    2770:	50                   	push   %eax
    2771:	50                   	push   %eax
    2772:	68 9f 49 00 00       	push   $0x499f
    2777:	6a 01                	push   $0x1
    2779:	e8 82 13 00 00       	call   3b00 <printf>
    exit();
    277e:	e8 13 12 00 00       	call   3996 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2783:	50                   	push   %eax
    2784:	50                   	push   %eax
    2785:	68 04 53 00 00       	push   $0x5304
    278a:	6a 01                	push   $0x1
    278c:	e8 6f 13 00 00       	call   3b00 <printf>
    exit();
    2791:	e8 00 12 00 00       	call   3996 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2796:	52                   	push   %edx
    2797:	52                   	push   %edx
    2798:	68 b4 52 00 00       	push   $0x52b4
    279d:	6a 01                	push   $0x1
    279f:	e8 5c 13 00 00       	call   3b00 <printf>
    exit();
    27a4:	e8 ed 11 00 00       	call   3996 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    27a9:	51                   	push   %ecx
    27aa:	51                   	push   %ecx
    27ab:	68 78 52 00 00       	push   $0x5278
    27b0:	6a 01                	push   $0x1
    27b2:	e8 49 13 00 00       	call   3b00 <printf>
    exit();
    27b7:	e8 da 11 00 00       	call   3996 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27bc:	51                   	push   %ecx
    27bd:	51                   	push   %ecx
    27be:	68 08 52 00 00       	push   $0x5208
    27c3:	6a 01                	push   $0x1
    27c5:	e8 36 13 00 00       	call   3b00 <printf>
    exit();
    27ca:	e8 c7 11 00 00       	call   3996 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27cf:	50                   	push   %eax
    27d0:	50                   	push   %eax
    27d1:	68 a8 51 00 00       	push   $0x51a8
    27d6:	6a 01                	push   $0x1
    27d8:	e8 23 13 00 00       	call   3b00 <printf>
    exit();
    27dd:	e8 b4 11 00 00       	call   3996 <exit>
...
000027f0 <rmdot>:
{
  ...
  printf(1, "rmdot ok\n");
    ...
    28c9:	50                   	push   %eax
    28ca:	50                   	push   %eax
    28cb:	68 f8 49 00 00       	push   $0x49f8
    28d0:	6a 01                	push   $0x1
    28d2:	e8 29 12 00 00       	call   3b00 <printf>
    exit();
    28d7:	e8 ba 10 00 00       	call   3996 <exit>
    printf(1, "unlink dots failed!\n");
    28dc:	50                   	push   %eax
    28dd:	50                   	push   %eax
    28de:	68 79 4a 00 00       	push   $0x4a79
    28e3:	6a 01                	push   $0x1
    28e5:	e8 16 12 00 00       	call   3b00 <printf>
    exit();
    28ea:	e8 a7 10 00 00       	call   3996 <exit>
    printf(1, "unlink dots/.. worked!\n");
    28ef:	52                   	push   %edx
    28f0:	52                   	push   %edx
    28f1:	68 61 4a 00 00       	push   $0x4a61
    28f6:	6a 01                	push   $0x1
    28f8:	e8 03 12 00 00       	call   3b00 <printf>
    exit();
    28fd:	e8 94 10 00 00       	call   3996 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    2904:	68 42 4a 00 00       	push   $0x4a42
    2909:	6a 01                	push   $0x1
    290b:	e8 f0 11 00 00       	call   3b00 <printf>
    exit();
    2910:	e8 81 10 00 00       	call   3996 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    2917:	68 73 3e 00 00       	push   $0x3e73
    291c:	6a 01                	push   $0x1
    291e:	e8 dd 11 00 00       	call   3b00 <printf>
    exit();
    2923:	e8 6e 10 00 00       	call   3996 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    292a:	68 2c 4a 00 00       	push   $0x4a2c
    292f:	6a 01                	push   $0x1
    2931:	e8 ca 11 00 00       	call   3b00 <printf>
    exit();
    2936:	e8 5b 10 00 00       	call   3996 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    293d:	68 1e 4a 00 00       	push   $0x4a1e
    2942:	6a 01                	push   $0x1
    2944:	e8 b7 11 00 00       	call   3b00 <printf>
    exit();
    2949:	e8 48 10 00 00       	call   3996 <exit>
    printf(1, "chdir dots failed\n");
    294e:	50                   	push   %eax
    294f:	50                   	push   %eax
    2950:	68 0b 4a 00 00       	push   $0x4a0b
    2955:	6a 01                	push   $0x1
    2957:	e8 a4 11 00 00       	call   3b00 <printf>
    exit();
    295c:	e8 35 10 00 00       	call   3996 <exit>
...
00002970 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2977:	68 98 4a 00 00       	push   $0x4a98
    297c:	6a 01                	push   $0x1
    297e:	e8 7d 11 00 00       	call   3b00 <printf>
  fd = open("dirfile", O_CREATE);
    2983:	5b                   	pop    %ebx
    2984:	58                   	pop    %eax
    2985:	68 00 02 00 00       	push   $0x200
    298a:	68 a5 4a 00 00       	push   $0x4aa5
    298f:	e8 42 10 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 16 10 00 00       	call   39be <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 a5 4a 00 00 	movl   $0x4aa5,(%esp)
    29af:	e8 52 10 00 00       	call   3a06 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c2:	6a 00                	push   $0x0
    29c4:	68 de 4a 00 00       	push   $0x4ade
    29c9:	e8 08 10 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e1:	68 de 4a 00 00       	push   $0x4ade
    29e6:	e8 eb 0f 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29f9:	68 de 4a 00 00       	push   $0x4ade
    29fe:	e8 fb 0f 00 00       	call   39fe <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a11:	68 de 4a 00 00       	push   $0x4ade
    2a16:	e8 cb 0f 00 00       	call   39e6 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a29:	68 de 4a 00 00       	push   $0x4ade
    2a2e:	68 42 4b 00 00       	push   $0x4b42
    2a33:	e8 be 0f 00 00       	call   39f6 <link>
    2a38:	83 c4 10             	add    $0x10,%esp
    2a3b:	85 c0                	test   %eax,%eax
    2a3d:	0f 84 eb 00 00 00    	je     2b2e <dirfile+0x1be>
  if(unlink("dirfile") != 0){
    2a43:	83 ec 0c             	sub    $0xc,%esp
    2a46:	68 a5 4a 00 00       	push   $0x4aa5
    2a4b:	e8 96 0f 00 00       	call   39e6 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a5e:	6a 02                	push   $0x2
    2a60:	68 9e 46 00 00       	push   $0x469e
    2a65:	e8 6c 0f 00 00       	call   39d6 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a78:	6a 00                	push   $0x0
    2a7a:	68 9e 46 00 00       	push   $0x469e
    2a7f:	e8 52 0f 00 00       	call   39d6 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    2a8b:	68 81 47 00 00       	push   $0x4781
    2a90:	50                   	push   %eax
    2a91:	e8 20 0f 00 00       	call   39b6 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 18 0f 00 00       	call   39be <close>
  printf(1, "dir vs file OK\n");
    2aa6:	58                   	pop    %eax
    2aa7:	5a                   	pop    %edx
    2aa8:	68 75 4b 00 00       	push   $0x4b75
    2aad:	6a 01                	push   $0x1
    2aaf:	e8 4c 10 00 00       	call   3b00 <printf>
}
    ...
    2abc:	50                   	push   %eax
    2abd:	50                   	push   %eax
    2abe:	68 e9 4a 00 00       	push   $0x4ae9
    2ac3:	6a 01                	push   $0x1
    2ac5:	e8 36 10 00 00       	call   3b00 <printf>
    exit();
    2aca:	e8 c7 0e 00 00       	call   3996 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2acf:	52                   	push   %edx
    2ad0:	52                   	push   %edx
    2ad1:	68 c4 4a 00 00       	push   $0x4ac4
    2ad6:	6a 01                	push   $0x1
    2ad8:	e8 23 10 00 00       	call   3b00 <printf>
    exit();
    2add:	e8 b4 0e 00 00       	call   3996 <exit>
    printf(1, "create dirfile failed\n");
    2ae2:	51                   	push   %ecx
    2ae3:	51                   	push   %ecx
    2ae4:	68 ad 4a 00 00       	push   $0x4aad
    2ae9:	6a 01                	push   $0x1
    2aeb:	e8 10 10 00 00       	call   3b00 <printf>
    exit();
    2af0:	e8 a1 0e 00 00       	call   3996 <exit>
    printf(1, "write . succeeded!\n");
    2af5:	51                   	push   %ecx
    2af6:	51                   	push   %ecx
    2af7:	68 61 4b 00 00       	push   $0x4b61
    2afc:	6a 01                	push   $0x1
    2afe:	e8 fd 0f 00 00       	call   3b00 <printf>
    exit();
    2b03:	e8 8e 0e 00 00       	call   3996 <exit>
    printf(1, "open . for writing succeeded!\n");
    2b08:	53                   	push   %ebx
    2b09:	53                   	push   %ebx
    2b0a:	68 58 53 00 00       	push   $0x5358
    2b0f:	6a 01                	push   $0x1
    2b11:	e8 ea 0f 00 00       	call   3b00 <printf>
    exit();
    2b16:	e8 7b 0e 00 00       	call   3996 <exit>
    printf(1, "unlink dirfile failed!\n");
    2b1b:	50                   	push   %eax
    2b1c:	50                   	push   %eax
    2b1d:	68 49 4b 00 00       	push   $0x4b49
    2b22:	6a 01                	push   $0x1
    2b24:	e8 d7 0f 00 00       	call   3b00 <printf>
    exit();
    2b29:	e8 68 0e 00 00       	call   3996 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b2e:	50                   	push   %eax
    2b2f:	50                   	push   %eax
    2b30:	68 38 53 00 00       	push   $0x5338
    2b35:	6a 01                	push   $0x1
    2b37:	e8 c4 0f 00 00       	call   3b00 <printf>
    exit();
    2b3c:	e8 55 0e 00 00       	call   3996 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b41:	50                   	push   %eax
    2b42:	50                   	push   %eax
    2b43:	68 24 4b 00 00       	push   $0x4b24
    2b48:	6a 01                	push   $0x1
    2b4a:	e8 b1 0f 00 00       	call   3b00 <printf>
    exit();
    2b4f:	e8 42 0e 00 00       	call   3996 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b54:	50                   	push   %eax
    2b55:	50                   	push   %eax
    2b56:	68 07 4b 00 00       	push   $0x4b07
    2b5b:	6a 01                	push   $0x1
    2b5d:	e8 9e 0f 00 00       	call   3b00 <printf>
    exit();
    2b62:	e8 2f 0e 00 00       	call   3996 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b7c:	68 85 4b 00 00       	push   $0x4b85
    2b81:	6a 01                	push   $0x1
    2b83:	e8 78 0f 00 00       	call   3b00 <printf>
    2b88:	83 c4 10             	add    $0x10,%esp
    2b8b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    2b8f:	90                   	nop
    if(mkdir("irefd") != 0){
    2b90:	83 ec 0c             	sub    $0xc,%esp
    2b93:	68 96 4b 00 00       	push   $0x4b96
    2b98:	e8 61 0e 00 00       	call   39fe <mkdir>
    2b9d:	83 c4 10             	add    $0x10,%esp
    2ba0:	85 c0                	test   %eax,%eax
    2ba2:	0f 85 bb 00 00 00    	jne    2c63 <iref+0xf3>
    if(chdir("irefd") != 0){
    2ba8:	83 ec 0c             	sub    $0xc,%esp
    2bab:	68 96 4b 00 00       	push   $0x4b96
    2bb0:	e8 51 0e 00 00       	call   3a06 <chdir>
    2bb5:	83 c4 10             	add    $0x10,%esp
    2bb8:	85 c0                	test   %eax,%eax
    2bba:	0f 85 b7 00 00 00    	jne    2c77 <iref+0x107>
    mkdir("");
    2bc0:	83 ec 0c             	sub    $0xc,%esp
    2bc3:	68 4b 42 00 00       	push   $0x424b
    2bc8:	e8 31 0e 00 00       	call   39fe <mkdir>
    link("README", "");
    2bcd:	59                   	pop    %ecx
    2bce:	58                   	pop    %eax
    2bcf:	68 4b 42 00 00       	push   $0x424b
    2bd4:	68 42 4b 00 00       	push   $0x4b42
    2bd9:	e8 18 0e 00 00       	call   39f6 <link>
    fd = open("", O_CREATE);
    2bde:	58                   	pop    %eax
    2bdf:	5a                   	pop    %edx
    2be0:	68 00 02 00 00       	push   $0x200
    2be5:	68 4b 42 00 00       	push   $0x424b
    2bea:	e8 e7 0d 00 00       	call   39d6 <open>
    if(fd >= 0)
    ...
    2bf9:	50                   	push   %eax
    2bfa:	e8 bf 0d 00 00       	call   39be <close>
    2bff:	83 c4 10             	add    $0x10,%esp
    fd = open("xx", O_CREATE);
    2c02:	83 ec 08             	sub    $0x8,%esp
    2c05:	68 00 02 00 00       	push   $0x200
    2c0a:	68 80 47 00 00       	push   $0x4780
    2c0f:	e8 c2 0d 00 00       	call   39d6 <open>
    if(fd >= 0)
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 9a 0d 00 00       	call   39be <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 80 47 00 00       	push   $0x4780
    2c2f:	e8 b2 0d 00 00       	call   39e6 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c43:	68 71 3e 00 00       	push   $0x3e71
    2c48:	e8 b9 0d 00 00       	call   3a06 <chdir>
  printf(1, "empty file name OK\n");
    2c4d:	58                   	pop    %eax
    2c4e:	5a                   	pop    %edx
    2c4f:	68 c4 4b 00 00       	push   $0x4bc4
    2c54:	6a 01                	push   $0x1
    2c56:	e8 a5 0e 00 00       	call   3b00 <printf>
}
    ...
    2c66:	68 9c 4b 00 00       	push   $0x4b9c
    2c6b:	6a 01                	push   $0x1
    2c6d:	e8 8e 0e 00 00       	call   3b00 <printf>
      exit();
    2c72:	e8 1f 0d 00 00       	call   3996 <exit>
      printf(1, "chdir irefd failed\n");
    2c77:	83 ec 08             	sub    $0x8,%esp
    2c7a:	68 b0 4b 00 00       	push   $0x4bb0
    2c7f:	6a 01                	push   $0x1
    2c81:	e8 7a 0e 00 00       	call   3b00 <printf>
      exit();
    2c86:	e8 0b 0d 00 00       	call   3996 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2c99:	68 d8 4b 00 00       	push   $0x4bd8
    2c9e:	6a 01                	push   $0x1
    2ca0:	e8 5b 0e 00 00       	call   3b00 <printf>
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 cc 0c 00 00       	call   398e <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 c9 0c 00 00       	call   399e <wait>
  ...
  if(wait() != -1){
    2cde:	e8 bb 0c 00 00       	call   399e <wait>
    2ce3:	83 f8 ff             	cmp    $0xffffffff,%eax
    2ce6:	75 2d                	jne    2d15 <forktest+0x85>
  printf(1, "fork test OK\n");
    2ce8:	83 ec 08             	sub    $0x8,%esp
    2ceb:	68 0a 4c 00 00       	push   $0x4c0a
    2cf0:	6a 01                	push   $0x1
    2cf2:	e8 09 0e 00 00       	call   3b00 <printf>
}
    2cf7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2cfa:	c9                   	leave  
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 95 0c 00 00       	call   3996 <exit>
      printf(1, "wait stopped early\n");
    2d01:	83 ec 08             	sub    $0x8,%esp
    2d04:	68 e3 4b 00 00       	push   $0x4be3
    2d09:	6a 01                	push   $0x1
    2d0b:	e8 f0 0d 00 00       	call   3b00 <printf>
      exit();
    2d10:	e8 81 0c 00 00       	call   3996 <exit>
    printf(1, "wait got too many\n");
    2d15:	52                   	push   %edx
    2d16:	52                   	push   %edx
    2d17:	68 f7 4b 00 00       	push   $0x4bf7
    2d1c:	6a 01                	push   $0x1
    2d1e:	e8 dd 0d 00 00       	call   3b00 <printf>
    exit();
    2d23:	e8 6e 0c 00 00       	call   3996 <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2d28:	50                   	push   %eax
    2d29:	50                   	push   %eax
    2d2a:	68 78 53 00 00       	push   $0x5378
    2d2f:	6a 01                	push   $0x1
    2d31:	e8 ca 0d 00 00       	call   3b00 <printf>
    exit();
    2d36:	e8 5b 0c 00 00       	call   3996 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    2d4b:	68 18 4c 00 00       	push   $0x4c18
    2d50:	ff 35 c8 5f 00 00    	push   0x5fc8
    2d56:	e8 a5 0d 00 00       	call   3b00 <printf>
  oldbrk = sbrk(0);
    2d5b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d62:	e8 b7 0c 00 00       	call   3a1e <sbrk>
  a = sbrk(0);
    2d67:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d6e:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d71:	e8 a8 0c 00 00       	call   3a1e <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 92 0c 00 00       	call   3a1e <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 e1 0b 00 00       	call   398e <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 5a 0c 00 00       	call   3a1e <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 4e 0c 00 00       	call   3a1e <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 b6 0b 00 00       	call   399e <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 2c 0c 00 00       	call   3a1e <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 1b 0c 00 00       	call   3a1e <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e18:	6a 00                	push   $0x0
    2e1a:	e8 ff 0b 00 00       	call   3a1e <sbrk>
  c = sbrk(-4096);
    2e1f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e26:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e28:	e8 f1 0b 00 00       	call   3a1e <sbrk>
  ...
  c = sbrk(0);
    ...
    2e3c:	6a 00                	push   $0x0
    2e3e:	e8 db 0b 00 00       	call   3a1e <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e57:	6a 00                	push   $0x0
    2e59:	e8 c0 0b 00 00       	call   3a1e <sbrk>
  c = sbrk(4096);
    2e5e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e65:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e67:	e8 b2 0b 00 00       	call   3a1e <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e7c:	6a 00                	push   $0x0
    2e7e:	e8 9b 0b 00 00       	call   3a1e <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2edf:	90                   	nop
    ppid = getpid();
    2ee0:	e8 31 0b 00 00       	call   3a16 <getpid>
    2ee5:	89 c6                	mov    %eax,%esi
    pid = fork();
    2ee7:	e8 a2 0a 00 00       	call   398e <fork>
    if(pid < 0){
    ...
    wait();
    2efa:	e8 9f 0a 00 00       	call   399e <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f13:	50                   	push   %eax
    2f14:	e8 8d 0a 00 00       	call   39a6 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f30:	e8 59 0a 00 00       	call   398e <fork>
    ...
    2f50:	e8 59 0a 00 00       	call   39ae <read>
  ...
  c = sbrk(4096);
    ...
    2f67:	e8 b2 0a 00 00       	call   3a1e <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f82:	50                   	push   %eax
    2f83:	e8 3e 0a 00 00       	call   39c6 <kill>
    wait();
    2f88:	e8 11 0a 00 00       	call   399e <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fa3:	6a 00                	push   $0x0
    2fa5:	e8 74 0a 00 00       	call   3a1e <sbrk>
    2faa:	83 c4 10             	add    $0x10,%esp
    2fad:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fb0:	72 60                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2fb2:	83 ec 08             	sub    $0x8,%esp
    2fb5:	68 c0 4c 00 00       	push   $0x4cc0
    2fba:	ff 35 c8 5f 00 00    	push   0x5fc8
    2fc0:	e8 3b 0b 00 00       	call   3b00 <printf>
}
    ...
    3037:	53                   	push   %ebx
    3038:	56                   	push   %esi
    3039:	68 23 4c 00 00       	push   $0x4c23
    303e:	ff 35 c8 5f 00 00    	push   0x5fc8
    3044:	e8 b7 0a 00 00       	call   3b00 <printf>
      exit();
    3049:	83 c4 20             	add    $0x20,%esp
    304c:	e8 45 09 00 00       	call   3996 <exit>
      printf(stdout, "fork failed\n");
    3051:	83 ec 08             	sub    $0x8,%esp
    3054:	68 69 4d 00 00       	push   $0x4d69
    3059:	ff 35 c8 5f 00 00    	push   0x5fc8
    305f:	e8 9c 0a 00 00       	call   3b00 <printf>
      exit();
    3064:	e8 2d 09 00 00       	call   3996 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3069:	0f be 03             	movsbl (%ebx),%eax
    306c:	50                   	push   %eax
    306d:	53                   	push   %ebx
    306e:	68 8c 4c 00 00       	push   $0x4c8c
    3073:	ff 35 c8 5f 00 00    	push   0x5fc8
    3079:	e8 82 0a 00 00       	call   3b00 <printf>
      kill(ppid);
    307e:	89 34 24             	mov    %esi,(%esp)
    3081:	e8 40 09 00 00       	call   39c6 <kill>
      exit();
    3086:	e8 0b 09 00 00       	call   3996 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    308b:	50                   	push   %eax
    308c:	53                   	push   %ebx
    308d:	68 6c 54 00 00       	push   $0x546c
    3092:	ff 35 c8 5f 00 00    	push   0x5fc8
    3098:	e8 63 0a 00 00       	call   3b00 <printf>
    exit();
    309d:	e8 f4 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    30a2:	56                   	push   %esi
    30a3:	56                   	push   %esi
    30a4:	68 9c 53 00 00       	push   $0x539c
    30a9:	ff 35 c8 5f 00 00    	push   0x5fc8
    30af:	e8 4c 0a 00 00       	call   3b00 <printf>
    exit();
    30b4:	e8 dd 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk test fork failed\n");
    30b9:	50                   	push   %eax
    30ba:	50                   	push   %eax
    30bb:	68 3e 4c 00 00       	push   $0x4c3e
    30c0:	ff 35 c8 5f 00 00    	push   0x5fc8
    30c6:	e8 35 0a 00 00       	call   3b00 <printf>
    exit();
    30cb:	e8 c6 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30d0:	51                   	push   %ecx
    30d1:	51                   	push   %ecx
    30d2:	68 3c 54 00 00       	push   $0x543c
    30d7:	ff 35 c8 5f 00 00    	push   0x5fc8
    30dd:	e8 1e 0a 00 00       	call   3b00 <printf>
    exit();
    30e2:	e8 af 08 00 00       	call   3996 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30e7:	50                   	push   %eax
    30e8:	50                   	push   %eax
    30e9:	68 a5 4c 00 00       	push   $0x4ca5
    30ee:	ff 35 c8 5f 00 00    	push   0x5fc8
    30f4:	e8 07 0a 00 00       	call   3b00 <printf>
    exit();
    30f9:	e8 98 08 00 00       	call   3996 <exit>
    printf(1, "pipe() failed\n");
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    3100:	68 61 41 00 00       	push   $0x4161
    3105:	6a 01                	push   $0x1
    3107:	e8 f4 09 00 00       	call   3b00 <printf>
    exit();
    310c:	e8 85 08 00 00       	call   3996 <exit>
    exit();
    3111:	e8 80 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 55 4c 00 00       	push   $0x4c55
    311d:	ff 35 c8 5f 00 00    	push   0x5fc8
    3123:	e8 d8 09 00 00       	call   3b00 <printf>
    exit();
    3128:	e8 69 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 14 54 00 00       	push   $0x5414
    3134:	ff 35 c8 5f 00 00    	push   0x5fc8
    313a:	e8 c1 09 00 00       	call   3b00 <printf>
    exit();
    313f:	e8 52 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 dc 53 00 00       	push   $0x53dc
    314b:	ff 35 c8 5f 00 00    	push   0x5fc8
    3151:	e8 aa 09 00 00       	call   3b00 <printf>
    exit();
    3156:	e8 3b 08 00 00       	call   3996 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 71 4c 00 00       	push   $0x4c71
    3162:	ff 35 c8 5f 00 00    	push   0x5fc8
    3168:	e8 93 09 00 00       	call   3b00 <printf>
    exit();
    316d:	e8 24 08 00 00       	call   3996 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319a:	68 ce 4c 00 00       	push   $0x4cce
    319f:	ff 35 c8 5f 00 00    	push   0x5fc8
    31a5:	e8 56 09 00 00       	call   3b00 <printf>
    31aa:	83 c4 10             	add    $0x10,%esp
    31ad:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31b0:	e8 d9 07 00 00       	call   398e <fork>
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 61 08 00 00       	call   3a26 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 55 08 00 00       	call   3a26 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 ed 07 00 00       	call   39c6 <kill>
    wait();
    31d9:	e8 c0 07 00 00       	call   399e <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 dd 4c 00 00       	push   $0x4cdd
    31e6:	e8 0b 08 00 00       	call   39f6 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3204:	68 01 4d 00 00       	push   $0x4d01
    3209:	ff 35 c8 5f 00 00    	push   0x5fc8
    320f:	e8 ec 08 00 00       	call   3b00 <printf>
}
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 73 07 00 00       	call   3996 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 e8 4c 00 00       	push   $0x4ce8
    322b:	ff 35 c8 5f 00 00    	push   0x5fc8
    3231:	e8 ca 08 00 00       	call   3b00 <printf>
      exit();
    3236:	e8 5b 07 00 00       	call   3996 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3246:	68 0e 4d 00 00       	push   $0x4d0e
    324b:	ff 35 c8 5f 00 00    	push   0x5fc8
    3251:	e8 aa 08 00 00       	call   3b00 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    3276:	68 29 4d 00 00       	push   $0x4d29
    327b:	ff 35 c8 5f 00 00    	push   0x5fc8
    3281:	e8 7a 08 00 00       	call   3b00 <printf>
}
    ...
    328e:	68 18 4d 00 00       	push   $0x4d18
    3293:	ff 35 c8 5f 00 00    	push   0x5fc8
    3299:	e8 62 08 00 00       	call   3b00 <printf>
      exit();
    329e:	e8 f3 06 00 00       	call   3996 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    32b6:	68 36 4d 00 00       	push   $0x4d36
    32bb:	e8 26 07 00 00       	call   39e6 <unlink>
  pid = fork();
    32c0:	e8 c9 06 00 00       	call   398e <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 c7 06 00 00       	call   399e <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 36 4d 00 00       	push   $0x4d36
    32e1:	e8 f0 06 00 00       	call   39d6 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 c4 06 00 00       	call   39be <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 36 4d 00 00 	movl   $0x4d36,(%esp)
    3301:	e8 e0 06 00 00       	call   39e6 <unlink>
}
    ...
    3310:	c7 04 85 00 a7 00 00 	movl   $0x5490,0xa700(,%eax,4)
    3317:	90 54 00 00 
    ...
    3323:	51                   	push   %ecx
    3324:	51                   	push   %ecx
    3325:	68 40 4d 00 00       	push   $0x4d40
    332a:	ff 35 c8 5f 00 00    	push   0x5fc8
    args[MAXARG-1] = 0;
    3330:	c7 05 7c a7 00 00 00 	movl   $0x0,0xa77c
    3337:	00 00 00 
    printf(stdout, "bigarg test\n");
    333a:	e8 c1 07 00 00       	call   3b00 <printf>
    exec("echo", args);
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    3341:	68 00 a7 00 00       	push   $0xa700
    3346:	68 0d 3f 00 00       	push   $0x3f0d
    334b:	e8 7e 06 00 00       	call   39ce <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 4d 4d 00 00       	push   $0x4d4d
    3357:	ff 35 c8 5f 00 00    	push   0x5fc8
    335d:	e8 9e 07 00 00       	call   3b00 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3362:	58                   	pop    %eax
    3363:	5a                   	pop    %edx
    3364:	68 00 02 00 00       	push   $0x200
    3369:	68 36 4d 00 00       	push   $0x4d36
    336e:	e8 63 06 00 00       	call   39d6 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 43 06 00 00       	call   39be <close>
    exit();
    337b:	e8 16 06 00 00       	call   3996 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 76 4d 00 00       	push   $0x4d76
    3387:	ff 35 c8 5f 00 00    	push   0x5fc8
    338d:	e8 6e 07 00 00       	call   3b00 <printf>
    exit();
    3392:	e8 ff 05 00 00       	call   3996 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 5d 4d 00 00       	push   $0x4d5d
    339e:	ff 35 c8 5f 00 00    	push   0x5fc8
    33a4:	e8 57 07 00 00       	call   3b00 <printf>
    exit();
    33a9:	e8 e8 05 00 00       	call   3996 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    33bb:	68 8b 4d 00 00       	push   $0x4d8b
    33c0:	6a 01                	push   $0x1
    33c2:	e8 39 07 00 00       	call   3b00 <printf>
    ...
    3441:	50                   	push   %eax
    3442:	68 98 4d 00 00       	push   $0x4d98
    3447:	6a 01                	push   $0x1
    3449:	e8 b2 06 00 00       	call   3b00 <printf>
    ...
    3458:	50                   	push   %eax
    3459:	e8 78 05 00 00       	call   39d6 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 31 05 00 00       	call   39b6 <write>
      if(cc < 512)
    ...
    3492:	53                   	push   %ebx
    3493:	68 b4 4d 00 00       	push   $0x4db4
    3498:	6a 01                	push   $0x1
    349a:	e8 61 06 00 00       	call   3b00 <printf>
    close(fd);
    349f:	89 3c 24             	mov    %edi,(%esp)
    34a2:	e8 17 05 00 00       	call   39be <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34bc:	50                   	push   %eax
    34bd:	68 a4 4d 00 00       	push   $0x4da4
    34c2:	6a 01                	push   $0x1
    34c4:	e8 37 06 00 00       	call   3b00 <printf>
      break;
    ...
    354b:	50                   	push   %eax
    354c:	e8 95 04 00 00       	call   39e6 <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    355c:	68 c4 4d 00 00       	push   $0x4dc4
    3561:	6a 01                	push   $0x1
    3563:	e8 98 05 00 00       	call   3b00 <printf>
}
...
00003580 <uio>:
{
  ...
  printf(1, "uio test\n");
    3586:	68 da 4d 00 00       	push   $0x4dda
    358b:	6a 01                	push   $0x1
    358d:	e8 6e 05 00 00       	call   3b00 <printf>
  pid = fork();
    3592:	e8 f7 03 00 00       	call   398e <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 f9 03 00 00       	call   399e <wait>
  printf(1, "uio test done\n");
    35a5:	83 ec 08             	sub    $0x8,%esp
    35a8:	68 e4 4d 00 00       	push   $0x4de4
    35ad:	6a 01                	push   $0x1
    35af:	e8 4c 05 00 00       	call   3b00 <printf>
}
    ...
    35ca:	52                   	push   %edx
    35cb:	52                   	push   %edx
    35cc:	68 70 55 00 00       	push   $0x5570
    35d1:	6a 01                	push   $0x1
    35d3:	e8 28 05 00 00       	call   3b00 <printf>
    exit();
    35d8:	e8 b9 03 00 00       	call   3996 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    35df:	68 69 4d 00 00       	push   $0x4d69
    35e4:	6a 01                	push   $0x1
    35e6:	e8 15 05 00 00       	call   3b00 <printf>
    exit();
    35eb:	e8 a6 03 00 00       	call   3996 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    35f7:	6a 00                	push   $0x0
    35f9:	68 f3 4d 00 00       	push   $0x4df3
    35fe:	e8 d3 03 00 00       	call   39d6 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 08 04 00 00       	call   3a1e <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 89 03 00 00       	call   39ae <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 91 03 00 00       	call   39be <close>
  printf(1, "arg test passed\n");
    362d:	58                   	pop    %eax
    362e:	5a                   	pop    %edx
    362f:	68 05 4e 00 00       	push   $0x4e05
    3634:	6a 01                	push   $0x1
    3636:	e8 c5 04 00 00       	call   3b00 <printf>
}
    ...
    3643:	51                   	push   %ecx
    3644:	51                   	push   %ecx
    3645:	68 f8 4d 00 00       	push   $0x4df8
    364a:	6a 02                	push   $0x2
    364c:	e8 af 04 00 00       	call   3b00 <printf>
    exit();
    3651:	e8 40 03 00 00       	call   3996 <exit>
    3656:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    365d:	8d 76 00             	lea    0x0(%esi),%esi

00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 c4 5f 00 00 0d 	imul   $0x19660d,0x5fc4,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 c4 5f 00 00       	mov    %eax,0x5fc4
}
    3674:	c3                   	ret    
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 f1 01 00 00       	call   39ae <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 b4 01 00 00       	call   39d6 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 b7 01 00 00       	call   39ee <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 7d 01 00 00       	call   39be <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
    ...
    38db:	e8 50 04 00 00       	call   3d30 <malloc>

	if(stack == 0)
    38e0:	83 c4 10             	add    $0x10,%esp
    38e3:	85 c0                	test   %eax,%eax
    38e5:	74 14                	je     38fb <thread_create+0x2b>
		return -1;

	return clone(fcn, arg1, arg2, stack);
    38e7:	50                   	push   %eax
    38e8:	ff 75 10             	push   0x10(%ebp)
    38eb:	ff 75 0c             	push   0xc(%ebp)
    38ee:	ff 75 08             	push   0x8(%ebp)
    38f1:	e8 40 01 00 00       	call   3a36 <clone>
    ...
    38fb:	c9                   	leave  
		return -1;
    38fc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    3901:	c3                   	ret    
    3902:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3909:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00003910 <thread_join>:
...
thread_join()
{
    ...
    3913:	83 ec 34             	sub    $0x34,%esp
	void *stack;
	int pid = join(&stack);
    3916:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3919:	50                   	push   %eax
    391a:	e8 1f 01 00 00       	call   3a3e <join>
	
	if(pid >= 0)
    391f:	83 c4 10             	add    $0x10,%esp
    3922:	85 c0                	test   %eax,%eax
    3924:	79 0a                	jns    3930 <thread_join+0x20>
		free(stack);
    ...
    3926:	c9                   	leave  
    3927:	c3                   	ret    
    3928:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    392f:	90                   	nop
		free(stack);
    3930:	83 ec 0c             	sub    $0xc,%esp
    3933:	ff 75 f4             	push   -0xc(%ebp)
    3936:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3939:	e8 62 03 00 00       	call   3ca0 <free>
    393e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3941:	83 c4 10             	add    $0x10,%esp
}
    3944:	c9                   	leave  
    3945:	c3                   	ret    
    3946:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    394d:	8d 76 00             	lea    0x0(%esi),%esi
...
void lock_init(lock_t *lock){
    ...
    3956:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    395c:	5d                   	pop    %ebp
    395d:	c3                   	ret    
    395e:	66 90                	xchg   %ax,%ax

00003960 <lock_acquire>:
...
00003980 <lock_release>:
    3980:	55                   	push   %ebp
    3981:	89 e5                	mov    %esp,%ebp
    3983:	8b 45 08             	mov    0x8(%ebp),%eax
    3986:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    398c:	5d                   	pop    %ebp
    398d:	c3                   	ret    
...
SYSCALL(fork)
    398e:	b8 01 00 00 00       	mov    $0x1,%eax
    3993:	cd 40                	int    $0x40
    3995:	c3                   	ret    

00003996 <exit>:
SYSCALL(exit)
    3996:	b8 02 00 00 00       	mov    $0x2,%eax
    399b:	cd 40                	int    $0x40
    399d:	c3                   	ret    

0000399e <wait>:
SYSCALL(wait)
    399e:	b8 03 00 00 00       	mov    $0x3,%eax
    39a3:	cd 40                	int    $0x40
    39a5:	c3                   	ret    

000039a6 <pipe>:
SYSCALL(pipe)
    39a6:	b8 04 00 00 00       	mov    $0x4,%eax
    39ab:	cd 40                	int    $0x40
    39ad:	c3                   	ret    

000039ae <read>:
SYSCALL(read)
    39ae:	b8 05 00 00 00       	mov    $0x5,%eax
    39b3:	cd 40                	int    $0x40
    39b5:	c3                   	ret    

000039b6 <write>:
SYSCALL(write)
    39b6:	b8 10 00 00 00       	mov    $0x10,%eax
    39bb:	cd 40                	int    $0x40
    39bd:	c3                   	ret    

000039be <close>:
SYSCALL(close)
    39be:	b8 15 00 00 00       	mov    $0x15,%eax
    39c3:	cd 40                	int    $0x40
    39c5:	c3                   	ret    

000039c6 <kill>:
SYSCALL(kill)
    39c6:	b8 06 00 00 00       	mov    $0x6,%eax
    39cb:	cd 40                	int    $0x40
    39cd:	c3                   	ret    

000039ce <exec>:
SYSCALL(exec)
    39ce:	b8 07 00 00 00       	mov    $0x7,%eax
    39d3:	cd 40                	int    $0x40
    39d5:	c3                   	ret    

000039d6 <open>:
SYSCALL(open)
    39d6:	b8 0f 00 00 00       	mov    $0xf,%eax
    39db:	cd 40                	int    $0x40
    39dd:	c3                   	ret    

000039de <mknod>:
SYSCALL(mknod)
    39de:	b8 11 00 00 00       	mov    $0x11,%eax
    39e3:	cd 40                	int    $0x40
    39e5:	c3                   	ret    

000039e6 <unlink>:
SYSCALL(unlink)
    39e6:	b8 12 00 00 00       	mov    $0x12,%eax
    39eb:	cd 40                	int    $0x40
    39ed:	c3                   	ret    

000039ee <fstat>:
SYSCALL(fstat)
    39ee:	b8 08 00 00 00       	mov    $0x8,%eax
    39f3:	cd 40                	int    $0x40
    39f5:	c3                   	ret    

000039f6 <link>:
SYSCALL(link)
    39f6:	b8 13 00 00 00       	mov    $0x13,%eax
    39fb:	cd 40                	int    $0x40
    39fd:	c3                   	ret    

000039fe <mkdir>:
SYSCALL(mkdir)
    39fe:	b8 14 00 00 00       	mov    $0x14,%eax
    3a03:	cd 40                	int    $0x40
    3a05:	c3                   	ret    

00003a06 <chdir>:
SYSCALL(chdir)
    3a06:	b8 09 00 00 00       	mov    $0x9,%eax
    3a0b:	cd 40                	int    $0x40
    3a0d:	c3                   	ret    

00003a0e <dup>:
SYSCALL(dup)
    3a0e:	b8 0a 00 00 00       	mov    $0xa,%eax
    3a13:	cd 40                	int    $0x40
    3a15:	c3                   	ret    

00003a16 <getpid>:
SYSCALL(getpid)
    3a16:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a1b:	cd 40                	int    $0x40
    3a1d:	c3                   	ret    

00003a1e <sbrk>:
SYSCALL(sbrk)
    3a1e:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a23:	cd 40                	int    $0x40
    3a25:	c3                   	ret    

00003a26 <sleep>:
SYSCALL(sleep)
    3a26:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a2b:	cd 40                	int    $0x40
    3a2d:	c3                   	ret    

00003a2e <uptime>:
SYSCALL(uptime)
    3a2e:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a33:	cd 40                	int    $0x40
    3a35:	c3                   	ret    

00003a36 <clone>:
SYSCALL(clone)
    3a36:	b8 16 00 00 00       	mov    $0x16,%eax
    3a3b:	cd 40                	int    $0x40
    3a3d:	c3                   	ret    

00003a3e <join>:
SYSCALL(join)
    3a3e:	b8 17 00 00 00       	mov    $0x17,%eax
    3a43:	cd 40                	int    $0x40
    3a45:	c3                   	ret    
    3a46:	66 90                	xchg   %ax,%ax
    3a48:	66 90                	xchg   %ax,%ax
    3a4a:	66 90                	xchg   %ax,%ax
    3a4c:	66 90                	xchg   %ax,%ax
    ...
    3a5c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3ace:	56                   	push   %esi
    3acf:	57                   	push   %edi
    3ad0:	e8 e1 fe ff ff       	call   39b6 <write>
  while(--i >= 0)
    ...
    3b09:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b45:	57                   	push   %edi
    3b46:	56                   	push   %esi
    3b47:	e8 6a fe ff ff       	call   39b6 <write>
  ...
  write(fd, &c, 1);
    ...
    3b9e:	e8 13 fe ff ff       	call   39b6 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3baf:	57                   	push   %edi
    3bb0:	56                   	push   %esi
    3bb1:	e8 00 fe ff ff       	call   39b6 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3c1b:	57                   	push   %edi
    3c1c:	56                   	push   %esi
    3c1d:	e8 94 fd ff ff       	call   39b6 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c5f:	e8 52 fd ff ff       	call   39b6 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3ca1:	a1 80 a7 00 00       	mov    0xa780,%eax
{
  ...
  freep = p;
    ...
    3ce1:	5b                   	pop    %ebx
  freep = p;
    3ce2:	89 15 80 a7 00 00    	mov    %edx,0xa780
}
    3ce8:	5e                   	pop    %esi
    3ce9:	5f                   	pop    %edi
    3cea:	5d                   	pop    %ebp
  ...
  freep = p;
    3d1c:	89 15 80 a7 00 00    	mov    %edx,0xa780
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d3c:	8b 3d 80 a7 00 00    	mov    0xa780,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    3daf:	8b 15 80 a7 00 00    	mov    0xa780,%edx
    ...
    3ddc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3ddf:	89 15 80 a7 00 00    	mov    %edx,0xa780
}
    ...
    3def:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3df0:	c7 05 80 a7 00 00 84 	movl   $0xa784,0xa780
    3df7:	a7 00 00 
    base.s.size = 0;
    3dfa:	bf 84 a7 00 00       	mov    $0xa784,%edi
    base.s.ptr = freep = prevp = &base;
    3dff:	c7 05 84 a7 00 00 84 	movl   $0xa784,0xa784
    3e06:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e09:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3e0b:	c7 05 88 a7 00 00 00 	movl   $0x0,0xa788
    3e12:	00 00 00 
    if(p->s.size >= nunits){

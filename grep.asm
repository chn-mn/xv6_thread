...
main(int argc, char *argv[])
{
  ...
  55:	e8 54 06 00 00       	call   6ae <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 58 06 00 00       	call   6c6 <open>
  ...
  81:	e8 6a 07 00 00       	call   7f0 <printf>
      exit();
  86:	e8 fb 05 00 00       	call   686 <exit>
  }
  exit();
  8b:	e8 f6 05 00 00       	call   686 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 52 07 00 00       	call   7f0 <printf>
    exit();
  9e:	e8 e3 05 00 00       	call   686 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 d4 05 00 00       	call   686 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 91 04 00 00       	call   69e <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 15 04 00 00       	call   6a6 <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 f1 01 00 00       	call   69e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 b4 01 00 00       	call   6c6 <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 b7 01 00 00       	call   6de <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 7d 01 00 00       	call   6ae <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 5d5:	74 14                	je     5eb <thread_create+0x2b>
		return -1;

	return clone(fcn, arg1, arg2, stack);
 5d7:	50                   	push   %eax
 5d8:	ff 75 10             	push   0x10(%ebp)
 5db:	ff 75 0c             	push   0xc(%ebp)
 5de:	ff 75 08             	push   0x8(%ebp)
 5e1:	e8 40 01 00 00       	call   726 <clone>
...
thread_join()
{
 ...
 603:	83 ec 34             	sub    $0x34,%esp
	void *stack;
	int pid = join(&stack);
 606:	8d 45 f4             	lea    -0xc(%ebp),%eax
 609:	50                   	push   %eax
 60a:	e8 1f 01 00 00       	call   72e <join>
	
	if(pid >= 0)
 60f:	83 c4 10             	add    $0x10,%esp
 612:	85 c0                	test   %eax,%eax
 614:	79 0a                	jns    620 <thread_join+0x20>
		free(stack);
 ...
 623:	ff 75 f4             	push   -0xc(%ebp)
 626:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 629:	e8 62 03 00 00       	call   990 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 662:	f0 0f c1 02          	lock xadd %eax,(%edx)
	while(fetch_and_add((int*)&lock->flag, 1) != 0)
 666:	85 c0                	test   %eax,%eax
 668:	75 f6                	jne    660 <lock_acquire+0x10>
		;
}
 66a:	5d                   	pop    %ebp
 66b:	c3                   	ret    
...
00000670 <lock_release>:
 ...
 676:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
 67c:	5d                   	pop    %ebp
 67d:	c3                   	ret    
 ...
 74c:	89 d1                	mov    %edx,%ecx
{
 ...
 7be:	56                   	push   %esi
 7bf:	57                   	push   %edi
 7c0:	e8 e1 fe ff ff       	call   6a6 <write>
  while(--i >= 0)
 ...
 7f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 835:	57                   	push   %edi
 836:	56                   	push   %esi
 837:	e8 6a fe ff ff       	call   6a6 <write>
 ...
 88e:	e8 13 fe ff ff       	call   6a6 <write>
        putc(fd, c);
 ...
 89f:	57                   	push   %edi
 8a0:	56                   	push   %esi
 8a1:	e8 00 fe ff ff       	call   6a6 <write>
        putc(fd, c);
 ...
 90b:	57                   	push   %edi
 90c:	56                   	push   %esi
 90d:	e8 94 fd ff ff       	call   6a6 <write>
        while(*s != 0){
 ...
 94c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 94f:	e8 52 fd ff ff       	call   6a6 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 a83:	e8 86 fc ff ff       	call   70e <sbrk>
  if(p == (char*)-1)

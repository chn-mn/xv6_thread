...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 ac 03 00 00       	call   3e6 <unlink>
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 489:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 579:	ff 24 85 5c 08 00 00 	jmp    *0x85c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba 55 08 00 00       	mov    $0x855,%edx
        while(*s != 0){

...
main(void)
{
  ...
  19:	e8 28 04 00 00       	call   446 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 4b 04 00 00       	call   47e <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 3f 04 00 00       	call   47e <dup>
  ...
  52:	e8 19 05 00 00       	call   570 <printf>
    pid = fork();
  57:	e8 a2 03 00 00       	call   3fe <fork>
    if(pid < 0){
  ...
  70:	e8 99 03 00 00       	call   40e <wait>
  ...
  9a:	e8 d1 04 00 00       	call   570 <printf>
      exit();
  9f:	e8 62 03 00 00       	call   406 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 a4 0c 00 00       	push   $0xca4
  ab:	68 c6 08 00 00       	push   $0x8c6
  b0:	e8 89 03 00 00       	call   43e <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 ad 04 00 00       	call   570 <printf>
      exit();
  c3:	e8 3e 03 00 00       	call   406 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 98 08 00 00       	push   $0x898
  d2:	e8 77 03 00 00       	call   44e <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 98 08 00 00       	push   $0x898
  e0:	e8 61 03 00 00       	call   446 <open>
 ...
 219:	31 db                	xor    %ebx,%ebx
{
 ...
 225:	57                   	push   %edi
 226:	6a 00                	push   $0x0
 228:	e8 f1 01 00 00       	call   41e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 b4 01 00 00       	call   446 <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 b7 01 00 00       	call   45e <fstat>
  close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
  close(fd);
 2ac:	e8 7d 01 00 00       	call   42e <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 355:	74 14                	je     36b <thread_create+0x2b>
		return -1;

	return clone(fcn, arg1, arg2, stack);
 357:	50                   	push   %eax
 358:	ff 75 10             	push   0x10(%ebp)
 35b:	ff 75 0c             	push   0xc(%ebp)
 35e:	ff 75 08             	push   0x8(%ebp)
 361:	e8 40 01 00 00       	call   4a6 <clone>
...
thread_join()
{
 ...
 383:	83 ec 34             	sub    $0x34,%esp
	void *stack;
	int pid = join(&stack);
 386:	8d 45 f4             	lea    -0xc(%ebp),%eax
 389:	50                   	push   %eax
 38a:	e8 1f 01 00 00       	call   4ae <join>
	
	if(pid >= 0)
 38f:	83 c4 10             	add    $0x10,%esp
 392:	85 c0                	test   %eax,%eax
 394:	79 0a                	jns    3a0 <thread_join+0x20>
		free(stack);
 ...
 3a9:	e8 62 03 00 00       	call   710 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 3e2:	f0 0f c1 02          	lock xadd %eax,(%edx)
	while(fetch_and_add((int*)&lock->flag, 1) != 0)
 3e6:	85 c0                	test   %eax,%eax
 3e8:	75 f6                	jne    3e0 <lock_acquire+0x10>
		;
}
 3ea:	5d                   	pop    %ebp
 3eb:	c3                   	ret    

...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 7f 7e 10 80 	movl   $0x80107e7f,(%esp)
...
80102088:	68 66 7c 10 80       	push   $0x80107c66
...
80102d85:	e8 76 15 00 00       	call   80104300 <sleep>
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 6f 15 00 00       	call   801043c0 <wakeup>
    release(&log.lock);
...
80102f08:	e8 b3 14 00 00       	call   801043c0 <wakeup>
  release(&log.lock);
...
8010355f:	e8 5c 0e 00 00       	call   801043c0 <wakeup>
...
801035c4:	e8 f7 0d 00 00       	call   801043c0 <wakeup>
...
80103638:	e8 83 0d 00 00       	call   801043c0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010363d:	58                   	pop    %eax
8010363e:	5a                   	pop    %edx
8010363f:	53                   	push   %ebx
80103640:	56                   	push   %esi
80103641:	e8 ba 0c 00 00       	call   80104300 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801036ba:	e8 01 0d 00 00       	call   801043c0 <wakeup>
  release(&p->lock);
...
80103715:	e8 e6 0b 00 00       	call   80104300 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103776:	e8 45 0c 00 00       	call   801043c0 <wakeup>
  release(&p->lock);
...
801037fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103802:	e8 f9 0f 00 00       	call   80104800 <release>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 cf 5b 10 80 	movl   $0x80105bcf,0x14(%eax)
  p->context = (struct context*)sp;
...
80103836:	e8 e5 10 00 00       	call   80104920 <memset>
...
8010388b:	e8 70 0f 00 00       	call   80104800 <release>
...
801038d6:	68 60 7a 10 80       	push   $0x80107a60
801038db:	68 20 1d 11 80       	push   $0x80111d20
801038e0:	e8 ab 0d 00 00       	call   80104690 <initlock>
}
...
80103974:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103977:	e8 94 0d 00 00       	call   80104710 <pushcli>
  c = mycpu();
8010397c:	e8 6f ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103981:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103987:	e8 d4 0d 00 00       	call   80104760 <popcli>
}
...
801039b3:	e8 08 38 00 00       	call   801071c0 <setupkvm>
...
801039d1:	e8 9a 34 00 00       	call   80106e70 <inituvm>
...
801039e6:	e8 35 0f 00 00       	call   80104920 <memset>
...
80103a3f:	68 90 7a 10 80       	push   $0x80107a90
80103a44:	50                   	push   %eax
80103a45:	e8 96 10 00 00       	call   80104ae0 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 99 7a 10 80 	movl   $0x80107a99,(%esp)
...
80103a83:	68 77 7a 10 80       	push   $0x80107a77
...
80103a95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a98:	e8 73 0c 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103a9d:	e8 4e fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103aa2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa8:	e8 b3 0c 00 00       	call   80104760 <popcli>
  sz = curproc->sz;
...
80103abb:	e8 a0 32 00 00       	call   80106d60 <switchuvm>
  return 0;
...
80103ada:	e8 01 35 00 00       	call   80106fe0 <allocuvm>
...
80103afa:	e8 11 36 00 00       	call   80107110 <deallocuvm>
...
80103b16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b19:	e8 f2 0b 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103b1e:	e8 cd fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b29:	e8 32 0c 00 00       	call   80104760 <popcli>
  if((np = allocproc()) == 0){
...
80103b48:	e8 63 37 00 00       	call   801072b0 <copyuvm>
...
80103c36:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
80103c39:	e8 d2 0a 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103c3e:	e8 ad fc ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103c43:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80103c49:	89 55 d4             	mov    %edx,-0x2c(%ebp)
  popcli();
80103c4c:	e8 0f 0b 00 00       	call   80104760 <popcli>
  if((np = allocproc()) == 0){
80103c51:	e8 5a fb ff ff       	call   801037b0 <allocproc>
80103c56:	85 c0                	test   %eax,%eax
80103c58:	0f 84 2f 01 00 00    	je     80103d8d <clone+0x15d>
  np->pgdir = curproc->pgdir;
80103c5e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
...
80103c6e:	89 43 04             	mov    %eax,0x4(%ebx)
  np->tstack = stack;
80103c71:	8b 45 14             	mov    0x14(%ebp),%eax
80103c74:	89 43 7c             	mov    %eax,0x7c(%ebx)
  np->sz = curproc->sz;
80103c77:	8b 02                	mov    (%edx),%eax
  np->parent = curproc;
80103c79:	89 53 14             	mov    %edx,0x14(%ebx)
  np->sz = curproc->sz;
80103c7c:	89 03                	mov    %eax,(%ebx)
  *np->tf = *curproc->tf;
80103c7e:	8b 72 18             	mov    0x18(%edx),%esi
80103c81:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
	sp = (uint) stack + PGSIZE;
80103c83:	8b 4d 14             	mov    0x14(%ebp),%ecx
	fakereturn = 0xffffffff;
80103c86:	c7 45 e4 ff ff ff ff 	movl   $0xffffffff,-0x1c(%ebp)
	np->context->ebp = sp;
80103c8d:	8b 43 1c             	mov    0x1c(%ebx),%eax
	sp = (uint) stack + PGSIZE;
80103c90:	81 c1 00 10 00 00    	add    $0x1000,%ecx
80103c96:	89 48 0c             	mov    %ecx,0xc(%eax)
	copyout(np->pgdir, sp - 3*sizeof(void*), &fakereturn, sizeof(void*));
80103c99:	8b 45 14             	mov    0x14(%ebp),%eax
80103c9c:	6a 04                	push   $0x4
80103c9e:	8d b0 f4 0f 00 00    	lea    0xff4(%eax),%esi
80103ca4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80103ca7:	50                   	push   %eax
80103ca8:	56                   	push   %esi
80103ca9:	ff 73 04             	push   0x4(%ebx)
80103cac:	e8 7f 37 00 00       	call   80107430 <copyout>
	copyout(np->pgdir, sp - 2*sizeof(void*), &arg1, sizeof(void*));
80103cb1:	8d 45 0c             	lea    0xc(%ebp),%eax
80103cb4:	6a 04                	push   $0x4
80103cb6:	50                   	push   %eax
80103cb7:	8b 45 14             	mov    0x14(%ebp),%eax
80103cba:	05 f8 0f 00 00       	add    $0xff8,%eax
80103cbf:	50                   	push   %eax
80103cc0:	ff 73 04             	push   0x4(%ebx)
80103cc3:	e8 68 37 00 00       	call   80107430 <copyout>
	copyout(np->pgdir, sp - sizeof(void*), &arg2, sizeof(void*));
80103cc8:	83 c4 20             	add    $0x20,%esp
80103ccb:	8d 45 10             	lea    0x10(%ebp),%eax
80103cce:	6a 04                	push   $0x4
80103cd0:	50                   	push   %eax
80103cd1:	8b 45 14             	mov    0x14(%ebp),%eax
80103cd4:	05 fc 0f 00 00       	add    $0xffc,%eax
80103cd9:	50                   	push   %eax
80103cda:	ff 73 04             	push   0x4(%ebx)
80103cdd:	e8 4e 37 00 00       	call   80107430 <copyout>
	np->tf->esp = sp - 3*sizeof(void*);
80103ce2:	8b 43 18             	mov    0x18(%ebx),%eax
  for(i = 0; i < NOFILE; i++)
80103ce5:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  np->tf->eax = 0;
80103ce8:	83 c4 10             	add    $0x10,%esp
	np->tf->esp = sp - 3*sizeof(void*);
80103ceb:	89 70 44             	mov    %esi,0x44(%eax)
	np->tf->ebp = np->tf->esp;
80103cee:	8b 43 18             	mov    0x18(%ebx),%eax
  for(i = 0; i < NOFILE; i++)
80103cf1:	31 f6                	xor    %esi,%esi
	np->tf->ebp = np->tf->esp;
80103cf3:	8b 48 44             	mov    0x44(%eax),%ecx
80103cf6:	89 48 08             	mov    %ecx,0x8(%eax)
	np->context->eip = (uint) fcn;
80103cf9:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103cfc:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103cff:	89 48 10             	mov    %ecx,0x10(%eax)
	np->tf->eip = (uint) fcn;
80103d02:	8b 43 18             	mov    0x18(%ebx),%eax
80103d05:	89 48 38             	mov    %ecx,0x38(%eax)
  np->tf->eax = 0;
80103d08:	8b 43 18             	mov    0x18(%ebx),%eax
80103d0b:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103d12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(curproc->ofile[i])
80103d18:	8b 44 b7 28          	mov    0x28(%edi,%esi,4),%eax
80103d1c:	85 c0                	test   %eax,%eax
80103d1e:	74 10                	je     80103d30 <clone+0x100>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103d20:	83 ec 0c             	sub    $0xc,%esp
80103d23:	50                   	push   %eax
80103d24:	e8 77 d1 ff ff       	call   80100ea0 <filedup>
...
80103d36:	75 e0                	jne    80103d18 <clone+0xe8>
  np->cwd = idup(curproc->cwd);
80103d38:	83 ec 0c             	sub    $0xc,%esp
80103d3b:	ff 77 68             	push   0x68(%edi)
80103d3e:	89 7d d4             	mov    %edi,-0x2c(%ebp)
80103d41:	e8 0a da ff ff       	call   80101750 <idup>
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d46:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103d49:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103d4c:	89 43 68             	mov    %eax,0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d4f:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103d52:	83 c2 6c             	add    $0x6c,%edx
80103d55:	6a 10                	push   $0x10
80103d57:	52                   	push   %edx
80103d58:	50                   	push   %eax
80103d59:	e8 82 0d 00 00       	call   80104ae0 <safestrcpy>
  pid = np->pid;
80103d5e:	8b 73 10             	mov    0x10(%ebx),%esi
  acquire(&ptable.lock);
80103d61:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d68:	e8 f3 0a 00 00       	call   80104860 <acquire>
  np->state = RUNNABLE;
80103d6d:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103d74:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d7b:	e8 80 0a 00 00       	call   80104800 <release>
  return pid;
...
80103d8c:	c3                   	ret    
    return -1;
80103d8d:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103d92:	eb ef                	jmp    80103d83 <clone+0x153>
...
80103da6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103da9:	e8 42 fb ff ff       	call   801038f0 <mycpu>
  c->proc = 0;
...
80103dc1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dc4:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
    acquire(&ptable.lock);
80103dc9:	68 20 1d 11 80       	push   $0x80111d20
80103dce:	e8 8d 0a 00 00       	call   80104860 <acquire>
...
80103de4:	75 33                	jne    80103e19 <scheduler+0x79>
      switchuvm(p);
...
80103df0:	e8 6b 2f 00 00       	call   80106d60 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103df5:	58                   	pop    %eax
80103df6:	5a                   	pop    %edx
80103df7:	ff 73 1c             	push   0x1c(%ebx)
80103dfa:	57                   	push   %edi
      p->state = RUNNING;
80103dfb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103e02:	e8 34 0d 00 00       	call   80104b3b <swtch>
      switchkvm();
80103e07:	e8 44 2f 00 00       	call   80106d50 <switchkvm>
      c->proc = 0;
80103e0c:	83 c4 10             	add    $0x10,%esp
80103e0f:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103e16:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e19:	83 eb 80             	sub    $0xffffff80,%ebx
80103e1c:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80103e22:	75 bc                	jne    80103de0 <scheduler+0x40>
    release(&ptable.lock);
80103e24:	83 ec 0c             	sub    $0xc,%esp
80103e27:	68 20 1d 11 80       	push   $0x80111d20
80103e2c:	e8 cf 09 00 00       	call   80104800 <release>
    sti();
80103e31:	83 c4 10             	add    $0x10,%esp
80103e34:	eb 8a                	jmp    80103dc0 <scheduler+0x20>
...
80103e44:	53                   	push   %ebx
  pushcli();
80103e45:	e8 c6 08 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103e4a:	e8 a1 fa ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103e4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e55:	e8 06 09 00 00       	call   80104760 <popcli>
  if(!holding(&ptable.lock))
80103e5a:	83 ec 0c             	sub    $0xc,%esp
80103e5d:	68 20 1d 11 80       	push   $0x80111d20
80103e62:	e8 59 09 00 00       	call   801047c0 <holding>
80103e67:	83 c4 10             	add    $0x10,%esp
80103e6a:	85 c0                	test   %eax,%eax
80103e6c:	74 4f                	je     80103ebd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103e6e:	e8 7d fa ff ff       	call   801038f0 <mycpu>
...
80103e87:	75 41                	jne    80103eca <sched+0x8a>
  intena = mycpu()->intena;
80103e89:	e8 62 fa ff ff       	call   801038f0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e8e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e91:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e97:	e8 54 fa ff ff       	call   801038f0 <mycpu>
80103e9c:	83 ec 08             	sub    $0x8,%esp
80103e9f:	ff 70 04             	push   0x4(%eax)
80103ea2:	53                   	push   %ebx
80103ea3:	e8 93 0c 00 00       	call   80104b3b <swtch>
  mycpu()->intena = intena;
80103ea8:	e8 43 fa ff ff       	call   801038f0 <mycpu>
}
...
80103f06:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103f09:	e8 62 fa ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
80103f0e:	39 05 54 3d 11 80    	cmp    %eax,0x80113d54
80103f14:	0f 84 fd 00 00 00    	je     80104017 <exit+0x117>
...
80103f5c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103f63:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103f6a:	e8 f1 08 00 00       	call   80104860 <acquire>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f75:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103f7a:	eb 0e                	jmp    80103f8a <exit+0x8a>
80103f7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f80:	83 e8 80             	sub    $0xffffff80,%eax
80103f83:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103f88:	74 1c                	je     80103fa6 <exit+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80103f8a:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103f8e:	75 f0                	jne    80103f80 <exit+0x80>
80103f90:	3b 50 20             	cmp    0x20(%eax),%edx
80103f93:	75 eb                	jne    80103f80 <exit+0x80>
      p->state = RUNNABLE;
80103f95:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f9c:	83 e8 80             	sub    $0xffffff80,%eax
80103f9f:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103fa4:	75 e4                	jne    80103f8a <exit+0x8a>
      p->parent = initproc;
80103fa6:	8b 0d 54 3d 11 80    	mov    0x80113d54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fac:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
80103fb1:	eb 10                	jmp    80103fc3 <exit+0xc3>
80103fb3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103fb7:	90                   	nop
80103fb8:	83 ea 80             	sub    $0xffffff80,%edx
80103fbb:	81 fa 54 3d 11 80    	cmp    $0x80113d54,%edx
80103fc1:	74 3b                	je     80103ffe <exit+0xfe>
    if(p->parent == curproc){
80103fc3:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103fc6:	75 f0                	jne    80103fb8 <exit+0xb8>
      if(p->state == ZOMBIE)
80103fc8:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103fcc:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103fcf:	75 e7                	jne    80103fb8 <exit+0xb8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fd1:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103fd6:	eb 12                	jmp    80103fea <exit+0xea>
...
80103fe8:	74 ce                	je     80103fb8 <exit+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
80103fea:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103fee:	75 f0                	jne    80103fe0 <exit+0xe0>
80103ff0:	3b 48 20             	cmp    0x20(%eax),%ecx
80103ff3:	75 eb                	jne    80103fe0 <exit+0xe0>
      p->state = RUNNABLE;
80103ff5:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103ffc:	eb e2                	jmp    80103fe0 <exit+0xe0>
  curproc->state = ZOMBIE;
80103ffe:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80104005:	e8 36 fe ff ff       	call   80103e40 <sched>
  panic("zombie exit");
8010400a:	83 ec 0c             	sub    $0xc,%esp
8010400d:	68 e8 7a 10 80       	push   $0x80107ae8
80104012:	e8 69 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80104017:	83 ec 0c             	sub    $0xc,%esp
8010401a:	68 db 7a 10 80       	push   $0x80107adb
...
80104034:	53                   	push   %ebx
  pushcli();
80104035:	e8 d6 06 00 00       	call   80104710 <pushcli>
  c = mycpu();
8010403a:	e8 b1 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010403f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104045:	e8 16 07 00 00       	call   80104760 <popcli>
  acquire(&ptable.lock);
...
80104061:	eb 10                	jmp    80104073 <join+0x43>
...
80104071:	74 23                	je     80104096 <join+0x66>
      if(p->parent != curproc)
80104073:	39 73 14             	cmp    %esi,0x14(%ebx)
80104076:	75 f0                	jne    80104068 <join+0x38>
			if(p->pgdir != p->parent->pgdir)
80104078:	8b 4e 04             	mov    0x4(%esi),%ecx
8010407b:	39 4b 04             	cmp    %ecx,0x4(%ebx)
8010407e:	75 e8                	jne    80104068 <join+0x38>
      if(p->state == ZOMBIE){
80104080:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104084:	74 62                	je     801040e8 <join+0xb8>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104094:	75 dd                	jne    80104073 <join+0x43>
    if(!havekids || curproc->killed){
80104096:	85 c0                	test   %eax,%eax
80104098:	0f 84 9f 00 00 00    	je     8010413d <join+0x10d>
8010409e:	8b 46 24             	mov    0x24(%esi),%eax
801040a1:	85 c0                	test   %eax,%eax
801040a3:	0f 85 94 00 00 00    	jne    8010413d <join+0x10d>
  pushcli();
801040a9:	e8 62 06 00 00       	call   80104710 <pushcli>
  c = mycpu();
801040ae:	e8 3d f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801040b3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040b9:	e8 a2 06 00 00       	call   80104760 <popcli>
  if(p == 0)
801040be:	85 db                	test   %ebx,%ebx
801040c0:	0f 84 8e 00 00 00    	je     80104154 <join+0x124>
  p->chan = chan;
801040c6:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801040c9:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801040d0:	e8 6b fd ff ff       	call   80103e40 <sched>
  p->chan = 0;
801040d5:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
801040dc:	e9 79 ff ff ff       	jmp    8010405a <join+0x2a>
...
801040f1:	e8 ca e3 ff ff       	call   801024c0 <kfree>
				*stack = p->tstack;
801040f6:	8b 53 7c             	mov    0x7c(%ebx),%edx
...
8010410e:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->killed = 0;
80104115:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010411c:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
				*stack = p->tstack;
80104123:	89 10                	mov    %edx,(%eax)
        release(&ptable.lock);
80104125:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010412c:	e8 cf 06 00 00       	call   80104800 <release>
        return pid;
80104131:	83 c4 10             	add    $0x10,%esp
}
80104134:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104137:	89 f0                	mov    %esi,%eax
80104139:	5b                   	pop    %ebx
8010413a:	5e                   	pop    %esi
8010413b:	5d                   	pop    %ebp
8010413c:	c3                   	ret    
...
8010413d:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104140:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104145:	68 20 1d 11 80       	push   $0x80111d20
8010414a:	e8 b1 06 00 00       	call   80104800 <release>
      return -1;
8010414f:	83 c4 10             	add    $0x10,%esp
80104152:	eb e0                	jmp    80104134 <join+0x104>
    panic("sleep");
80104154:	83 ec 0c             	sub    $0xc,%esp
80104157:	68 f4 7a 10 80       	push   $0x80107af4
...
80104174:	53                   	push   %ebx
  pushcli();
80104175:	e8 96 05 00 00       	call   80104710 <pushcli>
  c = mycpu();
8010417a:	e8 71 f7 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010417f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104185:	e8 d6 05 00 00       	call   80104760 <popcli>
  acquire(&ptable.lock);
8010418a:	83 ec 0c             	sub    $0xc,%esp
8010418d:	68 20 1d 11 80       	push   $0x80111d20
80104192:	e8 c9 06 00 00       	call   80104860 <acquire>
80104197:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010419a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010419c:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801041a1:	eb 10                	jmp    801041b3 <wait+0x43>
801041a3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801041a7:	90                   	nop
801041a8:	83 eb 80             	sub    $0xffffff80,%ebx
801041ab:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
801041b1:	74 23                	je     801041d6 <wait+0x66>
      if(p->parent != curproc)
801041b3:	39 73 14             	cmp    %esi,0x14(%ebx)
801041b6:	75 f0                	jne    801041a8 <wait+0x38>
			if(p->pgdir == curproc->pgdir)
801041b8:	8b 56 04             	mov    0x4(%esi),%edx
801041bb:	39 53 04             	cmp    %edx,0x4(%ebx)
801041be:	74 e8                	je     801041a8 <wait+0x38>
      if(p->state == ZOMBIE){
801041c0:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801041c4:	74 62                	je     80104228 <wait+0xb8>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041c6:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
801041c9:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041ce:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
801041d4:	75 dd                	jne    801041b3 <wait+0x43>
    if(!havekids || curproc->killed){
801041d6:	85 c0                	test   %eax,%eax
801041d8:	0f 84 a0 00 00 00    	je     8010427e <wait+0x10e>
801041de:	8b 46 24             	mov    0x24(%esi),%eax
801041e1:	85 c0                	test   %eax,%eax
801041e3:	0f 85 95 00 00 00    	jne    8010427e <wait+0x10e>
  pushcli();
801041e9:	e8 22 05 00 00       	call   80104710 <pushcli>
  c = mycpu();
801041ee:	e8 fd f6 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801041f3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801041f9:	e8 62 05 00 00       	call   80104760 <popcli>
  if(p == 0)
801041fe:	85 db                	test   %ebx,%ebx
80104200:	0f 84 8f 00 00 00    	je     80104295 <wait+0x125>
  p->chan = chan;
80104206:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104209:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104210:	e8 2b fc ff ff       	call   80103e40 <sched>
  p->chan = 0;
80104215:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
8010421c:	e9 79 ff ff ff       	jmp    8010419a <wait+0x2a>
80104221:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        kfree(p->kstack);
80104228:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
8010422b:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
8010422e:	ff 73 08             	push   0x8(%ebx)
80104231:	e8 8a e2 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
80104236:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010423d:	5a                   	pop    %edx
8010423e:	ff 73 04             	push   0x4(%ebx)
80104241:	e8 fa 2e 00 00       	call   80107140 <freevm>
        p->pid = 0;
80104246:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
8010424d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104254:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104258:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010425f:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104266:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010426d:	e8 8e 05 00 00       	call   80104800 <release>
        return pid;
...
80104281:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104286:	68 20 1d 11 80       	push   $0x80111d20
8010428b:	e8 70 05 00 00       	call   80104800 <release>
      return -1;
80104290:	83 c4 10             	add    $0x10,%esp
80104293:	eb e0                	jmp    80104275 <wait+0x105>
    panic("sleep");
80104295:	83 ec 0c             	sub    $0xc,%esp
80104298:	68 f4 7a 10 80       	push   $0x80107af4
8010429d:	e8 de c0 ff ff       	call   80100380 <panic>
...
801042d6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
801042dd:	e8 5e fb ff ff       	call   80103e40 <sched>
  release(&ptable.lock);
801042e2:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
8010430f:	e8 fc 03 00 00       	call   80104710 <pushcli>
  c = mycpu();
80104314:	e8 d7 f5 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80104330:	81 fe 20 1d 11 80    	cmp    $0x80111d20,%esi
80104336:	74 50                	je     80104388 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104338:	83 ec 0c             	sub    $0xc,%esp
8010433b:	68 20 1d 11 80       	push   $0x80111d20
...
80104350:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104357:	e8 e4 fa ff ff       	call   80103e40 <sched>
  p->chan = 0;
8010435c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80104363:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
8010438b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104392:	e8 a9 fa ff ff       	call   80103e40 <sched>
  p->chan = 0;
...
801043a9:	68 fa 7a 10 80       	push   $0x80107afa
801043ae:	e8 cd bf ff ff       	call   80100380 <panic>
    panic("sleep");
801043b3:	83 ec 0c             	sub    $0xc,%esp
801043b6:	68 f4 7a 10 80       	push   $0x80107af4
...
801043ff:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80104404:	75 e4                	jne    801043ea <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104406:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
...
80104466:	68 20 1d 11 80       	push   $0x80111d20
...
80104483:	68 20 1d 11 80       	push   $0x80111d20
...
801044dc:	74 ea                	je     801044c8 <procdump+0x28>
      state = "???";
801044de:	ba 0b 7b 10 80       	mov    $0x80107b0b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801044e3:	83 f8 05             	cmp    $0x5,%eax
801044e6:	77 11                	ja     801044f9 <procdump+0x59>
801044e8:	8b 14 85 6c 7b 10 80 	mov    -0x7fef8494(,%eax,4),%edx
      state = "???";
801044ef:	b8 0b 7b 10 80       	mov    $0x80107b0b,%eax
...
801044fe:	68 0f 7b 10 80       	push   $0x80107b0f
...
8010453d:	68 61 75 10 80       	push   $0x80107561
...
8010456a:	68 84 7b 10 80       	push   $0x80107b84
...
801045d3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801045d9:	e8 92 f3 ff ff       	call   80103970 <myproc>
...
8010467b:	e8 f0 f2 ff ff       	call   80103970 <myproc>
...
8010477b:	e8 70 f1 ff ff       	call   801038f0 <mycpu>
...
8010478c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104790:	e8 5b f1 ff ff       	call   801038f0 <mycpu>
...
801047a5:	68 8f 7b 10 80       	push   $0x80107b8f
801047aa:	e8 d1 bb ff ff       	call   80100380 <panic>
    panic("popcli");
801047af:	83 ec 0c             	sub    $0xc,%esp
801047b2:	68 a6 7b 10 80       	push   $0x80107ba6
...
801047e3:	e8 08 f1 ff ff       	call   801038f0 <mycpu>
...
8010481b:	68 ad 7b 10 80       	push   $0x80107bad
...
8010489c:	e8 4f f0 ff ff       	call   801038f0 <mycpu>
...
801048fb:	e8 f0 ef ff ff       	call   801038f0 <mycpu>
...
80104910:	68 b5 7b 10 80       	push   $0x80107bb5
...
80104b97:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104b9a:	e8 d1 ed ff ff       	call   80103970 <myproc>
...
80104be5:	e8 86 ed ff ff       	call   80103970 <myproc>
...
80104bf3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104bf6:	e8 75 ed ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c3e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c40:	e8 2b ed ff ff       	call   80103970 <myproc>
...
80104c4e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c51:	e8 1a ed ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ca4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ca5:	e8 c6 ec ff ff       	call   80103970 <myproc>
...
80104cb3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104cb6:	e8 b5 ec ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ccb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104cce:	e8 9d ec ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80104d3c:	8b 14 85 e0 7b 10 80 	mov    -0x7fef8420(,%eax,4),%edx
...
80104ec4:	68 5c 7c 10 80       	push   $0x80107c5c
...
80104edc:	68 5b 7c 10 80       	push   $0x80107c5b
...
80104ef1:	68 4f 7c 10 80       	push   $0x80107c4f
...
80104f0f:	68 5e 7c 10 80       	push   $0x80107c5e
80104f14:	e8 67 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104f19:	83 ec 0c             	sub    $0xc,%esp
80104f1c:	68 40 7c 10 80       	push   $0x80107c40
...
80105050:	e8 1b e9 ff ff       	call   80103970 <myproc>
...
801050e1:	74 25                	je     80105108 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
801050e3:	e8 88 e8 ff ff       	call   80103970 <myproc>
  fileclose(f);
...
80105130:	e8 3b e8 ff ff       	call   80103970 <myproc>
...
8010531d:	58                   	pop    %eax
8010531e:	5a                   	pop    %edx
8010531f:	68 5c 7c 10 80       	push   $0x80107c5c
...
80105338:	68 5b 7c 10 80       	push   $0x80107c5b
...
80105527:	74 23                	je     8010554c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105529:	e8 42 e4 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056e5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801056e8:	e8 83 e2 ff ff       	call   80103970 <myproc>
...
801058f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801058fa:	e8 71 e0 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105916:	75 f0                	jne    80105908 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105918:	e8 53 e0 ff ff       	call   80103970 <myproc>
...
{
  return fork();
80105950:	e9 bb e1 ff ff       	jmp    80103b10 <fork>
...
80105963:	83 ec 08             	sub    $0x8,%esp
  exit();
80105966:	e8 95 e5 ff ff       	call   80103f00 <exit>
...
{
  return wait();
80105970:	e9 fb e7 ff ff       	jmp    80104170 <wait>
...
801059c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801059c6:	e8 a5 df ff ff       	call   80103970 <myproc>
...
801059f6:	e8 95 e0 ff ff       	call   80103a90 <growproc>
...
80105a4a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105a4d:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
80105a5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    sleep(&ticks, &tickslock);	// bug point: why ptable.lock is locked?
80105a60:	83 ec 08             	sub    $0x8,%esp
80105a63:	68 80 3d 11 80       	push   $0x80113d80
80105a68:	68 60 3d 11 80       	push   $0x80113d60
80105a6d:	e8 8e e8 ff ff       	call   80104300 <sleep>
  while(ticks - ticks0 < n){
80105a72:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
80105a90:	68 80 3d 11 80       	push   $0x80113d80
...
80105ab3:	68 80 3d 11 80       	push   $0x80113d80
...
80105ad4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105ad7:	68 80 3d 11 80       	push   $0x80113d80
80105adc:	e8 7f ed ff ff       	call   80104860 <acquire>
  xticks = ticks;
80105ae1:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80105ae7:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
...
80105b03:	83 ec 1c             	sub    $0x1c,%esp
	...
	if(argptr(0, (void*)&fcn, sizeof(char*)) < 0 || argptr(1, (void*)&arg1, sizeof(char*)) < 0 ||
...
80105b2f:	78 47                	js     80105b78 <sys_clone+0x78>
		argptr(2, (void*)&arg2, sizeof(char*)) < 0 || argptr(3, (void*)&stack, sizeof(char*)) < 0 )
...
80105b6b:	e8 c0 e0 ff ff       	call   80103c30 <clone>
...
80105b83:	83 ec 1c             	sub    $0x1c,%esp
	...
	if(argptr(0, (void*)&stack, sizeof(char*)) < 0)
...
80105b98:	78 16                	js     80105bb0 <sys_join+0x30>
		return -1;
	
	return join(stack);
80105b9a:	83 ec 0c             	sub    $0xc,%esp
80105b9d:	ff 75 f4             	push   -0xc(%ebp)
80105ba0:	e8 8b e4 ff ff       	call   80104030 <join>
...
80105bb8:	06                   	push   %es
  pushl %fs
80105bb9:	0f a0                	push   %fs
  pushl %gs
80105bbb:	0f a8                	push   %gs
  pushal
80105bbd:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105bbe:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105bc2:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105bc4:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105bc6:	54                   	push   %esp
  call trap
80105bc7:	e8 c4 00 00 00       	call   80105c90 <trap>
  addl $4, %esp
...
80105bcf:	61                   	popa   
  popl %gs
80105bd0:	0f a9                	pop    %gs
  popl %fs
80105bd2:	0f a1                	pop    %fs
  popl %es
80105bd4:	07                   	pop    %es
  popl %ds
80105bd5:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105bd6:	83 c4 08             	add    $0x8,%esp
  iret
80105bd9:	cf                   	iret   
...
80105bf7:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
80105bfe:	08 00 00 8e 
80105c02:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105c09:	80 
80105c0a:	c1 ea 10             	shr    $0x10,%edx
80105c0d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105c14:	80 
  for(i = 0; i < 256; i++)
...
80105c27:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105c2e:	00 00 ef 
  initlock(&tickslock, "time");
80105c31:	68 a1 7c 10 80       	push   $0x80107ca1
80105c36:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c3b:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105c41:	c1 e8 10             	shr    $0x10,%eax
80105c44:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105c4a:	e8 41 ea ff ff       	call   80104690 <initlock>
}
...
80105c6b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105c6f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105cb4:	ff 24 85 48 7d 10 80 	jmp    *-0x7fef82b8(,%eax,4)
...
80105cd3:	e8 98 dc ff ff       	call   80103970 <myproc>
...
80105d02:	0f 84 b8 00 00 00    	je     80105dc0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d08:	e8 63 dc ff ff       	call   80103970 <myproc>
...
80105d60:	e8 eb db ff ff       	call   80103950 <cpuid>
...
80105da2:	e8 c9 db ff ff       	call   80103970 <myproc>
...
80105dc4:	0f 85 3e ff ff ff    	jne    80105d08 <trap+0x78>
    yield();
80105dca:	e8 e1 e4 ff ff       	call   801042b0 <yield>
...
80105ddf:	e8 6c db ff ff       	call   80103950 <cpuid>
80105de4:	57                   	push   %edi
80105de5:	56                   	push   %esi
80105de6:	50                   	push   %eax
80105de7:	68 ac 7c 10 80       	push   $0x80107cac
...
80105df6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105df9:	e8 72 db ff ff       	call   80103970 <myproc>
...
80105e0f:	90                   	nop
    if(myproc()->killed)
80105e10:	e8 5b db ff ff       	call   80103970 <myproc>
80105e15:	8b 70 24             	mov    0x24(%eax),%esi
80105e18:	85 f6                	test   %esi,%esi
80105e1a:	0f 85 c8 00 00 00    	jne    80105ee8 <trap+0x258>
    myproc()->tf = tf;
80105e20:	e8 4b db ff ff       	call   80103970 <myproc>
80105e25:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105e28:	e8 f3 ee ff ff       	call   80104d20 <syscall>
    if(myproc()->killed)
80105e2d:	e8 3e db ff ff       	call   80103970 <myproc>
...
80105e43:	5d                   	pop    %ebp
      exit();
80105e44:	e9 b7 e0 ff ff       	jmp    80103f00 <exit>
...
80105e55:	e8 b6 ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e5a:	e8 11 db ff ff       	call   80103970 <myproc>
...
80105e8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105e90:	e8 bb da ff ff       	call   80103950 <cpuid>
80105e95:	85 c0                	test   %eax,%eax
80105e97:	0f 85 28 fe ff ff    	jne    80105cc5 <trap+0x35>
      acquire(&tickslock);
80105e9d:	83 ec 0c             	sub    $0xc,%esp
80105ea0:	68 80 3d 11 80       	push   $0x80113d80
80105ea5:	e8 b6 e9 ff ff       	call   80104860 <acquire>
      wakeup(&ticks);
80105eaa:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105eb1:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105eb8:	e8 03 e5 ff ff       	call   801043c0 <wakeup>
      release(&tickslock);
80105ebd:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105ec4:	e8 37 e9 ff ff       	call   80104800 <release>
...
{
  if(!uart)
80105f20:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105fa7:	74 78                	je     80106021 <uartinit+0xd1>
  uart = 1;
80105fa9:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105fb0:	00 00 00 
...
80105fbc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105fbf:	bf c8 7d 10 80       	mov    $0x80107dc8,%edi
...
80106030 <uartputc>:
  if(!uart)
80106030:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
801060a7:	6a 00                	push   $0x0
  jmp alltraps
801060a9:	e9 09 fb ff ff       	jmp    80105bb7 <alltraps>
...
801060b0:	6a 01                	push   $0x1
  jmp alltraps
801060b2:	e9 00 fb ff ff       	jmp    80105bb7 <alltraps>
...
801060b9:	6a 02                	push   $0x2
  jmp alltraps
801060bb:	e9 f7 fa ff ff       	jmp    80105bb7 <alltraps>
...
801060c2:	6a 03                	push   $0x3
  jmp alltraps
801060c4:	e9 ee fa ff ff       	jmp    80105bb7 <alltraps>
...
801060cb:	6a 04                	push   $0x4
  jmp alltraps
801060cd:	e9 e5 fa ff ff       	jmp    80105bb7 <alltraps>
...
801060d4:	6a 05                	push   $0x5
  jmp alltraps
801060d6:	e9 dc fa ff ff       	jmp    80105bb7 <alltraps>
...
801060dd:	6a 06                	push   $0x6
  jmp alltraps
801060df:	e9 d3 fa ff ff       	jmp    80105bb7 <alltraps>
...
801060e6:	6a 07                	push   $0x7
  jmp alltraps
801060e8:	e9 ca fa ff ff       	jmp    80105bb7 <alltraps>
...
801060ed:	6a 08                	push   $0x8
  jmp alltraps
801060ef:	e9 c3 fa ff ff       	jmp    80105bb7 <alltraps>
...
801060f6:	6a 09                	push   $0x9
  jmp alltraps
801060f8:	e9 ba fa ff ff       	jmp    80105bb7 <alltraps>
...
801060fd:	6a 0a                	push   $0xa
  jmp alltraps
801060ff:	e9 b3 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106104:	6a 0b                	push   $0xb
  jmp alltraps
80106106:	e9 ac fa ff ff       	jmp    80105bb7 <alltraps>
...
8010610b:	6a 0c                	push   $0xc
  jmp alltraps
8010610d:	e9 a5 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106112:	6a 0d                	push   $0xd
  jmp alltraps
80106114:	e9 9e fa ff ff       	jmp    80105bb7 <alltraps>
...
80106119:	6a 0e                	push   $0xe
  jmp alltraps
8010611b:	e9 97 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106122:	6a 0f                	push   $0xf
  jmp alltraps
80106124:	e9 8e fa ff ff       	jmp    80105bb7 <alltraps>
...
8010612b:	6a 10                	push   $0x10
  jmp alltraps
8010612d:	e9 85 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106132:	6a 11                	push   $0x11
  jmp alltraps
80106134:	e9 7e fa ff ff       	jmp    80105bb7 <alltraps>
...
8010613b:	6a 12                	push   $0x12
  jmp alltraps
8010613d:	e9 75 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106144:	6a 13                	push   $0x13
  jmp alltraps
80106146:	e9 6c fa ff ff       	jmp    80105bb7 <alltraps>
...
8010614d:	6a 14                	push   $0x14
  jmp alltraps
8010614f:	e9 63 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106156:	6a 15                	push   $0x15
  jmp alltraps
80106158:	e9 5a fa ff ff       	jmp    80105bb7 <alltraps>
...
8010615f:	6a 16                	push   $0x16
  jmp alltraps
80106161:	e9 51 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106168:	6a 17                	push   $0x17
  jmp alltraps
8010616a:	e9 48 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106171:	6a 18                	push   $0x18
  jmp alltraps
80106173:	e9 3f fa ff ff       	jmp    80105bb7 <alltraps>
...
8010617a:	6a 19                	push   $0x19
  jmp alltraps
8010617c:	e9 36 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106183:	6a 1a                	push   $0x1a
  jmp alltraps
80106185:	e9 2d fa ff ff       	jmp    80105bb7 <alltraps>
...
8010618c:	6a 1b                	push   $0x1b
  jmp alltraps
8010618e:	e9 24 fa ff ff       	jmp    80105bb7 <alltraps>
...
80106195:	6a 1c                	push   $0x1c
  jmp alltraps
80106197:	e9 1b fa ff ff       	jmp    80105bb7 <alltraps>
...
8010619e:	6a 1d                	push   $0x1d
  jmp alltraps
801061a0:	e9 12 fa ff ff       	jmp    80105bb7 <alltraps>
...
801061a7:	6a 1e                	push   $0x1e
  jmp alltraps
801061a9:	e9 09 fa ff ff       	jmp    80105bb7 <alltraps>
...
801061b0:	6a 1f                	push   $0x1f
  jmp alltraps
801061b2:	e9 00 fa ff ff       	jmp    80105bb7 <alltraps>
...
801061b9:	6a 20                	push   $0x20
  jmp alltraps
801061bb:	e9 f7 f9 ff ff       	jmp    80105bb7 <alltraps>
...
801061c2:	6a 21                	push   $0x21
  jmp alltraps
801061c4:	e9 ee f9 ff ff       	jmp    80105bb7 <alltraps>
...
801061cb:	6a 22                	push   $0x22
  jmp alltraps
801061cd:	e9 e5 f9 ff ff       	jmp    80105bb7 <alltraps>
...
801061d4:	6a 23                	push   $0x23
  jmp alltraps
801061d6:	e9 dc f9 ff ff       	jmp    80105bb7 <alltraps>
...
801061dd:	6a 24                	push   $0x24
  jmp alltraps
801061df:	e9 d3 f9 ff ff       	jmp    80105bb7 <alltraps>
...
801061e6:	6a 25                	push   $0x25
  jmp alltraps
801061e8:	e9 ca f9 ff ff       	jmp    80105bb7 <alltraps>
...
801061ef:	6a 26                	push   $0x26
  jmp alltraps
801061f1:	e9 c1 f9 ff ff       	jmp    80105bb7 <alltraps>
...
801061f8:	6a 27                	push   $0x27
  jmp alltraps
801061fa:	e9 b8 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106201:	6a 28                	push   $0x28
  jmp alltraps
80106203:	e9 af f9 ff ff       	jmp    80105bb7 <alltraps>
...
8010620a:	6a 29                	push   $0x29
  jmp alltraps
8010620c:	e9 a6 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106213:	6a 2a                	push   $0x2a
  jmp alltraps
80106215:	e9 9d f9 ff ff       	jmp    80105bb7 <alltraps>
...
8010621c:	6a 2b                	push   $0x2b
  jmp alltraps
8010621e:	e9 94 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106225:	6a 2c                	push   $0x2c
  jmp alltraps
80106227:	e9 8b f9 ff ff       	jmp    80105bb7 <alltraps>
...
8010622e:	6a 2d                	push   $0x2d
  jmp alltraps
80106230:	e9 82 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106237:	6a 2e                	push   $0x2e
  jmp alltraps
80106239:	e9 79 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106240:	6a 2f                	push   $0x2f
  jmp alltraps
80106242:	e9 70 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106249:	6a 30                	push   $0x30
  jmp alltraps
8010624b:	e9 67 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106252:	6a 31                	push   $0x31
  jmp alltraps
80106254:	e9 5e f9 ff ff       	jmp    80105bb7 <alltraps>
...
8010625b:	6a 32                	push   $0x32
  jmp alltraps
8010625d:	e9 55 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106264:	6a 33                	push   $0x33
  jmp alltraps
80106266:	e9 4c f9 ff ff       	jmp    80105bb7 <alltraps>
...
8010626d:	6a 34                	push   $0x34
  jmp alltraps
8010626f:	e9 43 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106276:	6a 35                	push   $0x35
  jmp alltraps
80106278:	e9 3a f9 ff ff       	jmp    80105bb7 <alltraps>
...
8010627f:	6a 36                	push   $0x36
  jmp alltraps
80106281:	e9 31 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106288:	6a 37                	push   $0x37
  jmp alltraps
8010628a:	e9 28 f9 ff ff       	jmp    80105bb7 <alltraps>
...
80106291:	6a 38                	push   $0x38
  jmp alltraps
80106293:	e9 1f f9 ff ff       	jmp    80105bb7 <alltraps>
...
8010629a:	6a 39                	push   $0x39
  jmp alltraps
8010629c:	e9 16 f9 ff ff       	jmp    80105bb7 <alltraps>
...
801062a3:	6a 3a                	push   $0x3a
  jmp alltraps
801062a5:	e9 0d f9 ff ff       	jmp    80105bb7 <alltraps>
...
801062ac:	6a 3b                	push   $0x3b
  jmp alltraps
801062ae:	e9 04 f9 ff ff       	jmp    80105bb7 <alltraps>
...
801062b5:	6a 3c                	push   $0x3c
  jmp alltraps
801062b7:	e9 fb f8 ff ff       	jmp    80105bb7 <alltraps>
...
801062be:	6a 3d                	push   $0x3d
  jmp alltraps
801062c0:	e9 f2 f8 ff ff       	jmp    80105bb7 <alltraps>
...
801062c7:	6a 3e                	push   $0x3e
  jmp alltraps
801062c9:	e9 e9 f8 ff ff       	jmp    80105bb7 <alltraps>
...
801062d0:	6a 3f                	push   $0x3f
  jmp alltraps
801062d2:	e9 e0 f8 ff ff       	jmp    80105bb7 <alltraps>
...
801062d9:	6a 40                	push   $0x40
  jmp alltraps
801062db:	e9 d7 f8 ff ff       	jmp    80105bb7 <alltraps>
...
801062e2:	6a 41                	push   $0x41
  jmp alltraps
801062e4:	e9 ce f8 ff ff       	jmp    80105bb7 <alltraps>
...
801062eb:	6a 42                	push   $0x42
  jmp alltraps
801062ed:	e9 c5 f8 ff ff       	jmp    80105bb7 <alltraps>
...
801062f4:	6a 43                	push   $0x43
  jmp alltraps
801062f6:	e9 bc f8 ff ff       	jmp    80105bb7 <alltraps>
...
801062fd:	6a 44                	push   $0x44
  jmp alltraps
801062ff:	e9 b3 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106306:	6a 45                	push   $0x45
  jmp alltraps
80106308:	e9 aa f8 ff ff       	jmp    80105bb7 <alltraps>
...
8010630f:	6a 46                	push   $0x46
  jmp alltraps
80106311:	e9 a1 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106318:	6a 47                	push   $0x47
  jmp alltraps
8010631a:	e9 98 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106321:	6a 48                	push   $0x48
  jmp alltraps
80106323:	e9 8f f8 ff ff       	jmp    80105bb7 <alltraps>
...
8010632a:	6a 49                	push   $0x49
  jmp alltraps
8010632c:	e9 86 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106333:	6a 4a                	push   $0x4a
  jmp alltraps
80106335:	e9 7d f8 ff ff       	jmp    80105bb7 <alltraps>
...
8010633c:	6a 4b                	push   $0x4b
  jmp alltraps
8010633e:	e9 74 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106345:	6a 4c                	push   $0x4c
  jmp alltraps
80106347:	e9 6b f8 ff ff       	jmp    80105bb7 <alltraps>
...
8010634e:	6a 4d                	push   $0x4d
  jmp alltraps
80106350:	e9 62 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106357:	6a 4e                	push   $0x4e
  jmp alltraps
80106359:	e9 59 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106360:	6a 4f                	push   $0x4f
  jmp alltraps
80106362:	e9 50 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106369:	6a 50                	push   $0x50
  jmp alltraps
8010636b:	e9 47 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106372:	6a 51                	push   $0x51
  jmp alltraps
80106374:	e9 3e f8 ff ff       	jmp    80105bb7 <alltraps>
...
8010637b:	6a 52                	push   $0x52
  jmp alltraps
8010637d:	e9 35 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106384:	6a 53                	push   $0x53
  jmp alltraps
80106386:	e9 2c f8 ff ff       	jmp    80105bb7 <alltraps>
...
8010638d:	6a 54                	push   $0x54
  jmp alltraps
8010638f:	e9 23 f8 ff ff       	jmp    80105bb7 <alltraps>
...
80106396:	6a 55                	push   $0x55
  jmp alltraps
80106398:	e9 1a f8 ff ff       	jmp    80105bb7 <alltraps>
...
8010639f:	6a 56                	push   $0x56
  jmp alltraps
801063a1:	e9 11 f8 ff ff       	jmp    80105bb7 <alltraps>
...
801063a8:	6a 57                	push   $0x57
  jmp alltraps
801063aa:	e9 08 f8 ff ff       	jmp    80105bb7 <alltraps>
...
801063b1:	6a 58                	push   $0x58
  jmp alltraps
801063b3:	e9 ff f7 ff ff       	jmp    80105bb7 <alltraps>
...
801063ba:	6a 59                	push   $0x59
  jmp alltraps
801063bc:	e9 f6 f7 ff ff       	jmp    80105bb7 <alltraps>
...
801063c3:	6a 5a                	push   $0x5a
  jmp alltraps
801063c5:	e9 ed f7 ff ff       	jmp    80105bb7 <alltraps>
...
801063cc:	6a 5b                	push   $0x5b
  jmp alltraps
801063ce:	e9 e4 f7 ff ff       	jmp    80105bb7 <alltraps>
...
801063d5:	6a 5c                	push   $0x5c
  jmp alltraps
801063d7:	e9 db f7 ff ff       	jmp    80105bb7 <alltraps>
...
801063de:	6a 5d                	push   $0x5d
  jmp alltraps
801063e0:	e9 d2 f7 ff ff       	jmp    80105bb7 <alltraps>
...
801063e7:	6a 5e                	push   $0x5e
  jmp alltraps
801063e9:	e9 c9 f7 ff ff       	jmp    80105bb7 <alltraps>
...
801063f0:	6a 5f                	push   $0x5f
  jmp alltraps
801063f2:	e9 c0 f7 ff ff       	jmp    80105bb7 <alltraps>
...
801063f9:	6a 60                	push   $0x60
  jmp alltraps
801063fb:	e9 b7 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106402:	6a 61                	push   $0x61
  jmp alltraps
80106404:	e9 ae f7 ff ff       	jmp    80105bb7 <alltraps>
...
8010640b:	6a 62                	push   $0x62
  jmp alltraps
8010640d:	e9 a5 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106414:	6a 63                	push   $0x63
  jmp alltraps
80106416:	e9 9c f7 ff ff       	jmp    80105bb7 <alltraps>
...
8010641d:	6a 64                	push   $0x64
  jmp alltraps
8010641f:	e9 93 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106426:	6a 65                	push   $0x65
  jmp alltraps
80106428:	e9 8a f7 ff ff       	jmp    80105bb7 <alltraps>
...
8010642f:	6a 66                	push   $0x66
  jmp alltraps
80106431:	e9 81 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106438:	6a 67                	push   $0x67
  jmp alltraps
8010643a:	e9 78 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106441:	6a 68                	push   $0x68
  jmp alltraps
80106443:	e9 6f f7 ff ff       	jmp    80105bb7 <alltraps>
...
8010644a:	6a 69                	push   $0x69
  jmp alltraps
8010644c:	e9 66 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106453:	6a 6a                	push   $0x6a
  jmp alltraps
80106455:	e9 5d f7 ff ff       	jmp    80105bb7 <alltraps>
...
8010645c:	6a 6b                	push   $0x6b
  jmp alltraps
8010645e:	e9 54 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106465:	6a 6c                	push   $0x6c
  jmp alltraps
80106467:	e9 4b f7 ff ff       	jmp    80105bb7 <alltraps>
...
8010646e:	6a 6d                	push   $0x6d
  jmp alltraps
80106470:	e9 42 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106477:	6a 6e                	push   $0x6e
  jmp alltraps
80106479:	e9 39 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106480:	6a 6f                	push   $0x6f
  jmp alltraps
80106482:	e9 30 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106489:	6a 70                	push   $0x70
  jmp alltraps
8010648b:	e9 27 f7 ff ff       	jmp    80105bb7 <alltraps>
...
80106492:	6a 71                	push   $0x71
  jmp alltraps
80106494:	e9 1e f7 ff ff       	jmp    80105bb7 <alltraps>
...
8010649b:	6a 72                	push   $0x72
  jmp alltraps
8010649d:	e9 15 f7 ff ff       	jmp    80105bb7 <alltraps>
...
801064a4:	6a 73                	push   $0x73
  jmp alltraps
801064a6:	e9 0c f7 ff ff       	jmp    80105bb7 <alltraps>
...
801064ad:	6a 74                	push   $0x74
  jmp alltraps
801064af:	e9 03 f7 ff ff       	jmp    80105bb7 <alltraps>
...
801064b6:	6a 75                	push   $0x75
  jmp alltraps
801064b8:	e9 fa f6 ff ff       	jmp    80105bb7 <alltraps>
...
801064bf:	6a 76                	push   $0x76
  jmp alltraps
801064c1:	e9 f1 f6 ff ff       	jmp    80105bb7 <alltraps>
...
801064c8:	6a 77                	push   $0x77
  jmp alltraps
801064ca:	e9 e8 f6 ff ff       	jmp    80105bb7 <alltraps>
...
801064d1:	6a 78                	push   $0x78
  jmp alltraps
801064d3:	e9 df f6 ff ff       	jmp    80105bb7 <alltraps>
...
801064da:	6a 79                	push   $0x79
  jmp alltraps
801064dc:	e9 d6 f6 ff ff       	jmp    80105bb7 <alltraps>
...
801064e3:	6a 7a                	push   $0x7a
  jmp alltraps
801064e5:	e9 cd f6 ff ff       	jmp    80105bb7 <alltraps>
...
801064ec:	6a 7b                	push   $0x7b
  jmp alltraps
801064ee:	e9 c4 f6 ff ff       	jmp    80105bb7 <alltraps>
...
801064f5:	6a 7c                	push   $0x7c
  jmp alltraps
801064f7:	e9 bb f6 ff ff       	jmp    80105bb7 <alltraps>
...
801064fe:	6a 7d                	push   $0x7d
  jmp alltraps
80106500:	e9 b2 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106507:	6a 7e                	push   $0x7e
  jmp alltraps
80106509:	e9 a9 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106510:	6a 7f                	push   $0x7f
  jmp alltraps
80106512:	e9 a0 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106519:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010651e:	e9 94 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106525:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010652a:	e9 88 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106531:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106536:	e9 7c f6 ff ff       	jmp    80105bb7 <alltraps>
...
8010653d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106542:	e9 70 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106549:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010654e:	e9 64 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106555:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010655a:	e9 58 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106561:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106566:	e9 4c f6 ff ff       	jmp    80105bb7 <alltraps>
...
8010656d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106572:	e9 40 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106579:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010657e:	e9 34 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106585:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010658a:	e9 28 f6 ff ff       	jmp    80105bb7 <alltraps>
...
80106591:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106596:	e9 1c f6 ff ff       	jmp    80105bb7 <alltraps>
...
8010659d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801065a2:	e9 10 f6 ff ff       	jmp    80105bb7 <alltraps>
...
801065a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801065ae:	e9 04 f6 ff ff       	jmp    80105bb7 <alltraps>
...
801065b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801065ba:	e9 f8 f5 ff ff       	jmp    80105bb7 <alltraps>
...
801065c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801065c6:	e9 ec f5 ff ff       	jmp    80105bb7 <alltraps>
...
801065cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801065d2:	e9 e0 f5 ff ff       	jmp    80105bb7 <alltraps>
...
801065d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801065de:	e9 d4 f5 ff ff       	jmp    80105bb7 <alltraps>
...
801065e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801065ea:	e9 c8 f5 ff ff       	jmp    80105bb7 <alltraps>
...
801065f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801065f6:	e9 bc f5 ff ff       	jmp    80105bb7 <alltraps>
...
801065fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106602:	e9 b0 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106609:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010660e:	e9 a4 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106615:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010661a:	e9 98 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106621:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106626:	e9 8c f5 ff ff       	jmp    80105bb7 <alltraps>
...
8010662d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106632:	e9 80 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106639:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010663e:	e9 74 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106645:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010664a:	e9 68 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106651:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106656:	e9 5c f5 ff ff       	jmp    80105bb7 <alltraps>
...
8010665d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106662:	e9 50 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106669:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010666e:	e9 44 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106675:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010667a:	e9 38 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106681:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106686:	e9 2c f5 ff ff       	jmp    80105bb7 <alltraps>
...
8010668d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106692:	e9 20 f5 ff ff       	jmp    80105bb7 <alltraps>
...
80106699:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010669e:	e9 14 f5 ff ff       	jmp    80105bb7 <alltraps>
...
801066a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801066aa:	e9 08 f5 ff ff       	jmp    80105bb7 <alltraps>
...
801066b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801066b6:	e9 fc f4 ff ff       	jmp    80105bb7 <alltraps>
...
801066bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801066c2:	e9 f0 f4 ff ff       	jmp    80105bb7 <alltraps>
...
801066c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801066ce:	e9 e4 f4 ff ff       	jmp    80105bb7 <alltraps>
...
801066d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801066da:	e9 d8 f4 ff ff       	jmp    80105bb7 <alltraps>
...
801066e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801066e6:	e9 cc f4 ff ff       	jmp    80105bb7 <alltraps>
...
801066ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801066f2:	e9 c0 f4 ff ff       	jmp    80105bb7 <alltraps>
...
801066f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801066fe:	e9 b4 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106705:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010670a:	e9 a8 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106711:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106716:	e9 9c f4 ff ff       	jmp    80105bb7 <alltraps>
...
8010671d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106722:	e9 90 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106729:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010672e:	e9 84 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106735:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010673a:	e9 78 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106741:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106746:	e9 6c f4 ff ff       	jmp    80105bb7 <alltraps>
...
8010674d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106752:	e9 60 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106759:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010675e:	e9 54 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106765:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010676a:	e9 48 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106771:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106776:	e9 3c f4 ff ff       	jmp    80105bb7 <alltraps>
...
8010677d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106782:	e9 30 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106789:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010678e:	e9 24 f4 ff ff       	jmp    80105bb7 <alltraps>
...
80106795:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010679a:	e9 18 f4 ff ff       	jmp    80105bb7 <alltraps>
...
801067a1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801067a6:	e9 0c f4 ff ff       	jmp    80105bb7 <alltraps>
...
801067ad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801067b2:	e9 00 f4 ff ff       	jmp    80105bb7 <alltraps>
...
801067b9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801067be:	e9 f4 f3 ff ff       	jmp    80105bb7 <alltraps>
...
801067c5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801067ca:	e9 e8 f3 ff ff       	jmp    80105bb7 <alltraps>
...
801067d1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801067d6:	e9 dc f3 ff ff       	jmp    80105bb7 <alltraps>
...
801067dd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801067e2:	e9 d0 f3 ff ff       	jmp    80105bb7 <alltraps>
...
801067e9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801067ee:	e9 c4 f3 ff ff       	jmp    80105bb7 <alltraps>
...
801067f5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801067fa:	e9 b8 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106801:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106806:	e9 ac f3 ff ff       	jmp    80105bb7 <alltraps>
...
8010680d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106812:	e9 a0 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106819:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010681e:	e9 94 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106825:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010682a:	e9 88 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106831:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106836:	e9 7c f3 ff ff       	jmp    80105bb7 <alltraps>
...
8010683d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106842:	e9 70 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106849:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010684e:	e9 64 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106855:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010685a:	e9 58 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106861:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106866:	e9 4c f3 ff ff       	jmp    80105bb7 <alltraps>
...
8010686d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106872:	e9 40 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106879:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010687e:	e9 34 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106885:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010688a:	e9 28 f3 ff ff       	jmp    80105bb7 <alltraps>
...
80106891:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106896:	e9 1c f3 ff ff       	jmp    80105bb7 <alltraps>
...
8010689d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801068a2:	e9 10 f3 ff ff       	jmp    80105bb7 <alltraps>
...
801068a9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801068ae:	e9 04 f3 ff ff       	jmp    80105bb7 <alltraps>
...
801068b5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801068ba:	e9 f8 f2 ff ff       	jmp    80105bb7 <alltraps>
...
801068c1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801068c6:	e9 ec f2 ff ff       	jmp    80105bb7 <alltraps>
...
801068cd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801068d2:	e9 e0 f2 ff ff       	jmp    80105bb7 <alltraps>
...
801068d9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801068de:	e9 d4 f2 ff ff       	jmp    80105bb7 <alltraps>
...
801068e5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801068ea:	e9 c8 f2 ff ff       	jmp    80105bb7 <alltraps>
...
801068f1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801068f6:	e9 bc f2 ff ff       	jmp    80105bb7 <alltraps>
...
801068fd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106902:	e9 b0 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106909:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010690e:	e9 a4 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106915:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010691a:	e9 98 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106921:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106926:	e9 8c f2 ff ff       	jmp    80105bb7 <alltraps>
...
8010692d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106932:	e9 80 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106939:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010693e:	e9 74 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106945:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010694a:	e9 68 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106951:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106956:	e9 5c f2 ff ff       	jmp    80105bb7 <alltraps>
...
8010695d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106962:	e9 50 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106969:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010696e:	e9 44 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106975:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010697a:	e9 38 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106981:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106986:	e9 2c f2 ff ff       	jmp    80105bb7 <alltraps>
...
8010698d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106992:	e9 20 f2 ff ff       	jmp    80105bb7 <alltraps>
...
80106999:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010699e:	e9 14 f2 ff ff       	jmp    80105bb7 <alltraps>
...
801069a5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801069aa:	e9 08 f2 ff ff       	jmp    80105bb7 <alltraps>
...
801069b1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801069b6:	e9 fc f1 ff ff       	jmp    80105bb7 <alltraps>
...
801069bd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801069c2:	e9 f0 f1 ff ff       	jmp    80105bb7 <alltraps>
...
801069c9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801069ce:	e9 e4 f1 ff ff       	jmp    80105bb7 <alltraps>
...
801069d5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801069da:	e9 d8 f1 ff ff       	jmp    80105bb7 <alltraps>
...
801069e1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801069e6:	e9 cc f1 ff ff       	jmp    80105bb7 <alltraps>
...
801069ed:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801069f2:	e9 c0 f1 ff ff       	jmp    80105bb7 <alltraps>
...
801069f9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801069fe:	e9 b4 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a05:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106a0a:	e9 a8 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a11:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106a16:	e9 9c f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a1d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106a22:	e9 90 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a29:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106a2e:	e9 84 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a35:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a3a:	e9 78 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a41:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a46:	e9 6c f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a4d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106a52:	e9 60 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a59:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106a5e:	e9 54 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a65:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106a6a:	e9 48 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a71:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106a76:	e9 3c f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a7d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106a82:	e9 30 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a89:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106a8e:	e9 24 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106a95:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106a9a:	e9 18 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106aa1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106aa6:	e9 0c f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106aad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106ab2:	e9 00 f1 ff ff       	jmp    80105bb7 <alltraps>
...
80106ab9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106abe:	e9 f4 f0 ff ff       	jmp    80105bb7 <alltraps>
...
80106ac5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106aca:	e9 e8 f0 ff ff       	jmp    80105bb7 <alltraps>
...
80106ad1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106ad6:	e9 dc f0 ff ff       	jmp    80105bb7 <alltraps>
...
80106add:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106ae2:	e9 d0 f0 ff ff       	jmp    80105bb7 <alltraps>
...
80106ae9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106aee:	e9 c4 f0 ff ff       	jmp    80105bb7 <alltraps>
...
80106af5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106afa:	e9 b8 f0 ff ff       	jmp    80105bb7 <alltraps>
...
80106b01:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106b06:	e9 ac f0 ff ff       	jmp    80105bb7 <alltraps>
...
80106b0d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106b12:	e9 a0 f0 ff ff       	jmp    80105bb7 <alltraps>
...
80106c65:	e8 b6 dc ff ff       	call   80104920 <memset>
...
80106cad:	68 d0 7d 10 80       	push   $0x80107dd0
...
80106cc3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106cc6:	e8 85 cc ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106d50:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106d84:	0f 84 c2 00 00 00    	je     80106e4c <switchuvm+0xec>
  pushcli();
80106d8a:	e8 81 d9 ff ff       	call   80104710 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106d8f:	e8 5c cb ff ff       	call   801038f0 <mycpu>
80106d94:	89 c3                	mov    %eax,%ebx
80106d96:	e8 55 cb ff ff       	call   801038f0 <mycpu>
...
80106da8:	e8 43 cb ff ff       	call   801038f0 <mycpu>
...
80106df1:	e8 fa ca ff ff       	call   801038f0 <mycpu>
80106df6:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106dfd:	e8 ee ca ff ff       	call   801038f0 <mycpu>
...
80106e14:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106e17:	e8 d4 ca ff ff       	call   801038f0 <mycpu>
...
80106e9f:	e8 7c da ff ff       	call   80104920 <memset>
...
80106ed2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ed3:	e9 e8 da ff ff       	jmp    801049c0 <memmove>
    panic("inituvm: more than a page");
80106ed8:	83 ec 0c             	sub    $0xc,%esp
80106edb:	68 15 7e 10 80       	push   $0x80107e15
...
80106f40:	68 2f 7e 10 80       	push   $0x80107e2f
...
80106fc8:	68 d0 7e 10 80       	push   $0x80107ed0
...
8010702b:	e8 f0 d8 ff ff       	call   80104920 <memset>
...
80107069:	68 4d 7e 10 80       	push   $0x80107e4d
...
801070cb:	68 65 7e 10 80       	push   $0x80107e65
...
801071ac:	68 81 7e 10 80       	push   $0x80107e81
...
801071e0:	e8 3b d7 ff ff       	call   80104920 <memset>
...
8010724b:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010727c:	68 92 7e 10 80       	push   $0x80107e92
...
801072f2:	68 9c 7e 10 80       	push   $0x80107e9c
...
80107350:	e8 6b d6 ff ff       	call   801049c0 <memmove>
...
801073c7:	68 b6 7e 10 80       	push   $0x80107eb6
...
80107480:	e8 3b d5 ff ff       	call   801049c0 <memmove>
    len -= n;
    buf += n;

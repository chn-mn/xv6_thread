   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  1e:	6a 02                	push   $0x2
  20:	e8 bb 04 00 00       	call   4e0 <printf>
    exit();
  25:	e8 4c 03 00 00       	call   376 <exit>
  }
  ...
  32:	e8 9f 03 00 00       	call   3d6 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 33 03 00 00       	call   376 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  43:	ff 73 08             	push   0x8(%ebx)
  46:	ff 73 04             	push   0x4(%ebx)
  49:	68 1b 08 00 00       	push   $0x81b
  4e:	6a 02                	push   $0x2
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 f1 01 00 00       	call   38e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 b4 01 00 00       	call   3b6 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 b7 01 00 00       	call   3ce <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 7d 01 00 00       	call   39e <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 2c5:	74 14                	je     2db <thread_create+0x2b>
		return -1;
 ...
 2d1:	e8 40 01 00 00       	call   416 <clone>
...
thread_join()
{
 ...
 2f9:	50                   	push   %eax
 2fa:	e8 1f 01 00 00       	call   41e <join>
	
	if(pid >= 0)
 2ff:	83 c4 10             	add    $0x10,%esp
 302:	85 c0                	test   %eax,%eax
 304:	79 0a                	jns    310 <thread_join+0x20>
		free(stack);
 ...
 319:	e8 62 03 00 00       	call   680 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 352:	f0 0f c1 02          	lock xadd %eax,(%edx)
	while(fetch_and_add((int*)&lock->flag, 1) != 0)
 356:	85 c0                	test   %eax,%eax
 358:	75 f6                	jne    350 <lock_acquire+0x10>
		;
}
 35a:	5d                   	pop    %ebp
 35b:	c3                   	ret    
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 38 08 00 00 	jmp    *0x838(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 2f 08 00 00       	mov    $0x82f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 ec 0b 00 00       	mov    0xbec,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 ec 0b 00 00    	mov    %edx,0xbec
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 ec 0b 00 00    	mov    %edx,0xbec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d ec 0b 00 00    	mov    0xbec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d ec 0b 00 00    	mov    0xbec,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 ec 0b 00 00    	mov    0xbec,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 ec 0b 00 00    	mov    %edx,0xbec
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 ec 0b 00 00 f0 	movl   $0xbf0,0xbec
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf f0 0b 00 00       	mov    $0xbf0,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 f0 0b 00 00 f0 	movl   $0xbf0,0xbf0
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 f4 0b 00 00 00 	movl   $0x0,0xbf4
 7f2:	00 00 00 
    if(p->s.size >= nunits){

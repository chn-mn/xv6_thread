...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 14 06 00 00       	call   656 <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 30 0b 00 00       	push   $0xb30
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 02 06 00 00       	call   656 <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000060 <fmtname>:
{
  ...
  return buf;
  c5:	bb 74 0f 00 00       	mov    $0xf74,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  db:	05 74 0f 00 00       	add    $0xf74,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 7f 05 00 00       	call   696 <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 7a 05 00 00       	call   6ae <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 23 05 00 00       	call   67e <close>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 5c 04 00 00       	call   66e <read>
 ...
 313:	e8 66 03 00 00       	call   67e <close>
    return;
 ...
 469:	31 db                	xor    %ebx,%ebx
{
 ...
 475:	57                   	push   %edi
 476:	6a 00                	push   $0x0
 478:	e8 f1 01 00 00       	call   66e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4dd:	e8 b4 01 00 00       	call   696 <open>
  if(fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 b7 01 00 00       	call   6ae <fstat>
  close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
  close(fd);
 4fc:	e8 7d 01 00 00       	call   67e <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 5a5:	74 14                	je     5bb <thread_create+0x2b>
		return -1;

	return clone(fcn, arg1, arg2, stack);
 5a7:	50                   	push   %eax
 5a8:	ff 75 10             	push   0x10(%ebp)
 5ab:	ff 75 0c             	push   0xc(%ebp)
 5ae:	ff 75 08             	push   0x8(%ebp)
 5b1:	e8 40 01 00 00       	call   6f6 <clone>
...
thread_join()
{
 ...
 5d3:	83 ec 34             	sub    $0x34,%esp
	void *stack;
	int pid = join(&stack);
 5d6:	8d 45 f4             	lea    -0xc(%ebp),%eax
 5d9:	50                   	push   %eax
 5da:	e8 1f 01 00 00       	call   6fe <join>
	
	if(pid >= 0)
 5df:	83 c4 10             	add    $0x10,%esp
 5e2:	85 c0                	test   %eax,%eax
 5e4:	79 0a                	jns    5f0 <thread_join+0x20>
		free(stack);
 ...
 5f3:	ff 75 f4             	push   -0xc(%ebp)
 5f6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 5f9:	e8 62 03 00 00       	call   960 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 632:	f0 0f c1 02          	lock xadd %eax,(%edx)
	while(fetch_and_add((int*)&lock->flag, 1) != 0)
 636:	85 c0                	test   %eax,%eax
 638:	75 f6                	jne    630 <lock_acquire+0x10>
		;
}
 63a:	5d                   	pop    %ebp
 63b:	c3                   	ret    
...
free(void *ap)
{
 ...
 961:	a1 84 0f 00 00       	mov    0xf84,%eax
{
 ...
 9a1:	5b                   	pop    %ebx
  freep = p;
 9a2:	89 15 84 0f 00 00    	mov    %edx,0xf84
}
 9a8:	5e                   	pop    %esi
 9a9:	5f                   	pop    %edi
 9aa:	5d                   	pop    %ebp
 ...
 9d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9dc:	89 15 84 0f 00 00    	mov    %edx,0xf84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9fc:	8b 3d 84 0f 00 00    	mov    0xf84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a3f:	73 4f                	jae    a90 <malloc+0xa0>
    ...
    if(p == freep)
 a41:	8b 3d 84 0f 00 00    	mov    0xf84,%edi
 ...
 a6a:	e8 f1 fe ff ff       	call   960 <free>
  return freep;
 a6f:	8b 15 84 0f 00 00    	mov    0xf84,%edx
 ...
 a9c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a9f:	89 15 84 0f 00 00    	mov    %edx,0xf84
}
 ...
 aaf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 ab0:	c7 05 84 0f 00 00 88 	movl   $0xf88,0xf84
 ab7:	0f 00 00 
    base.s.size = 0;
 aba:	bf 88 0f 00 00       	mov    $0xf88,%edi
    base.s.ptr = freep = prevp = &base;
 abf:	c7 05 88 0f 00 00 88 	movl   $0xf88,0xf88
 ac6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ac9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 acb:	c7 05 8c 0f 00 00 00 	movl   $0x0,0xf8c
 ad2:	00 00 00 
    if(p->s.size >= nunits){

...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 1c 03 00 00       	call   386 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 f1 01 00 00       	call   39e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 b4 01 00 00       	call   3c6 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 b7 01 00 00       	call   3de <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 7d 01 00 00       	call   3ae <close>
  return r;
...
thread_create(void* fcn, void* arg1, void* arg2)
{
 ...
 2d5:	74 14                	je     2eb <thread_create+0x2b>
		return -1;
 ...
 2e1:	e8 40 01 00 00       	call   426 <clone>
...
thread_join()
{
 ...
 309:	50                   	push   %eax
 30a:	e8 1f 01 00 00       	call   42e <join>
	
	if(pid >= 0)
 30f:	83 c4 10             	add    $0x10,%esp
 312:	85 c0                	test   %eax,%eax
 314:	79 0a                	jns    320 <thread_join+0x20>
		free(stack);
 ...
 329:	e8 62 03 00 00       	call   690 <free>
...
static inline int fetch_and_add(int* variable, int value)
{
 ...
 362:	f0 0f c1 02          	lock xadd %eax,(%edx)
	while(fetch_and_add((int*)&lock->flag, 1) != 0)
 366:	85 c0                	test   %eax,%eax
 368:	75 f6                	jne    360 <lock_acquire+0x10>
		;
}
 36a:	5d                   	pop    %ebp
 36b:	c3                   	ret    
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 4be:	56                   	push   %esi
 4bf:	57                   	push   %edi
 4c0:	e8 e1 fe ff ff       	call   3a6 <write>
  while(--i >= 0)
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 535:	57                   	push   %edi
 536:	56                   	push   %esi
 537:	e8 6a fe ff ff       	call   3a6 <write>
 ...
 58e:	e8 13 fe ff ff       	call   3a6 <write>
        putc(fd, c);
 ...
 59f:	57                   	push   %edi
 5a0:	56                   	push   %esi
 5a1:	e8 00 fe ff ff       	call   3a6 <write>
        putc(fd, c);
 ...
 60b:	57                   	push   %edi
 60c:	56                   	push   %esi
 60d:	e8 94 fd ff ff       	call   3a6 <write>
        while(*s != 0){
 ...
 64c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 64f:	e8 52 fd ff ff       	call   3a6 <write>
        ap++;
...
free(void *ap)
{
 ...
 691:	a1 e4 0b 00 00       	mov    0xbe4,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
 ...
 783:	e8 86 fc ff ff       	call   40e <sbrk>
  if(p == (char*)-1)
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
